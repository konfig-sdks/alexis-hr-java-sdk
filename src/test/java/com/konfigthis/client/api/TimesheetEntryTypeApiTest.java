...
/**
 * API tests for TimesheetEntryTypeApi
 */
@Disabled
public class TimesheetEntryTypeApiTest {

    private static TimesheetEntryTypeApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TimesheetEntryTypeApi(apiClient);
    }
     ...
     */
    @Test
    public void getOneTimesheetEntryTypeTest() throws ApiException {
        String id = null;
        List<String> select = null;
        TimesheetEntryTypeGetOneResponseMapped response = api.getOneTimesheetEntryType(id)
                .select(select)
                .execute();
     ...
     */
    @Test
    public void listManyTimesheetEntryTypesTest() throws ApiException {
        List<String> select = null;
        TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        TimesheetentrytypeListManyTimesheetEntryTypesSortParameter sort = null;
        TimesheetEntryTypesGetManyResponseMapped response = api.listManyTimesheetEntryTypes()
                .select(select)
                .filters(filters)
                .limit(limit)
                .offset(offset)
