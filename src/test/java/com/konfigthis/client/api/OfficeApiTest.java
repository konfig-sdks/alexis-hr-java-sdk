...
/**
 * API tests for OfficeApi
 */
@Disabled
public class OfficeApiTest {

    private static OfficeApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new OfficeApi(apiClient);
    }
     ...
     */
    @Test
    public void createOneOfficeTest() throws ApiException {
        String name = null;
        String phone = null;
        String email = null;
        ...
        String SCB = null;
        String SNI = null;
        OfficeResponseMapped response = api.createOneOffice(name, phone, email, timezone, CFAR, SCB, SNI)
                .execute();
     ...
     */
    @Test
    public void getOneOfficeTest() throws ApiException {
        String id = null;
        List<String> select = null;
        OfficeGetOneResponseMapped response = api.getOneOffice(id)
                .select(select)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listManyOfficesTest() throws ApiException {
        List<String> select = null;
        OfficeListManyOfficesFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        OfficeListManyOfficesSortParameter sort = null;
        OfficesGetManyResponseMapped response = api.listManyOffices()
                .select(select)
                .filters(filters)
                .limit(limit)
                .offset(offset)
    ...
    public void replaceOneTest() throws ApiException {
        ...
        String SCB = null;
        String SNI = null;
        OfficeResponseMapped response = api.replaceOne(id)
                .name(name)
                .phone(phone)
                .email(email)
                .timezone(timezone)
    ...
    public void updateOneTest() throws ApiException {
        ...
        String SCB = null;
        String SNI = null;
        OfficeResponseMapped response = api.updateOne(id)
                .name(name)
                .phone(phone)
                .email(email)
                .timezone(timezone)
