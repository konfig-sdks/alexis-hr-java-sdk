...
public class CompanyApiTest {
    ...
    public void getOneTest() throws ApiException {
        ...
        CompanyGetOneResponseMapped response = api.getOne(id)
                .select(select)
                .execute();
     ...
     */
    @Test
    public void listManyCompaniesTest() throws ApiException {
        List<String> select = null;
        CompanyListManyCompaniesFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        CompanyListManyCompaniesSortParameter sort = null;
        CompaniesGetManyResponseMapped response = api.listManyCompanies()
                .select(select)
                .filters(filters)
                .limit(limit)
                .offset(offset)
