...
public class TeamApiTest {
     ...
     */
    @Test
    public void createOneTeamTest() throws ApiException {
        String name = null;
        String bgColor = null;
        String fgColor = null;
        String description = null;
        TeamResponseMapped response = api.createOneTeam(name, bgColor, fgColor)
     ...
     */
    @Test
    public void getOneTeamTest() throws ApiException {
        String id = null;
        List<String> select = null;
        TeamGetOneResponseMapped response = api.getOneTeam(id)
                .select(select)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTeamsTest() throws ApiException {
        List<String> select = null;
        TeamListTeamsFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        TeamListTeamsSortParameter sort = null;
        TeamsGetManyResponseMapped response = api.listTeams()
                .select(select)
                .filters(filters)
                .limit(limit)
                .offset(offset)
     ...
     */
    @Test
    public void replaceTeamTest() throws ApiException {
        String id = null;
        String description = null;
        String name = null;
        String bgColor = null;
        String fgColor = null;
        TeamResponseMapped response = api.replaceTeam(id)
                .description(description)
                .name(name)
                .bgColor(bgColor)
                .fgColor(fgColor)
    ...
    public void updateTeamTest() throws ApiException {
        ...
        String bgColor = null;
        String fgColor = null;
        TeamResponseMapped response = api.updateTeam(id)
                .description(description)
                .name(name)
                .bgColor(bgColor)
                .fgColor(fgColor)
