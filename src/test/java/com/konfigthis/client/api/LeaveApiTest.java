...
/**
 * API tests for LeaveApi
 */
@Disabled
public class LeaveApiTest {

    private static LeaveApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LeaveApi(apiClient);
    }
    ...
    public void createOneTest() throws ApiException {
        ...
        LeaveResponseMapped response = api.createOne(employeeId, typeId, duration, startDate, endDate)
     ...
     */
    @Test
    public void deleteOneLeaveTest() throws ApiException {
        String id = null;
        EmptyResponseMapped response = api.deleteOneLeave(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getManyLeavesTest() throws ApiException {
        List<String> select = null;
        List<String> relations = null;
        LeaveGetManyLeavesFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        LeaveGetManyLeavesSortParameter sort = null;
        LeavesGetManyResponseMapped response = api.getManyLeaves()
                .select(select)
                .relations(relations)
                .filters(filters)
                .limit(limit)
     ...
     */
    @Test
    public void getOneLeaveTest() throws ApiException {
        String id = null;
        List<String> select = null;
        List<String> relations = null;
        LeaveGetOneResponseMapped response = api.getOneLeave(id)
                .select(select)
                .relations(relations)
                .execute();
        // TODO: test validations
    ...
    public void replaceOneTest() throws ApiException {
        ...
        OffsetDateTime startDate = null;
        OffsetDateTime endDate = null;
        Boolean morning = null;
        Boolean afternoon = null;
        String status = null;
        String approvalNote = null;
        LeaveResponseMapped response = api.replaceOne(extent, id)
                .description(description)
                .childId(childId)
                .duration(duration)
                .startDate(startDate)
     ...
     */
    @Test
    public void updateOneLeaveTest() throws ApiException {
        Double extent = null;
        String id = null;
        String description = null;
        String childId = null;
        ...
        String status = null;
        String approvalNote = null;
        LeaveResponseMapped response = api.updateOneLeave(extent, id)
                .description(description)
                .childId(childId)
                .duration(duration)
                .startDate(startDate)
