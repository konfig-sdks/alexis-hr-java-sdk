...
public class DepartmentApiTest {
    ...
    public void createOneTest() throws ApiException {
        ...
        DepartmentResponseMapped response = api.createOne(name)
     ...
     */
    @Test
    public void deleteOneDepartmentTest() throws ApiException {
        String id = null;
        EmptyResponseMapped response = api.deleteOneDepartment(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getOneTest() throws ApiException {
        ...
        DepartmentGetOneResponseMapped response = api.getOne(id)
                .select(select)
                .relations(relations)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listManyDepartmentsTest() throws ApiException {
        List<String> select = null;
        List<String> relations = null;
        DepartmentListManyDepartmentsFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        DepartmentListManyDepartmentsSortParameter sort = null;
        DepartmentsGetManyResponseMapped response = api.listManyDepartments()
                .select(select)
                .relations(relations)
                .filters(filters)
                .limit(limit)
    ...
    public void replaceOneTest() throws ApiException {
        ...
        String costCenterId = null;
        String parentId = null;
        DepartmentResponseMapped response = api.replaceOne(name, id)
                .description(description)
                .costCenterId(costCenterId)
                .parentId(parentId)
                .execute();
     ...
     */
    @Test
    public void updateOneDepartmentTest() throws ApiException {
        String name = null;
        String id = null;
        String description = null;
        String costCenterId = null;
        String parentId = null;
        DepartmentResponseMapped response = api.updateOneDepartment(name, id)
                .description(description)
                .costCenterId(costCenterId)
                .parentId(parentId)
                .execute();
