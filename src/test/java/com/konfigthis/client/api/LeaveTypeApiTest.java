...
/**
 * API tests for LeaveTypeApi
 */
@Disabled
public class LeaveTypeApiTest {

    private static LeaveTypeApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LeaveTypeApi(apiClient);
    }
     ...
     */
    @Test
    public void createOneLeaveTypeTest() throws ApiException {
        String name = null;
        String kind = null;
        String minimumDuration = null;
        Boolean deductible = null;
        Boolean paid = null;
        Boolean disabled = null;
        Boolean archived = null;
        LeaveTypeResponseMapped response = api.createOneLeaveType(name)
                .kind(kind)
     ...
     */
    @Test
    public void deleteOneLeaveTypeTest() throws ApiException {
        String id = null;
        EmptyResponseMapped response = api.deleteOneLeaveType(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getManyLeaveTypesTest() throws ApiException {
        List<String> select = null;
        List<String> relations = null;
        LeavetypeGetManyLeaveTypesFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        LeavetypeGetManyLeaveTypesSortParameter sort = null;
        LeaveTypesGetManyResponseMapped response = api.getManyLeaveTypes()
                .select(select)
                .relations(relations)
                .filters(filters)
                .limit(limit)
     ...
     */
    @Test
    public void getOneLeaveTypeTest() throws ApiException {
        String id = null;
        List<String> select = null;
        List<String> relations = null;
        LeaveTypeGetOneResponseMapped response = api.getOneLeaveType(id)
                .select(select)
                .relations(relations)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void replaceLeaveTypeTest() throws ApiException {
        String id = null;
        String name = null;
        String kind = null;
        String minimumDuration = null;
        ...
        Boolean disabled = null;
        Boolean archived = null;
        LeaveTypeResponseMapped response = api.replaceLeaveType(id)
                .name(name)
                .kind(kind)
                .minimumDuration(minimumDuration)
                .deductible(deductible)
     ...
     */
    @Test
    public void updateOneLeaveTypeTest() throws ApiException {
        String id = null;
        String name = null;
        String kind = null;
        String minimumDuration = null;
        ...
        Boolean disabled = null;
        Boolean archived = null;
        LeaveTypeResponseMapped response = api.updateOneLeaveType(id)
                .name(name)
                .kind(kind)
                .minimumDuration(minimumDuration)
                .deductible(deductible)
