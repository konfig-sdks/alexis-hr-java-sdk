...
/**
 * API tests for EmploymentTypeApi
 */
@Disabled
public class EmploymentTypeApiTest {

    private static EmploymentTypeApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmploymentTypeApi(apiClient);
    }
     ...
     */
    @Test
    public void createOneEmploymentTypeTest() throws ApiException {
        String name = null;
        Boolean vacation = null;
        String country = null;
        Double maxMonths = null;
        EmploymentTypeResponseMapped response = api.createOneEmploymentType(name, vacation, country)
                .maxMonths(maxMonths)
                .execute();
     ...
     */
    @Test
    public void deleteOneTypeTest() throws ApiException {
        String id = null;
        EmptyResponseMapped response = api.deleteOneType(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getManyEmploymentTypesTest() throws ApiException {
        List<String> select = null;
        EmploymenttypeGetManyEmploymentTypesFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        EmploymenttypeGetManyEmploymentTypesSortParameter sort = null;
        EmploymentTypesGetManyResponseMapped response = api.getManyEmploymentTypes()
                .select(select)
                .filters(filters)
                .limit(limit)
                .offset(offset)
    ...
    public void getOneTest() throws ApiException {
        String id = null;
        List<String> select = null;
        EmploymentTypeGetOneResponseMapped response = api.getOne(id)
                .select(select)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateOneEmploymentTypeTest() throws ApiException {
        String country = null;
        String id = null;
        String name = null;
        Boolean vacation = null;
        Double maxMonths = null;
        EmploymentTypeResponseMapped response = api.updateOneEmploymentType(country, id)
                .name(name)
                .vacation(vacation)
                .maxMonths(maxMonths)
                .execute();
     ...
     */
    @Test
    public void updateOneEmploymentType_0Test() throws ApiException {
        String country = null;
        String id = null;
        String name = null;
        Boolean vacation = null;
        Double maxMonths = null;
        EmploymentTypeResponseMapped response = api.updateOneEmploymentType_0(country, id)
                .name(name)
                .vacation(vacation)
                .maxMonths(maxMonths)
                .execute();
