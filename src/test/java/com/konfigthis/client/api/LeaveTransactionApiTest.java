...
/**
 * API tests for LeaveTransactionApi
 */
@Disabled
public class LeaveTransactionApiTest {

    private static LeaveTransactionApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LeaveTransactionApi(apiClient);
    }
     ...
     */
    @Test
    public void getOneLeaveTransactionTest() throws ApiException {
        String id = null;
        List<String> select = null;
        List<String> relations = null;
        LeaveTransactionGetOneResponseMapped response = api.getOneLeaveTransaction(id)
                .select(select)
                .relations(relations)
                .execute();
     ...
     */
    @Test
    public void listManyTransactionsTest() throws ApiException {
        List<String> select = null;
        List<String> relations = null;
        LeavetransactionListManyTransactionsFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        LeavetransactionListManyTransactionsSortParameter sort = null;
        LeaveTransactionsGetManyResponseMapped response = api.listManyTransactions()
                .select(select)
                .relations(relations)
                .filters(filters)
                .limit(limit)
