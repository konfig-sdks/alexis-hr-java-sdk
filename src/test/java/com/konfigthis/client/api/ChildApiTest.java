...
/**
 * API tests for ChildApi
 */
@Disabled
public class ChildApiTest {

    private static ChildApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ChildApi(apiClient);
    }
    ...
    public void createOneTest() throws ApiException {
        ...
        ChildResponseMapped response = api.createOne(employeeId, name, birthdate)
                .execute();
     ...
     */
    @Test
    public void deleteChildTest() throws ApiException {
        String id = null;
        EmptyResponseMapped response = api.deleteChild(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getManyTest() throws ApiException {
        ...
        ChildGetManyFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        ChildGetManySortParameter sort = null;
        ChildrenGetManyResponseMapped response = api.getMany()
                .select(select)
                .filters(filters)
                .limit(limit)
                .offset(offset)
     ...
     */
    @Test
    public void getOneChildTest() throws ApiException {
        String id = null;
        List<String> select = null;
        ChildGetOneResponseMapped response = api.getOneChild(id)
                .select(select)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void replaceChildDataTest() throws ApiException {
        String name = null;
        OffsetDateTime birthdate = null;
        String id = null;
        ChildResponseMapped response = api.replaceChildData(name, birthdate, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateChildDataTest() throws ApiException {
        String name = null;
        OffsetDateTime birthdate = null;
        String id = null;
        ChildResponseMapped response = api.updateChildData(name, birthdate, id)
                .execute();
        // TODO: test validations
    }
