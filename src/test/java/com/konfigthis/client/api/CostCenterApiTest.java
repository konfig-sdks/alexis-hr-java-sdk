...
public class CostCenterApiTest {
     ...
     */
    @Test
    public void createOneCostCenterTest() throws ApiException {
        String code = null;
        String name = null;
        CostCenterResponseMapped response = api.createOneCostCenter(code)
                .name(name)
                .execute();
     ...
     */
    @Test
    public void deleteOneCostCenterTest() throws ApiException {
        String id = null;
        EmptyResponseMapped response = api.deleteOneCostCenter(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getManyTest() throws ApiException {
        ...
        CostcenterGetManyFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        CostcenterGetManySortParameter sort = null;
        CostCentersGetManyResponseMapped response = api.getMany()
                .select(select)
                .filters(filters)
                .limit(limit)
                .offset(offset)
     ...
     */
    @Test
    public void getOneCostCenterTest() throws ApiException {
        String id = null;
        List<String> select = null;
        CostCenterGetOneResponseMapped response = api.getOneCostCenter(id)
                .select(select)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void replaceOneCostCenterTest() throws ApiException {
        String id = null;
        String code = null;
        String name = null;
        CostCenterResponseMapped response = api.replaceOneCostCenter(id)
                .code(code)
                .name(name)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void updateOneCostCenterTest() throws ApiException {
        String id = null;
        String code = null;
        String name = null;
        CostCenterResponseMapped response = api.updateOneCostCenter(id)
                .code(code)
                .name(name)
                .execute();
        // TODO: test validations
