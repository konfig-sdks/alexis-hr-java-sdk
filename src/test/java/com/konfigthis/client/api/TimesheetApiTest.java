...
public class TimesheetApiTest {
    ...
    private static TimesheetApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new TimesheetApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        ...
        TimesheetGetOneResponseMapped response = api.get(id)
                .select(select)
                .relations(relations)
                .execute();
    ...
    public void getManyTest() throws ApiException {
        List<String> select = null;
        List<String> relations = null;
        TimesheetGetManyFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        TimesheetGetManySortParameter sort = null;
        TimesheetsGetManyResponseMapped response = api.getMany()
                .select(select)
                .relations(relations)
                .filters(filters)
                .limit(limit)
