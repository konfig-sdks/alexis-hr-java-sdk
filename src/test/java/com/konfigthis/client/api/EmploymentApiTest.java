...
/**
 * API tests for EmploymentApi
 */
@Disabled
public class EmploymentApiTest {

    private static EmploymentApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmploymentApi(apiClient);
    }
     ...
     */
    @Test
    public void createOneEmploymentTest() throws ApiException {
        ...
        String note = null;
        EmploymentResponseMapped response = api.createOneEmployment(employeeId, userId, typeId, startDate, terminated, rate, country)
                .endDate(endDate)
    ...
    public void getOneTest() throws ApiException {
        ...
        EmploymentGetOneResponseMapped response = api.getOne(id)
                .select(select)
                .relations(relations)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listManyEmploymentsTest() throws ApiException {
        List<String> select = null;
        List<String> relations = null;
        EmploymentListManyEmploymentsFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        EmploymentListManyEmploymentsSortParameter sort = null;
        EmploymentsGetManyResponseMapped response = api.listManyEmployments()
                .select(select)
                .relations(relations)
                .filters(filters)
                .limit(limit)
     ...
     */
    @Test
    public void removeOneTest() throws ApiException {
        String id = null;
        EmptyResponseMapped response = api.removeOne(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void replaceOneTest() throws ApiException {
        ...
        String note = null;
        String country = null;
        EmploymentResponseMapped response = api.replaceOne(id)
     ...
     */
    @Test
    public void updateEmploymentDataTest() throws ApiException {
        String id = null;
        String employeeId = null;
        String userId = null;
        String typeId = null;
        ...
        String note = null;
        String country = null;
        EmploymentResponseMapped response = api.updateEmploymentData(id)
                .employeeId(employeeId)
                .userId(userId)
                .typeId(typeId)
                .startDate(startDate)
