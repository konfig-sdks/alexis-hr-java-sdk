...
/**
 * API tests for EmployeeTeamReferenceApi
 */
@Disabled
public class EmployeeTeamReferenceApiTest {

    private static EmployeeTeamReferenceApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeTeamReferenceApi(apiClient);
    }
     ...
     */
    @Test
    public void createOneEmployeeTeamReferenceTest() throws ApiException {
        String teamId = null;
        String companyId = null;
        String employeeId = null;
        String userId = null;
        EmployeeTeamReferenceResponseMapped response = api.createOneEmployeeTeamReference(teamId, companyId, employeeId, userId)
                .execute();
    ...
    public void getManyTest() throws ApiException {
        ...
        EmployeeteamreferenceGetManyFiltersParameter filters = null;
        Integer limit = null;
        Integer offset = null;
        EmployeeteamreferenceGetManySortParameter sort = null;
        EmployeeTeamReferencesGetManyResponseMapped response = api.getMany()
                .select(select)
                .relations(relations)
                .filters(filters)
                .limit(limit)
     ...
     */
    @Test
    public void getOneEmployeeTeamReferenceTest() throws ApiException {
        String id = null;
        List<String> select = null;
        List<String> relations = null;
        EmployeeTeamReferenceGetOneResponseMapped response = api.getOneEmployeeTeamReference(id)
                .select(select)
                .relations(relations)
                .execute();
        // TODO: test validations
    ...
    public void replaceOneTest() throws ApiException {
        String id = null;
        String teamId = null;
        EmployeeTeamReferenceResponseMapped response = api.replaceOne(id)
                .teamId(teamId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateOneEmployeeTeamReferenceTest() throws ApiException {
        String id = null;
        String teamId = null;
        EmployeeTeamReferenceResponseMapped response = api.updateOneEmployeeTeamReference(id)
                .teamId(teamId)
                .execute();
        // TODO: test validations
    }
