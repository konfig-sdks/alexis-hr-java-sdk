...
/**
 * ChildGetManyFiltersParameter
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ChildGetManyFiltersParameter {
  ...
  public ChildGetManyFiltersParameter() {
  }

  public ChildGetManyFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
  ...
  public ChildGetManyFiltersParameter employeeId(CompanyListManyCompaniesFiltersParameterId employeeId) {
  ...
  **/
  ...
  public ChildGetManyFiltersParameter name(CompanyListManyCompaniesFiltersParameterId name) {
  ...
  **/
  ...
  public ChildGetManyFiltersParameter birthdate(CompanyListManyCompaniesFiltersParameterId birthdate) {
  ...
  **/
   ...
   * @return the ChildGetManyFiltersParameter instance itself
   */
  public ChildGetManyFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChildGetManyFiltersParameter childGetManyFiltersParameter = (ChildGetManyFiltersParameter) o;
    return Objects.equals(this.id, childGetManyFiltersParameter.id) &&
        Objects.equals(this.employeeId, childGetManyFiltersParameter.employeeId) &&
        Objects.equals(this.name, childGetManyFiltersParameter.name) &&
        Objects.equals(this.birthdate, childGetManyFiltersParameter.birthdate)&&
        Objects.equals(this.additionalProperties, childGetManyFiltersParameter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, employeeId, name, birthdate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChildGetManyFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChildGetManyFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChildGetManyFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChildGetManyFiltersParameter is not found in the empty JSON string", ChildGetManyFiltersParameter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChildGetManyFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChildGetManyFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChildGetManyFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChildGetManyFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<ChildGetManyFiltersParameter>() {
           @Override
           public void write(JsonWriter out, ChildGetManyFiltersParameter value) throws IOException {
           ...
           @Override
           public ChildGetManyFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChildGetManyFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChildGetManyFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChildGetManyFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to ChildGetManyFiltersParameter
  */
  public static ChildGetManyFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChildGetManyFiltersParameter.class);
  }

 /**
  * Convert an instance of ChildGetManyFiltersParameter to an JSON string
  *
  * @return JSON string
  */
