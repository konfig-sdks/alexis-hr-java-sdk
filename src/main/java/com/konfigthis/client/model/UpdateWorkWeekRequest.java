...
public class UpdateWorkWeekRequest {
  ...
  public UpdateWorkWeekRequest() {
  }

  public UpdateWorkWeekRequest effectiveTo(OffsetDateTime effectiveTo) {
  ...
  **/
   ...
   * @return the UpdateWorkWeekRequest instance itself
   */
  public UpdateWorkWeekRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateWorkWeekRequest updateWorkWeekRequest = (UpdateWorkWeekRequest) o;
    return Objects.equals(this.effectiveTo, updateWorkWeekRequest.effectiveTo)&&
        Objects.equals(this.additionalProperties, updateWorkWeekRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(effectiveTo, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateWorkWeekRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateWorkWeekRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateWorkWeekRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateWorkWeekRequest is not found in the empty JSON string", UpdateWorkWeekRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWorkWeekRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWorkWeekRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWorkWeekRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWorkWeekRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWorkWeekRequest>() {
           @Override
           public void write(JsonWriter out, UpdateWorkWeekRequest value) throws IOException {
           ...
           @Override
           public UpdateWorkWeekRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateWorkWeekRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateWorkWeekRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateWorkWeekRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateWorkWeekRequest
  */
  public static UpdateWorkWeekRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWorkWeekRequest.class);
  }

 /**
  * Convert an instance of UpdateWorkWeekRequest to an JSON string
  *
  * @return JSON string
  */
