...
public class WorkWeekRelationsResponse {
  ...
  public WorkWeekRelationsResponse() {
  }

  public WorkWeekRelationsResponse office(List<OfficeResponse> office) {
  ...
  public WorkWeekRelationsResponse addOfficeItem(OfficeResponse officeItem) {
    if (this.office == null) {
  ...
  **/
  ...
  public WorkWeekRelationsResponse employee(List<EmployeeResponse> employee) {
  ...
  public WorkWeekRelationsResponse addEmployeeItem(EmployeeResponse employeeItem) {
  ...
  **/
   ...
   * @return the WorkWeekRelationsResponse instance itself
   */
  public WorkWeekRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkWeekRelationsResponse workWeekRelationsResponse = (WorkWeekRelationsResponse) o;
    return Objects.equals(this.office, workWeekRelationsResponse.office) &&
        Objects.equals(this.employee, workWeekRelationsResponse.employee)&&
        Objects.equals(this.additionalProperties, workWeekRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(office, employee, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkWeekRelationsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkWeekRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkWeekRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkWeekRelationsResponse is not found in the empty JSON string", WorkWeekRelationsResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkWeekRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkWeekRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkWeekRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkWeekRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkWeekRelationsResponse>() {
           @Override
           public void write(JsonWriter out, WorkWeekRelationsResponse value) throws IOException {
           ...
           @Override
           public WorkWeekRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkWeekRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkWeekRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkWeekRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to WorkWeekRelationsResponse
  */
  public static WorkWeekRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkWeekRelationsResponse.class);
  }

 /**
  * Convert an instance of WorkWeekRelationsResponse to an JSON string
  *
  * @return JSON string
  */
