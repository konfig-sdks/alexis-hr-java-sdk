...
import com.konfigthis.client.model.LeaveTypeCodeResponse;
...
public class LeaveTypeGetManyRelationsResponse {
  public static final String SERIALIZED_NAME_LEAVE_TYPE_CODE = "leaveTypeCode";
  @SerializedName(SERIALIZED_NAME_LEAVE_TYPE_CODE)
  private List<LeaveTypeCodeResponse> leaveTypeCode = null;

  public LeaveTypeGetManyRelationsResponse() {
  }

  public LeaveTypeGetManyRelationsResponse leaveTypeCode(List<LeaveTypeCodeResponse> leaveTypeCode) {
  ...
  public LeaveTypeGetManyRelationsResponse addLeaveTypeCodeItem(LeaveTypeCodeResponse leaveTypeCodeItem) {
    if (this.leaveTypeCode == null) {
      this.leaveTypeCode = new ArrayList<>();
    }
    this.leaveTypeCode.add(leaveTypeCodeItem);
    return this;
  }
  ...
  **/
  ...
  public List<LeaveTypeCodeResponse> getLeaveTypeCode() {
    return leaveTypeCode;
  }


  public void setLeaveTypeCode(List<LeaveTypeCodeResponse> leaveTypeCode) {
   ...
   * @return the LeaveTypeGetManyRelationsResponse instance itself
   */
  public LeaveTypeGetManyRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTypeGetManyRelationsResponse leaveTypeGetManyRelationsResponse = (LeaveTypeGetManyRelationsResponse) o;
    return Objects.equals(this.leaveTypeCode, leaveTypeGetManyRelationsResponse.leaveTypeCode)&&
        Objects.equals(this.additionalProperties, leaveTypeGetManyRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(leaveTypeCode, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LeaveTypeGetManyRelationsResponse {\n");
    sb.append("    leaveTypeCode: ").append(toIndentedString(leaveTypeCode)).append("\n");
  ...
  static {
    ...
    openapiFields.add("leaveTypeCode");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTypeGetManyRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTypeGetManyRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTypeGetManyRelationsResponse is not found in the empty JSON string", LeaveTypeGetManyRelationsResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("leaveTypeCode") != null && !jsonObj.get("leaveTypeCode").isJsonNull()) {
        JsonArray jsonArrayleaveTypeCode = jsonObj.getAsJsonArray("leaveTypeCode");
        if (jsonArrayleaveTypeCode != null) {
          // ensure the json data is an array
          if (!jsonObj.get("leaveTypeCode").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `leaveTypeCode` to be an array in the JSON string but got `%s`", jsonObj.get("leaveTypeCode").toString()));
          }

          // validate the optional field `leaveTypeCode` (array)
          for (int i = 0; i < jsonArrayleaveTypeCode.size(); i++) {
            LeaveTypeCodeResponse.validateJsonObject(jsonArrayleaveTypeCode.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTypeGetManyRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTypeGetManyRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTypeGetManyRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTypeGetManyRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTypeGetManyRelationsResponse>() {
           @Override
           public void write(JsonWriter out, LeaveTypeGetManyRelationsResponse value) throws IOException {
           ...
           @Override
           public LeaveTypeGetManyRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTypeGetManyRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTypeGetManyRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTypeGetManyRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveTypeGetManyRelationsResponse
  */
  public static LeaveTypeGetManyRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTypeGetManyRelationsResponse.class);
  }

 /**
  * Convert an instance of LeaveTypeGetManyRelationsResponse to an JSON string
  *
  * @return JSON string
  */
