...
public class CreateChildRequest {
  ...
  public CreateChildRequest employeeId(String employeeId) {
  ...
  **/
  ...
  public CreateChildRequest name(String name) {
  ...
  **/
  ...
  public CreateChildRequest birthdate(OffsetDateTime birthdate) {
  ...
  **/
   ...
   * @return the CreateChildRequest instance itself
   */
  public CreateChildRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.employeeId, createChildRequest.employeeId) &&
        Objects.equals(this.name, createChildRequest.name) &&
        Objects.equals(this.birthdate, createChildRequest.birthdate)&&
        Objects.equals(this.additionalProperties, createChildRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(employeeId, name, birthdate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateChildRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateChildRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateChildRequest is not found in the empty JSON string", CreateChildRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateChildRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChildRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChildRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChildRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChildRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChildRequest>() {
           @Override
           public void write(JsonWriter out, CreateChildRequest value) throws IOException {
           ...
           @Override
           public CreateChildRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateChildRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateChildRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateChildRequest
  * @throws IOException if the JSON string is invalid with respect to CreateChildRequest
  */
  public static CreateChildRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChildRequest.class);
  }

 /**
  * Convert an instance of CreateChildRequest to an JSON string
  *
  * @return JSON string
  */
