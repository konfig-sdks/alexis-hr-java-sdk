...
public class OfficeResponseMapped {
  ...
  public OfficeResponseMapped() {
  }

  public OfficeResponseMapped status(String status) {
  ...
  **/
  ...
  public OfficeResponseMapped data(OfficeResponse data) {
  ...
  **/
   ...
   * @return the OfficeResponseMapped instance itself
   */
  public OfficeResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OfficeResponseMapped officeResponseMapped = (OfficeResponseMapped) o;
    return Objects.equals(this.status, officeResponseMapped.status) &&
        Objects.equals(this.data, officeResponseMapped.data)&&
        Objects.equals(this.additionalProperties, officeResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OfficeResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OfficeResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OfficeResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OfficeResponseMapped is not found in the empty JSON string", OfficeResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OfficeResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OfficeResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OfficeResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OfficeResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OfficeResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<OfficeResponseMapped>() {
           @Override
           public void write(JsonWriter out, OfficeResponseMapped value) throws IOException {
           ...
           @Override
           public OfficeResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OfficeResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OfficeResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OfficeResponseMapped
  * @throws IOException if the JSON string is invalid with respect to OfficeResponseMapped
  */
  public static OfficeResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OfficeResponseMapped.class);
  }

 /**
  * Convert an instance of OfficeResponseMapped to an JSON string
  *
  * @return JSON string
  */
