...
public class TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter {
  ...
  public TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter() {
  }

  public TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
  ...
  public TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter name(CompanyListManyCompaniesFiltersParameterId name) {
  ...
  **/
  ...
  public TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter kind(CompanyListManyCompaniesFiltersParameterId kind) {
  ...
  **/
   ...
   * @return the TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter instance itself
   */
  public TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter timesheetentrytypeListManyTimesheetEntryTypesFiltersParameter = (TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter) o;
    return Objects.equals(this.id, timesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.id) &&
        Objects.equals(this.name, timesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.name) &&
        Objects.equals(this.kind, timesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.kind)&&
        Objects.equals(this.additionalProperties, timesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, kind, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter is not found in the empty JSON string", TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter>() {
           @Override
           public void write(JsonWriter out, TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter value) throws IOException {
           ...
           @Override
           public TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter
  */
  public static TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter.class);
  }

 /**
  * Convert an instance of TimesheetentrytypeListManyTimesheetEntryTypesFiltersParameter to an JSON string
  *
  * @return JSON string
  */
