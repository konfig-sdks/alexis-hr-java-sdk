...
public class DepartmentResponse {
  ...
  private String effectiveCostCenterId;
  ...
  **/
  ...
  public DepartmentResponse companyId(String companyId) {
  ...
  **/
  ...
  public DepartmentResponse costCenterId(String costCenterId) {
  ...
  **/
  ...
  public DepartmentResponse effectiveCostCenterId(String effectiveCostCenterId) {
  ...
  **/
  ...
  public String getEffectiveCostCenterId() {
    return effectiveCostCenterId;
  }


  public void setEffectiveCostCenterId(String effectiveCostCenterId) {
  ...
  public DepartmentResponse parentId(String parentId) {
  ...
  **/
   ...
   * @return the DepartmentResponse instance itself
   */
  public DepartmentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, departmentResponse.description) &&
        Objects.equals(this.id, departmentResponse.id) &&
        Objects.equals(this.companyId, departmentResponse.companyId) &&
        Objects.equals(this.name, departmentResponse.name) &&
        Objects.equals(this.costCenterId, departmentResponse.costCenterId) &&
        Objects.equals(this.effectiveCostCenterId, departmentResponse.effectiveCostCenterId) &&
        Objects.equals(this.parentId, departmentResponse.parentId)&&
        Objects.equals(this.additionalProperties, departmentResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, companyId, name, costCenterId, effectiveCostCenterId, parentId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DepartmentResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DepartmentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepartmentResponse is not found in the empty JSON string", DepartmentResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DepartmentResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepartmentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepartmentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepartmentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepartmentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DepartmentResponse>() {
           @Override
           public void write(JsonWriter out, DepartmentResponse value) throws IOException {
           ...
           @Override
           public DepartmentResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DepartmentResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DepartmentResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DepartmentResponse
  * @throws IOException if the JSON string is invalid with respect to DepartmentResponse
  */
  public static DepartmentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepartmentResponse.class);
  }

 /**
  * Convert an instance of DepartmentResponse to an JSON string
  *
  * @return JSON string
  */
