...
import com.konfigthis.client.model.LeaveTypeGetOneRelationResponse;
...
public class LeaveTypeGetOneResponseMapped {
  ...
  private LeaveTypeResponse data;

  public static final String SERIALIZED_NAME_RELATIONS = "relations";
  @SerializedName(SERIALIZED_NAME_RELATIONS)
  private LeaveTypeGetOneRelationResponse relations;

  public LeaveTypeGetOneResponseMapped() {
  }

  public LeaveTypeGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public LeaveTypeGetOneResponseMapped data(LeaveTypeResponse data) {
  ...
  **/
  ...
  public LeaveTypeResponse getData() {
    return data;
  }


  public void setData(LeaveTypeResponse data) {
  ...
  public LeaveTypeGetOneResponseMapped relations(LeaveTypeGetOneRelationResponse relations) {
  ...
  **/
  ...
  public LeaveTypeGetOneRelationResponse getRelations() {
    return relations;
  }


  public void setRelations(LeaveTypeGetOneRelationResponse relations) {
   ...
   * @return the LeaveTypeGetOneResponseMapped instance itself
   */
  public LeaveTypeGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTypeGetOneResponseMapped leaveTypeGetOneResponseMapped = (LeaveTypeGetOneResponseMapped) o;
    return Objects.equals(this.status, leaveTypeGetOneResponseMapped.status) &&
        Objects.equals(this.data, leaveTypeGetOneResponseMapped.data) &&
        Objects.equals(this.relations, leaveTypeGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, leaveTypeGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveTypeGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTypeGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTypeGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTypeGetOneResponseMapped is not found in the empty JSON string", LeaveTypeGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveTypeGetOneResponseMapped.openapiRequiredFields) {
      ...
      LeaveTypeResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        LeaveTypeGetOneRelationResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTypeGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTypeGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTypeGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTypeGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTypeGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, LeaveTypeGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public LeaveTypeGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTypeGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTypeGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTypeGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to LeaveTypeGetOneResponseMapped
  */
  public static LeaveTypeGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTypeGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of LeaveTypeGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
