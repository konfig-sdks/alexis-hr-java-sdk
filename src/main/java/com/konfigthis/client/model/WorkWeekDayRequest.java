...
import com.konfigthis.client.model.WorkShiftRequest;
...
public class WorkWeekDayRequest {
  ...
  private List<WorkShiftRequest> shifts = new ArrayList<>();

  public WorkWeekDayRequest() {
  }

  public WorkWeekDayRequest working(Boolean working) {
  ...
  **/
  ...
  public WorkWeekDayRequest duration(Double duration) {
  ...
  public WorkWeekDayRequest duration(Integer duration) {
  ...
  **/
  ...
  public WorkWeekDayRequest shifts(List<WorkShiftRequest> shifts) {
  ...
  public WorkWeekDayRequest addShiftsItem(WorkShiftRequest shiftsItem) {
  ...
  **/
  ...
  public List<WorkShiftRequest> getShifts() {
    return shifts;
  }


  public void setShifts(List<WorkShiftRequest> shifts) {
   ...
   * @return the WorkWeekDayRequest instance itself
   */
  public WorkWeekDayRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkWeekDayRequest workWeekDayRequest = (WorkWeekDayRequest) o;
    return Objects.equals(this.working, workWeekDayRequest.working) &&
        Objects.equals(this.duration, workWeekDayRequest.duration) &&
        Objects.equals(this.shifts, workWeekDayRequest.shifts)&&
        Objects.equals(this.additionalProperties, workWeekDayRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(working, duration, shifts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkWeekDayRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("working");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkWeekDayRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkWeekDayRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkWeekDayRequest is not found in the empty JSON string", WorkWeekDayRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkWeekDayRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayshifts.size(); i++) {
        WorkShiftRequest.validateJsonObject(jsonArrayshifts.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkWeekDayRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkWeekDayRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkWeekDayRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkWeekDayRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkWeekDayRequest>() {
           @Override
           public void write(JsonWriter out, WorkWeekDayRequest value) throws IOException {
           ...
           @Override
           public WorkWeekDayRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkWeekDayRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkWeekDayRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkWeekDayRequest
  * @throws IOException if the JSON string is invalid with respect to WorkWeekDayRequest
  */
  public static WorkWeekDayRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkWeekDayRequest.class);
  }

 /**
  * Convert an instance of WorkWeekDayRequest to an JSON string
  *
  * @return JSON string
  */
