...
public class LeaveTypeCodeResponse {
  ...
  public LeaveTypeCodeResponse() {
  }

  public LeaveTypeCodeResponse id(String id) {
  ...
  **/
  ...
  public LeaveTypeCodeResponse companyId(String companyId) {
  ...
  **/
  ...
  public LeaveTypeCodeResponse leaveTypeId(String leaveTypeId) {
  ...
  **/
  ...
  public LeaveTypeCodeResponse code(String code) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "UserGivenCode123", required = true, value = "")
   ...
   * @return the LeaveTypeCodeResponse instance itself
   */
  public LeaveTypeCodeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTypeCodeResponse leaveTypeCodeResponse = (LeaveTypeCodeResponse) o;
    return Objects.equals(this.id, leaveTypeCodeResponse.id) &&
        Objects.equals(this.companyId, leaveTypeCodeResponse.companyId) &&
        Objects.equals(this.leaveTypeId, leaveTypeCodeResponse.leaveTypeId) &&
        Objects.equals(this.code, leaveTypeCodeResponse.code)&&
        Objects.equals(this.additionalProperties, leaveTypeCodeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, leaveTypeId, code, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LeaveTypeCodeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTypeCodeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTypeCodeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTypeCodeResponse is not found in the empty JSON string", LeaveTypeCodeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveTypeCodeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTypeCodeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTypeCodeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTypeCodeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTypeCodeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTypeCodeResponse>() {
           @Override
           public void write(JsonWriter out, LeaveTypeCodeResponse value) throws IOException {
           ...
           @Override
           public LeaveTypeCodeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTypeCodeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTypeCodeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTypeCodeResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveTypeCodeResponse
  */
  public static LeaveTypeCodeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTypeCodeResponse.class);
  }

 /**
  * Convert an instance of LeaveTypeCodeResponse to an JSON string
  *
  * @return JSON string
  */
