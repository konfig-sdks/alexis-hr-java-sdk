...
public class EmployeeTeamReferenceRelationsResponse {
  public static final String SERIALIZED_NAME_EMPLOYEE = "employee";
  @SerializedName(SERIALIZED_NAME_EMPLOYEE)
  private List<List<Object>> employee = null;

  public static final String SERIALIZED_NAME_TEAM = "team";
  @SerializedName(SERIALIZED_NAME_TEAM)
  private List<TeamResponse> team = null;

  public static final String SERIALIZED_NAME_USER = "user";
  @SerializedName(SERIALIZED_NAME_USER)
  private List<UserResponse> user = null;

  public EmployeeTeamReferenceRelationsResponse() {
  }

  public EmployeeTeamReferenceRelationsResponse employee(List<List<Object>> employee) {
  ...
  public EmployeeTeamReferenceRelationsResponse addEmployeeItem(List<Object> employeeItem) {
  ...
  **/
  ...
  public List<List<Object>> getEmployee() {
    return employee;
  }


  public void setEmployee(List<List<Object>> employee) {
  ...
  public EmployeeTeamReferenceRelationsResponse team(List<TeamResponse> team) {
  ...
  public EmployeeTeamReferenceRelationsResponse addTeamItem(TeamResponse teamItem) {
    if (this.team == null) {
  ...
  **/
  ...
  public EmployeeTeamReferenceRelationsResponse user(List<UserResponse> user) {
  ...
  public EmployeeTeamReferenceRelationsResponse addUserItem(UserResponse userItem) {
    if (this.user == null) {
  ...
  **/
   ...
   * @return the EmployeeTeamReferenceRelationsResponse instance itself
   */
  public EmployeeTeamReferenceRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeTeamReferenceRelationsResponse employeeTeamReferenceRelationsResponse = (EmployeeTeamReferenceRelationsResponse) o;
    return Objects.equals(this.employee, employeeTeamReferenceRelationsResponse.employee) &&
        Objects.equals(this.team, employeeTeamReferenceRelationsResponse.team) &&
        Objects.equals(this.user, employeeTeamReferenceRelationsResponse.user)&&
        Objects.equals(this.additionalProperties, employeeTeamReferenceRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(employee, team, user, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeeTeamReferenceRelationsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTeamReferenceRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTeamReferenceRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeTeamReferenceRelationsResponse is not found in the empty JSON string", EmployeeTeamReferenceRelationsResponse.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("employee") != null && !jsonObj.get("employee").isJsonArray()) {
      ...
      if (jsonObj.get("team") != null && !jsonObj.get("team").isJsonNull()) {
        ...
        if (jsonArrayteam != null) {
          ...
          for (int i = 0; i < jsonArrayteam.size(); i++) {
            TeamResponse.validateJsonObject(jsonArrayteam.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        ...
        if (jsonArrayuser != null) {
          ...
          for (int i = 0; i < jsonArrayuser.size(); i++) {
            UserResponse.validateJsonObject(jsonArrayuser.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeTeamReferenceRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeTeamReferenceRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeTeamReferenceRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeTeamReferenceRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeTeamReferenceRelationsResponse>() {
           @Override
           public void write(JsonWriter out, EmployeeTeamReferenceRelationsResponse value) throws IOException {
           ...
           @Override
           public EmployeeTeamReferenceRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeTeamReferenceRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeTeamReferenceRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeTeamReferenceRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to EmployeeTeamReferenceRelationsResponse
  */
  public static EmployeeTeamReferenceRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeTeamReferenceRelationsResponse.class);
  }

 /**
  * Convert an instance of EmployeeTeamReferenceRelationsResponse to an JSON string
  *
  * @return JSON string
  */
