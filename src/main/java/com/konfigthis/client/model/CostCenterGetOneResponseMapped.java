...
public class CostCenterGetOneResponseMapped {
  ...
  private CostCenterResponse data;
  ...
  public CostCenterGetOneResponseMapped() {
  }

  public CostCenterGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public CostCenterGetOneResponseMapped data(CostCenterResponse data) {
  ...
  **/
  ...
  public CostCenterResponse getData() {
    return data;
  }


  public void setData(CostCenterResponse data) {
  ...
  public CostCenterGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the CostCenterGetOneResponseMapped instance itself
   */
  public CostCenterGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CostCenterGetOneResponseMapped costCenterGetOneResponseMapped = (CostCenterGetOneResponseMapped) o;
    return Objects.equals(this.status, costCenterGetOneResponseMapped.status) &&
        Objects.equals(this.data, costCenterGetOneResponseMapped.data) &&
        Objects.equals(this.relations, costCenterGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, costCenterGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostCenterGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CostCenterGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CostCenterGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostCenterGetOneResponseMapped is not found in the empty JSON string", CostCenterGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CostCenterGetOneResponseMapped.openapiRequiredFields) {
      ...
      CostCenterResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostCenterGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostCenterGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostCenterGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostCenterGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CostCenterGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, CostCenterGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public CostCenterGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CostCenterGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CostCenterGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CostCenterGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CostCenterGetOneResponseMapped
  */
  public static CostCenterGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostCenterGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of CostCenterGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
