...
public class EmployeeTeamReferenceResponseMapped {
  ...
  public EmployeeTeamReferenceResponseMapped() {
  }

  public EmployeeTeamReferenceResponseMapped status(String status) {
  ...
  **/
  ...
  public EmployeeTeamReferenceResponseMapped data(EmployeeTeamReferenceResponse data) {
  ...
  **/
   ...
   * @return the EmployeeTeamReferenceResponseMapped instance itself
   */
  public EmployeeTeamReferenceResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeTeamReferenceResponseMapped employeeTeamReferenceResponseMapped = (EmployeeTeamReferenceResponseMapped) o;
    return Objects.equals(this.status, employeeTeamReferenceResponseMapped.status) &&
        Objects.equals(this.data, employeeTeamReferenceResponseMapped.data)&&
        Objects.equals(this.additionalProperties, employeeTeamReferenceResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeTeamReferenceResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTeamReferenceResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTeamReferenceResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeTeamReferenceResponseMapped is not found in the empty JSON string", EmployeeTeamReferenceResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeTeamReferenceResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeTeamReferenceResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeTeamReferenceResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeTeamReferenceResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeTeamReferenceResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeTeamReferenceResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmployeeTeamReferenceResponseMapped value) throws IOException {
           ...
           @Override
           public EmployeeTeamReferenceResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeTeamReferenceResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeTeamReferenceResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeTeamReferenceResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmployeeTeamReferenceResponseMapped
  */
  public static EmployeeTeamReferenceResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeTeamReferenceResponseMapped.class);
  }

 /**
  * Convert an instance of EmployeeTeamReferenceResponseMapped to an JSON string
  *
  * @return JSON string
  */
