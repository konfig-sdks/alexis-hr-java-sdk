...
import com.konfigthis.client.model.WorkShiftResponse;
...
public class WorkWeekDayResponse {
  ...
  private List<WorkShiftResponse> shifts = new ArrayList<>();

  public WorkWeekDayResponse() {
  }

  public WorkWeekDayResponse working(Boolean working) {
  ...
  **/
  ...
  public WorkWeekDayResponse duration(Double duration) {
  ...
  public WorkWeekDayResponse duration(Integer duration) {
  ...
  **/
  ...
  public WorkWeekDayResponse shifts(List<WorkShiftResponse> shifts) {
  ...
  public WorkWeekDayResponse addShiftsItem(WorkShiftResponse shiftsItem) {
  ...
  **/
  ...
  public void setShifts(List<WorkShiftResponse> shifts) {
   ...
   * @return the WorkWeekDayResponse instance itself
   */
  public WorkWeekDayResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkWeekDayResponse workWeekDayResponse = (WorkWeekDayResponse) o;
    return Objects.equals(this.working, workWeekDayResponse.working) &&
        Objects.equals(this.duration, workWeekDayResponse.duration) &&
        Objects.equals(this.shifts, workWeekDayResponse.shifts)&&
        Objects.equals(this.additionalProperties, workWeekDayResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkWeekDayResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkWeekDayResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkWeekDayResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkWeekDayResponse is not found in the empty JSON string", WorkWeekDayResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkWeekDayResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayshifts.size(); i++) {
        WorkShiftResponse.validateJsonObject(jsonArrayshifts.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkWeekDayResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkWeekDayResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkWeekDayResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkWeekDayResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkWeekDayResponse>() {
           @Override
           public void write(JsonWriter out, WorkWeekDayResponse value) throws IOException {
           ...
           @Override
           public WorkWeekDayResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkWeekDayResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkWeekDayResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkWeekDayResponse
  * @throws IOException if the JSON string is invalid with respect to WorkWeekDayResponse
  */
  public static WorkWeekDayResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkWeekDayResponse.class);
  }

 /**
  * Convert an instance of WorkWeekDayResponse to an JSON string
  *
  * @return JSON string
  */
