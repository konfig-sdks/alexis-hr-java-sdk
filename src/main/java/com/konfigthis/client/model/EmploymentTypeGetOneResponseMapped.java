...
public class EmploymentTypeGetOneResponseMapped {
  ...
  private EmploymentTypeResponse data;
  ...
  public EmploymentTypeGetOneResponseMapped() {
  }

  public EmploymentTypeGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public EmploymentTypeGetOneResponseMapped data(EmploymentTypeResponse data) {
  ...
  **/
  ...
  public EmploymentTypeResponse getData() {
    return data;
  }


  public void setData(EmploymentTypeResponse data) {
  ...
  public EmploymentTypeGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the EmploymentTypeGetOneResponseMapped instance itself
   */
  public EmploymentTypeGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmploymentTypeGetOneResponseMapped employmentTypeGetOneResponseMapped = (EmploymentTypeGetOneResponseMapped) o;
    return Objects.equals(this.status, employmentTypeGetOneResponseMapped.status) &&
        Objects.equals(this.data, employmentTypeGetOneResponseMapped.data) &&
        Objects.equals(this.relations, employmentTypeGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, employmentTypeGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmploymentTypeGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentTypeGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentTypeGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmploymentTypeGetOneResponseMapped is not found in the empty JSON string", EmploymentTypeGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmploymentTypeGetOneResponseMapped.openapiRequiredFields) {
      ...
      EmploymentTypeResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmploymentTypeGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmploymentTypeGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmploymentTypeGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmploymentTypeGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmploymentTypeGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmploymentTypeGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public EmploymentTypeGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmploymentTypeGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmploymentTypeGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmploymentTypeGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmploymentTypeGetOneResponseMapped
  */
  public static EmploymentTypeGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmploymentTypeGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of EmploymentTypeGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
