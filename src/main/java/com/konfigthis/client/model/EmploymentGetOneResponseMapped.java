...
public class EmploymentGetOneResponseMapped {
  ...
  private EmploymentResponse data;
  ...
  public EmploymentGetOneResponseMapped() {
  }

  public EmploymentGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public EmploymentGetOneResponseMapped data(EmploymentResponse data) {
  ...
  **/
  ...
  public EmploymentResponse getData() {
    return data;
  }


  public void setData(EmploymentResponse data) {
  ...
  public EmploymentGetOneResponseMapped relations(EmploymentRelationsResponse relations) {
  ...
  **/
   ...
   * @return the EmploymentGetOneResponseMapped instance itself
   */
  public EmploymentGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmploymentGetOneResponseMapped employmentGetOneResponseMapped = (EmploymentGetOneResponseMapped) o;
    return Objects.equals(this.status, employmentGetOneResponseMapped.status) &&
        Objects.equals(this.data, employmentGetOneResponseMapped.data) &&
        Objects.equals(this.relations, employmentGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, employmentGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmploymentGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmploymentGetOneResponseMapped is not found in the empty JSON string", EmploymentGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmploymentGetOneResponseMapped.openapiRequiredFields) {
      ...
      EmploymentResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmploymentGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmploymentGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmploymentGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmploymentGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmploymentGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmploymentGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public EmploymentGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmploymentGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmploymentGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmploymentGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmploymentGetOneResponseMapped
  */
  public static EmploymentGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmploymentGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of EmploymentGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
