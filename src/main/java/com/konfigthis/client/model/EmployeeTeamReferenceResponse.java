...
public class EmployeeTeamReferenceResponse {
  ...
  public EmployeeTeamReferenceResponse() {
  }

  public EmployeeTeamReferenceResponse id(String id) {
  ...
  **/
  ...
  public EmployeeTeamReferenceResponse companyId(String companyId) {
  ...
  **/
  ...
  public EmployeeTeamReferenceResponse teamId(String teamId) {
  ...
  **/
  ...
  public EmployeeTeamReferenceResponse userId(String userId) {
  ...
  **/
  ...
  public EmployeeTeamReferenceResponse employeeId(String employeeId) {
  ...
  **/
   ...
   * @return the EmployeeTeamReferenceResponse instance itself
   */
  public EmployeeTeamReferenceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeTeamReferenceResponse employeeTeamReferenceResponse = (EmployeeTeamReferenceResponse) o;
    return Objects.equals(this.id, employeeTeamReferenceResponse.id) &&
        Objects.equals(this.companyId, employeeTeamReferenceResponse.companyId) &&
        Objects.equals(this.teamId, employeeTeamReferenceResponse.teamId) &&
        Objects.equals(this.userId, employeeTeamReferenceResponse.userId) &&
        Objects.equals(this.employeeId, employeeTeamReferenceResponse.employeeId)&&
        Objects.equals(this.additionalProperties, employeeTeamReferenceResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeTeamReferenceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTeamReferenceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTeamReferenceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeTeamReferenceResponse is not found in the empty JSON string", EmployeeTeamReferenceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeTeamReferenceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeTeamReferenceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeTeamReferenceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeTeamReferenceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeTeamReferenceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeTeamReferenceResponse>() {
           @Override
           public void write(JsonWriter out, EmployeeTeamReferenceResponse value) throws IOException {
           ...
           @Override
           public EmployeeTeamReferenceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeTeamReferenceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeTeamReferenceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeTeamReferenceResponse
  * @throws IOException if the JSON string is invalid with respect to EmployeeTeamReferenceResponse
  */
  public static EmployeeTeamReferenceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeTeamReferenceResponse.class);
  }

 /**
  * Convert an instance of EmployeeTeamReferenceResponse to an JSON string
  *
  * @return JSON string
  */
