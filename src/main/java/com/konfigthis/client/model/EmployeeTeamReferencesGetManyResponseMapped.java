...
import com.konfigthis.client.model.EmployeeTeamReferenceRelationsResponse;
...
public class EmployeeTeamReferencesGetManyResponseMapped {
  ...
  private List<EmployeeTeamReferenceResponse> data = new ArrayList<>();
  ...
  private EmployeeTeamReferenceRelationsResponse relations;

  public EmployeeTeamReferencesGetManyResponseMapped() {
  }

  public EmployeeTeamReferencesGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public EmployeeTeamReferencesGetManyResponseMapped data(List<EmployeeTeamReferenceResponse> data) {
  ...
  public EmployeeTeamReferencesGetManyResponseMapped addDataItem(EmployeeTeamReferenceResponse dataItem) {
  ...
  **/
  ...
  public List<EmployeeTeamReferenceResponse> getData() {
    return data;
  }


  public void setData(List<EmployeeTeamReferenceResponse> data) {
  ...
  public EmployeeTeamReferencesGetManyResponseMapped total(Double total) {
  ...
  public EmployeeTeamReferencesGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public EmployeeTeamReferencesGetManyResponseMapped count(Double count) {
  ...
  public EmployeeTeamReferencesGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public EmployeeTeamReferencesGetManyResponseMapped offset(Double offset) {
  ...
  public EmployeeTeamReferencesGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public EmployeeTeamReferencesGetManyResponseMapped relations(EmployeeTeamReferenceRelationsResponse relations) {
  ...
  **/
  ...
  public EmployeeTeamReferenceRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(EmployeeTeamReferenceRelationsResponse relations) {
   ...
   * @return the EmployeeTeamReferencesGetManyResponseMapped instance itself
   */
  public EmployeeTeamReferencesGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeTeamReferencesGetManyResponseMapped employeeTeamReferencesGetManyResponseMapped = (EmployeeTeamReferencesGetManyResponseMapped) o;
    return Objects.equals(this.status, employeeTeamReferencesGetManyResponseMapped.status) &&
        Objects.equals(this.data, employeeTeamReferencesGetManyResponseMapped.data) &&
        Objects.equals(this.total, employeeTeamReferencesGetManyResponseMapped.total) &&
        Objects.equals(this.count, employeeTeamReferencesGetManyResponseMapped.count) &&
        Objects.equals(this.offset, employeeTeamReferencesGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, employeeTeamReferencesGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, employeeTeamReferencesGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeTeamReferencesGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTeamReferencesGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTeamReferencesGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeTeamReferencesGetManyResponseMapped is not found in the empty JSON string", EmployeeTeamReferencesGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeTeamReferencesGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        EmployeeTeamReferenceResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        EmployeeTeamReferenceRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeTeamReferencesGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeTeamReferencesGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeTeamReferencesGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeTeamReferencesGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeTeamReferencesGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmployeeTeamReferencesGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public EmployeeTeamReferencesGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeTeamReferencesGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeTeamReferencesGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeTeamReferencesGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmployeeTeamReferencesGetManyResponseMapped
  */
  public static EmployeeTeamReferencesGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeTeamReferencesGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of EmployeeTeamReferencesGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
