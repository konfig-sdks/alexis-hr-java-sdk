...
public class WorkWeekResponseMapped {
  ...
  public WorkWeekResponseMapped() {
  }

  public WorkWeekResponseMapped status(String status) {
  ...
  **/
  ...
  public WorkWeekResponseMapped data(WorkWeekResponse data) {
  ...
  **/
   ...
   * @return the WorkWeekResponseMapped instance itself
   */
  public WorkWeekResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkWeekResponseMapped workWeekResponseMapped = (WorkWeekResponseMapped) o;
    return Objects.equals(this.status, workWeekResponseMapped.status) &&
        Objects.equals(this.data, workWeekResponseMapped.data)&&
        Objects.equals(this.additionalProperties, workWeekResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkWeekResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkWeekResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkWeekResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkWeekResponseMapped is not found in the empty JSON string", WorkWeekResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkWeekResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkWeekResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkWeekResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkWeekResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkWeekResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkWeekResponseMapped>() {
           @Override
           public void write(JsonWriter out, WorkWeekResponseMapped value) throws IOException {
           ...
           @Override
           public WorkWeekResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkWeekResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkWeekResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkWeekResponseMapped
  * @throws IOException if the JSON string is invalid with respect to WorkWeekResponseMapped
  */
  public static WorkWeekResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkWeekResponseMapped.class);
  }

 /**
  * Convert an instance of WorkWeekResponseMapped to an JSON string
  *
  * @return JSON string
  */
