...
public class ChildResponse {
  ...
  public ChildResponse id(String id) {
  ...
  **/
  ...
  public ChildResponse employeeId(String employeeId) {
  ...
  **/
  ...
  public ChildResponse name(String name) {
  ...
  **/
  ...
  public ChildResponse birthdate(OffsetDateTime birthdate) {
  ...
  **/
   ...
   * @return the ChildResponse instance itself
   */
  public ChildResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChildResponse childResponse = (ChildResponse) o;
    return Objects.equals(this.id, childResponse.id) &&
        Objects.equals(this.employeeId, childResponse.employeeId) &&
        Objects.equals(this.name, childResponse.name) &&
        Objects.equals(this.birthdate, childResponse.birthdate)&&
        Objects.equals(this.additionalProperties, childResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChildResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChildResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChildResponse is not found in the empty JSON string", ChildResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChildResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChildResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChildResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChildResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChildResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ChildResponse>() {
           @Override
           public void write(JsonWriter out, ChildResponse value) throws IOException {
           ...
           @Override
           public ChildResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChildResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChildResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChildResponse
  * @throws IOException if the JSON string is invalid with respect to ChildResponse
  */
  public static ChildResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChildResponse.class);
  }

 /**
  * Convert an instance of ChildResponse to an JSON string
  *
  * @return JSON string
  */
