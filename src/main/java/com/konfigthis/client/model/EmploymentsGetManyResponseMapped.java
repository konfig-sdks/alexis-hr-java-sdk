...
import com.konfigthis.client.model.EmploymentRelationsResponse;
...
public class EmploymentsGetManyResponseMapped {
  ...
  private List<EmploymentResponse> data = new ArrayList<>();
  ...
  private EmploymentRelationsResponse relations;

  public EmploymentsGetManyResponseMapped() {
  }

  public EmploymentsGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public EmploymentsGetManyResponseMapped data(List<EmploymentResponse> data) {
  ...
  public EmploymentsGetManyResponseMapped addDataItem(EmploymentResponse dataItem) {
  ...
  **/
  ...
  public List<EmploymentResponse> getData() {
    return data;
  }


  public void setData(List<EmploymentResponse> data) {
  ...
  public EmploymentsGetManyResponseMapped total(Double total) {
  ...
  public EmploymentsGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public EmploymentsGetManyResponseMapped count(Double count) {
  ...
  public EmploymentsGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public EmploymentsGetManyResponseMapped offset(Double offset) {
  ...
  public EmploymentsGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public EmploymentsGetManyResponseMapped relations(EmploymentRelationsResponse relations) {
  ...
  **/
  ...
  public EmploymentRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(EmploymentRelationsResponse relations) {
   ...
   * @return the EmploymentsGetManyResponseMapped instance itself
   */
  public EmploymentsGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmploymentsGetManyResponseMapped employmentsGetManyResponseMapped = (EmploymentsGetManyResponseMapped) o;
    return Objects.equals(this.status, employmentsGetManyResponseMapped.status) &&
        Objects.equals(this.data, employmentsGetManyResponseMapped.data) &&
        Objects.equals(this.total, employmentsGetManyResponseMapped.total) &&
        Objects.equals(this.count, employmentsGetManyResponseMapped.count) &&
        Objects.equals(this.offset, employmentsGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, employmentsGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, employmentsGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmploymentsGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentsGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentsGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmploymentsGetManyResponseMapped is not found in the empty JSON string", EmploymentsGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmploymentsGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        EmploymentResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        EmploymentRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmploymentsGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmploymentsGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmploymentsGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmploymentsGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmploymentsGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmploymentsGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public EmploymentsGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmploymentsGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmploymentsGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmploymentsGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmploymentsGetManyResponseMapped
  */
  public static EmploymentsGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmploymentsGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of EmploymentsGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
