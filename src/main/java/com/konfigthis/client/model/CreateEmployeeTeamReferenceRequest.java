...
public class CreateEmployeeTeamReferenceRequest {
  ...
  public CreateEmployeeTeamReferenceRequest() {
  }

  public CreateEmployeeTeamReferenceRequest teamId(String teamId) {
  ...
  **/
  ...
  public CreateEmployeeTeamReferenceRequest companyId(String companyId) {
  ...
  **/
  ...
  public CreateEmployeeTeamReferenceRequest employeeId(String employeeId) {
  ...
  **/
  ...
  public CreateEmployeeTeamReferenceRequest userId(String userId) {
  ...
  **/
   ...
   * @return the CreateEmployeeTeamReferenceRequest instance itself
   */
  public CreateEmployeeTeamReferenceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEmployeeTeamReferenceRequest createEmployeeTeamReferenceRequest = (CreateEmployeeTeamReferenceRequest) o;
    return Objects.equals(this.teamId, createEmployeeTeamReferenceRequest.teamId) &&
        Objects.equals(this.companyId, createEmployeeTeamReferenceRequest.companyId) &&
        Objects.equals(this.employeeId, createEmployeeTeamReferenceRequest.employeeId) &&
        Objects.equals(this.userId, createEmployeeTeamReferenceRequest.userId)&&
        Objects.equals(this.additionalProperties, createEmployeeTeamReferenceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(teamId, companyId, employeeId, userId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateEmployeeTeamReferenceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateEmployeeTeamReferenceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateEmployeeTeamReferenceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEmployeeTeamReferenceRequest is not found in the empty JSON string", CreateEmployeeTeamReferenceRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateEmployeeTeamReferenceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEmployeeTeamReferenceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEmployeeTeamReferenceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEmployeeTeamReferenceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEmployeeTeamReferenceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEmployeeTeamReferenceRequest>() {
           @Override
           public void write(JsonWriter out, CreateEmployeeTeamReferenceRequest value) throws IOException {
           ...
           @Override
           public CreateEmployeeTeamReferenceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateEmployeeTeamReferenceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateEmployeeTeamReferenceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateEmployeeTeamReferenceRequest
  * @throws IOException if the JSON string is invalid with respect to CreateEmployeeTeamReferenceRequest
  */
  public static CreateEmployeeTeamReferenceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEmployeeTeamReferenceRequest.class);
  }

 /**
  * Convert an instance of CreateEmployeeTeamReferenceRequest to an JSON string
  *
  * @return JSON string
  */
