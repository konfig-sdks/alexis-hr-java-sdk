...
public class TimesheetRelationsResponse {
  public static final String SERIALIZED_NAME_APPROVER_EMPLOYEE = "approverEmployee";
  @SerializedName(SERIALIZED_NAME_APPROVER_EMPLOYEE)
  private List<EmployeeResponse> approverEmployee = null;

  public static final String SERIALIZED_NAME_EMPLOYEE = "employee";
  @SerializedName(SERIALIZED_NAME_EMPLOYEE)
  private List<EmployeeResponse> employee = null;

  public TimesheetRelationsResponse() {
  }

  public TimesheetRelationsResponse approverEmployee(List<EmployeeResponse> approverEmployee) {
  ...
  public TimesheetRelationsResponse addApproverEmployeeItem(EmployeeResponse approverEmployeeItem) {
    if (this.approverEmployee == null) {
      this.approverEmployee = new ArrayList<>();
    }
    this.approverEmployee.add(approverEmployeeItem);
    return this;
  }

   /**
   * Get approverEmployee
   * @return approverEmployee
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public List<EmployeeResponse> getApproverEmployee() {
    return approverEmployee;
  }


  public void setApproverEmployee(List<EmployeeResponse> approverEmployee) {
  ...
  public TimesheetRelationsResponse employee(List<EmployeeResponse> employee) {
  ...
  public TimesheetRelationsResponse addEmployeeItem(EmployeeResponse employeeItem) {
  ...
  **/
   ...
   * @return the TimesheetRelationsResponse instance itself
   */
  public TimesheetRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetRelationsResponse timesheetRelationsResponse = (TimesheetRelationsResponse) o;
    return Objects.equals(this.approverEmployee, timesheetRelationsResponse.approverEmployee) &&
        Objects.equals(this.employee, timesheetRelationsResponse.employee)&&
        Objects.equals(this.additionalProperties, timesheetRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approverEmployee, employee, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimesheetRelationsResponse {\n");
    sb.append("    approverEmployee: ").append(toIndentedString(approverEmployee)).append("\n");
  ...
  static {
    ...
    openapiFields.add("approverEmployee");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetRelationsResponse is not found in the empty JSON string", TimesheetRelationsResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("approverEmployee") != null && !jsonObj.get("approverEmployee").isJsonNull()) {
        JsonArray jsonArrayapproverEmployee = jsonObj.getAsJsonArray("approverEmployee");
        if (jsonArrayapproverEmployee != null) {
          // ensure the json data is an array
          if (!jsonObj.get("approverEmployee").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `approverEmployee` to be an array in the JSON string but got `%s`", jsonObj.get("approverEmployee").toString()));
          }

          // validate the optional field `approverEmployee` (array)
          for (int i = 0; i < jsonArrayapproverEmployee.size(); i++) {
            EmployeeResponse.validateJsonObject(jsonArrayapproverEmployee.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetRelationsResponse>() {
           @Override
           public void write(JsonWriter out, TimesheetRelationsResponse value) throws IOException {
           ...
           @Override
           public TimesheetRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to TimesheetRelationsResponse
  */
  public static TimesheetRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetRelationsResponse.class);
  }

 /**
  * Convert an instance of TimesheetRelationsResponse to an JSON string
  *
  * @return JSON string
  */
