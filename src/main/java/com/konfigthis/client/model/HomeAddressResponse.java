...
import com.konfigthis.client.model.PointResponse;
...
public class HomeAddressResponse {
  ...
  public HomeAddressResponse() {
  }

  public HomeAddressResponse street(String street) {
  ...
  **/
  ...
  public HomeAddressResponse postalCode(String postalCode) {
  ...
  **/
  ...
  public HomeAddressResponse city(String city) {
  ...
  **/
  ...
  public HomeAddressResponse country(String country) {
  ...
  **/
  ...
  public HomeAddressResponse location(PointResponse location) {
  ...
  **/
  ...
  public PointResponse getLocation() {
    return location;
  }


  public void setLocation(PointResponse location) {
   ...
   * @return the HomeAddressResponse instance itself
   */
  public HomeAddressResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HomeAddressResponse homeAddressResponse = (HomeAddressResponse) o;
    return Objects.equals(this.street, homeAddressResponse.street) &&
        Objects.equals(this.postalCode, homeAddressResponse.postalCode) &&
        Objects.equals(this.city, homeAddressResponse.city) &&
        Objects.equals(this.country, homeAddressResponse.country) &&
        Objects.equals(this.location, homeAddressResponse.location)&&
        Objects.equals(this.additionalProperties, homeAddressResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(street, postalCode, city, country, location, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HomeAddressResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to HomeAddressResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HomeAddressResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HomeAddressResponse is not found in the empty JSON string", HomeAddressResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        PointResponse.validateJsonObject(jsonObj.getAsJsonObject("location"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HomeAddressResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HomeAddressResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HomeAddressResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HomeAddressResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<HomeAddressResponse>() {
           @Override
           public void write(JsonWriter out, HomeAddressResponse value) throws IOException {
           ...
           @Override
           public HomeAddressResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             HomeAddressResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of HomeAddressResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HomeAddressResponse
  * @throws IOException if the JSON string is invalid with respect to HomeAddressResponse
  */
  public static HomeAddressResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HomeAddressResponse.class);
  }

 /**
  * Convert an instance of HomeAddressResponse to an JSON string
  *
  * @return JSON string
  */
