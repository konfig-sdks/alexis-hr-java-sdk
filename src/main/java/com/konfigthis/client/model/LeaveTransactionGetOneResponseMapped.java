...
public class LeaveTransactionGetOneResponseMapped {
  ...
  private LeaveTransactionResponse data;
  ...
  public LeaveTransactionGetOneResponseMapped() {
  }

  public LeaveTransactionGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public LeaveTransactionGetOneResponseMapped data(LeaveTransactionResponse data) {
  ...
  **/
  ...
  public LeaveTransactionResponse getData() {
    return data;
  }


  public void setData(LeaveTransactionResponse data) {
  ...
  public LeaveTransactionGetOneResponseMapped relations(LeaveTransactionRelationsResponse relations) {
  ...
  **/
   ...
   * @return the LeaveTransactionGetOneResponseMapped instance itself
   */
  public LeaveTransactionGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTransactionGetOneResponseMapped leaveTransactionGetOneResponseMapped = (LeaveTransactionGetOneResponseMapped) o;
    return Objects.equals(this.status, leaveTransactionGetOneResponseMapped.status) &&
        Objects.equals(this.data, leaveTransactionGetOneResponseMapped.data) &&
        Objects.equals(this.relations, leaveTransactionGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, leaveTransactionGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveTransactionGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTransactionGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTransactionGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTransactionGetOneResponseMapped is not found in the empty JSON string", LeaveTransactionGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveTransactionGetOneResponseMapped.openapiRequiredFields) {
      ...
      LeaveTransactionResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTransactionGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTransactionGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTransactionGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTransactionGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTransactionGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, LeaveTransactionGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public LeaveTransactionGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTransactionGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTransactionGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTransactionGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to LeaveTransactionGetOneResponseMapped
  */
  public static LeaveTransactionGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTransactionGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of LeaveTransactionGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
