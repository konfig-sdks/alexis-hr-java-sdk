...
public class CompanyListManyCompaniesFiltersParameter {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private CompanyListManyCompaniesFiltersParameterId id;

  public CompanyListManyCompaniesFiltersParameter() {
  }

  public CompanyListManyCompaniesFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
   ...
   * @return the CompanyListManyCompaniesFiltersParameter instance itself
   */
  public CompanyListManyCompaniesFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyListManyCompaniesFiltersParameter companyListManyCompaniesFiltersParameter = (CompanyListManyCompaniesFiltersParameter) o;
    return Objects.equals(this.id, companyListManyCompaniesFiltersParameter.id)&&
        Objects.equals(this.additionalProperties, companyListManyCompaniesFiltersParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyListManyCompaniesFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompanyListManyCompaniesFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompanyListManyCompaniesFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyListManyCompaniesFiltersParameter is not found in the empty JSON string", CompanyListManyCompaniesFiltersParameter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyListManyCompaniesFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyListManyCompaniesFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyListManyCompaniesFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyListManyCompaniesFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyListManyCompaniesFiltersParameter>() {
           @Override
           public void write(JsonWriter out, CompanyListManyCompaniesFiltersParameter value) throws IOException {
           ...
           @Override
           public CompanyListManyCompaniesFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompanyListManyCompaniesFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompanyListManyCompaniesFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompanyListManyCompaniesFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to CompanyListManyCompaniesFiltersParameter
  */
  public static CompanyListManyCompaniesFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyListManyCompaniesFiltersParameter.class);
  }

 /**
  * Convert an instance of CompanyListManyCompaniesFiltersParameter to an JSON string
  *
  * @return JSON string
  */
