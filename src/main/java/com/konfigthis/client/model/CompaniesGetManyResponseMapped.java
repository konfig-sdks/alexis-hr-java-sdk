...
public class CompaniesGetManyResponseMapped {
  ...
  public CompaniesGetManyResponseMapped() {
  }

  public CompaniesGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public CompaniesGetManyResponseMapped data(List<CompanyResponse> data) {
  ...
  public CompaniesGetManyResponseMapped addDataItem(CompanyResponse dataItem) {
  ...
  **/
  ...
  public CompaniesGetManyResponseMapped total(Double total) {
  ...
  public CompaniesGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public CompaniesGetManyResponseMapped count(Double count) {
  ...
  public CompaniesGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public CompaniesGetManyResponseMapped offset(Double offset) {
  ...
  public CompaniesGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public CompaniesGetManyResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the CompaniesGetManyResponseMapped instance itself
   */
  public CompaniesGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompaniesGetManyResponseMapped companiesGetManyResponseMapped = (CompaniesGetManyResponseMapped) o;
    return Objects.equals(this.status, companiesGetManyResponseMapped.status) &&
        Objects.equals(this.data, companiesGetManyResponseMapped.data) &&
        Objects.equals(this.total, companiesGetManyResponseMapped.total) &&
        Objects.equals(this.count, companiesGetManyResponseMapped.count) &&
        Objects.equals(this.offset, companiesGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, companiesGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, companiesGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompaniesGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompaniesGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompaniesGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompaniesGetManyResponseMapped is not found in the empty JSON string", CompaniesGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompaniesGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        CompanyResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompaniesGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompaniesGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompaniesGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompaniesGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CompaniesGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, CompaniesGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public CompaniesGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompaniesGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompaniesGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompaniesGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CompaniesGetManyResponseMapped
  */
  public static CompaniesGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompaniesGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of CompaniesGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
