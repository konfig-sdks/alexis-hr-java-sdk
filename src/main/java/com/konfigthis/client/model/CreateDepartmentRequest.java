...
public class CreateDepartmentRequest {
  ...
  **/
  ...
  public CreateDepartmentRequest costCenterId(String costCenterId) {
  ...
  **/
   ...
   * @return the CreateDepartmentRequest instance itself
   */
  public CreateDepartmentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, createDepartmentRequest.description) &&
        ...
        Objects.equals(this.costCenterId, createDepartmentRequest.costCenterId) &&
        Objects.equals(this.parentId, createDepartmentRequest.parentId)&&
        Objects.equals(this.additionalProperties, createDepartmentRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateDepartmentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateDepartmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDepartmentRequest is not found in the empty JSON string", CreateDepartmentRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDepartmentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDepartmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDepartmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDepartmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDepartmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDepartmentRequest>() {
           @Override
           public void write(JsonWriter out, CreateDepartmentRequest value) throws IOException {
           ...
           @Override
           public CreateDepartmentRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateDepartmentRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateDepartmentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateDepartmentRequest
  * @throws IOException if the JSON string is invalid with respect to CreateDepartmentRequest
  */
  public static CreateDepartmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDepartmentRequest.class);
  }

 /**
  * Convert an instance of CreateDepartmentRequest to an JSON string
  *
  * @return JSON string
  */
