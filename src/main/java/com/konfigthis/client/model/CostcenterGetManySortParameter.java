...
/**
 * CostcenterGetManySortParameter
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CostcenterGetManySortParameter {
  /**
   * Gets or Sets id
   */
 ...
 public enum NameEnum {
  ...
  public CostcenterGetManySortParameter() {
  }

  public CostcenterGetManySortParameter id(IdEnum id) {
  ...
  **/
  ...
  public CostcenterGetManySortParameter companyId(CompanyIdEnum companyId) {
  ...
  **/
  ...
  public CostcenterGetManySortParameter code(CodeEnum code) {
  ...
  **/
  ...
  public CostcenterGetManySortParameter name(NameEnum name) {
  ...
  **/
   ...
   * @return the CostcenterGetManySortParameter instance itself
   */
  public CostcenterGetManySortParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CostcenterGetManySortParameter costcenterGetManySortParameter = (CostcenterGetManySortParameter) o;
    return Objects.equals(this.id, costcenterGetManySortParameter.id) &&
        Objects.equals(this.companyId, costcenterGetManySortParameter.companyId) &&
        Objects.equals(this.code, costcenterGetManySortParameter.code) &&
        Objects.equals(this.name, costcenterGetManySortParameter.name)&&
        Objects.equals(this.additionalProperties, costcenterGetManySortParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostcenterGetManySortParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CostcenterGetManySortParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CostcenterGetManySortParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostcenterGetManySortParameter is not found in the empty JSON string", CostcenterGetManySortParameter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostcenterGetManySortParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostcenterGetManySortParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostcenterGetManySortParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostcenterGetManySortParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<CostcenterGetManySortParameter>() {
           @Override
           public void write(JsonWriter out, CostcenterGetManySortParameter value) throws IOException {
           ...
           @Override
           public CostcenterGetManySortParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CostcenterGetManySortParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CostcenterGetManySortParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CostcenterGetManySortParameter
  * @throws IOException if the JSON string is invalid with respect to CostcenterGetManySortParameter
  */
  public static CostcenterGetManySortParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostcenterGetManySortParameter.class);
  }

 /**
  * Convert an instance of CostcenterGetManySortParameter to an JSON string
  *
  * @return JSON string
  */
