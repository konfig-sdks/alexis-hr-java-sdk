...
public class PointResponse {
  ...
  **/
  ...
  public PointResponse coordinates(List<String> coordinates) {
  ...
  public PointResponse addCoordinatesItem(String coordinatesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[123,321]", required = true, value = "")
   ...
   * @return the PointResponse instance itself
   */
  public PointResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, pointResponse.type) &&
        Objects.equals(this.coordinates, pointResponse.coordinates)&&
        Objects.equals(this.additionalProperties, pointResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PointResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PointResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PointResponse is not found in the empty JSON string", PointResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PointResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PointResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PointResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PointResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PointResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PointResponse>() {
           @Override
           public void write(JsonWriter out, PointResponse value) throws IOException {
           ...
           @Override
           public PointResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PointResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PointResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PointResponse
  * @throws IOException if the JSON string is invalid with respect to PointResponse
  */
  public static PointResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PointResponse.class);
  }

 /**
  * Convert an instance of PointResponse to an JSON string
  *
  * @return JSON string
  */
