...
public class WorkShiftRequest {
  ...
  public WorkShiftRequest startHour(Double startHour) {
  ...
  public WorkShiftRequest startHour(Integer startHour) {
  ...
  **/
  ...
  public WorkShiftRequest startMinute(Double startMinute) {
  ...
  public WorkShiftRequest startMinute(Integer startMinute) {
  ...
  **/
  ...
  public WorkShiftRequest endHour(Double endHour) {
  ...
  public WorkShiftRequest endHour(Integer endHour) {
  ...
  **/
  ...
  public WorkShiftRequest endMinute(Double endMinute) {
  ...
  public WorkShiftRequest endMinute(Integer endMinute) {
  ...
  **/
  ...
  public WorkShiftRequest duration(Double duration) {
  ...
  public WorkShiftRequest duration(Integer duration) {
  ...
  **/
   ...
   * @return the WorkShiftRequest instance itself
   */
  public WorkShiftRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkShiftRequest workShiftRequest = (WorkShiftRequest) o;
    return Objects.equals(this.startHour, workShiftRequest.startHour) &&
        Objects.equals(this.startMinute, workShiftRequest.startMinute) &&
        Objects.equals(this.endHour, workShiftRequest.endHour) &&
        Objects.equals(this.endMinute, workShiftRequest.endMinute) &&
        Objects.equals(this.duration, workShiftRequest.duration)&&
        Objects.equals(this.additionalProperties, workShiftRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkShiftRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkShiftRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkShiftRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkShiftRequest is not found in the empty JSON string", WorkShiftRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkShiftRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkShiftRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkShiftRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkShiftRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkShiftRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkShiftRequest>() {
           @Override
           public void write(JsonWriter out, WorkShiftRequest value) throws IOException {
           ...
           @Override
           public WorkShiftRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkShiftRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkShiftRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkShiftRequest
  * @throws IOException if the JSON string is invalid with respect to WorkShiftRequest
  */
  public static WorkShiftRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkShiftRequest.class);
  }

 /**
  * Convert an instance of WorkShiftRequest to an JSON string
  *
  * @return JSON string
  */
