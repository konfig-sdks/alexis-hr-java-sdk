...
public class EmergencyContactResponse {
  ...
  public EmergencyContactResponse id(String id) {
  ...
  **/
  ...
  public EmergencyContactResponse employeeId(String employeeId) {
  ...
  **/
  ...
  public EmergencyContactResponse fullName(String fullName) {
  ...
  **/
  ...
  public EmergencyContactResponse relationship(String relationship) {
  ...
  **/
  ...
  public EmergencyContactResponse phone(String phone) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "+4612345678", required = true, value = "")
  ...
  public EmergencyContactResponse email(String email) {
  ...
  **/
   ...
   * @return the EmergencyContactResponse instance itself
   */
  public EmergencyContactResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmergencyContactResponse emergencyContactResponse = (EmergencyContactResponse) o;
    return Objects.equals(this.id, emergencyContactResponse.id) &&
        Objects.equals(this.employeeId, emergencyContactResponse.employeeId) &&
        Objects.equals(this.fullName, emergencyContactResponse.fullName) &&
        Objects.equals(this.relationship, emergencyContactResponse.relationship) &&
        Objects.equals(this.phone, emergencyContactResponse.phone) &&
        Objects.equals(this.email, emergencyContactResponse.email)&&
        Objects.equals(this.additionalProperties, emergencyContactResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, employeeId, fullName, relationship, phone, email, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmergencyContactResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmergencyContactResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmergencyContactResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmergencyContactResponse is not found in the empty JSON string", EmergencyContactResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmergencyContactResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmergencyContactResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmergencyContactResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmergencyContactResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmergencyContactResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmergencyContactResponse>() {
           @Override
           public void write(JsonWriter out, EmergencyContactResponse value) throws IOException {
           ...
           @Override
           public EmergencyContactResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmergencyContactResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmergencyContactResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmergencyContactResponse
  * @throws IOException if the JSON string is invalid with respect to EmergencyContactResponse
  */
  public static EmergencyContactResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmergencyContactResponse.class);
  }

 /**
  * Convert an instance of EmergencyContactResponse to an JSON string
  *
  * @return JSON string
  */
