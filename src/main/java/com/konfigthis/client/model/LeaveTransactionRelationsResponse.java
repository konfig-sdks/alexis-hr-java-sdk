...
public class LeaveTransactionRelationsResponse {
  ...
  private List<LeaveTypeResponse> leaveType = null;

  public static final String SERIALIZED_NAME_EMPLOYEE = "employee";
  @SerializedName(SERIALIZED_NAME_EMPLOYEE)
  private List<EmployeeResponse> employee = null;

  public LeaveTransactionRelationsResponse() {
  }

  public LeaveTransactionRelationsResponse child(List<ChildResponse> child) {
  ...
  public LeaveTransactionRelationsResponse addChildItem(ChildResponse childItem) {
    if (this.child == null) {
  ...
  **/
  ...
  public LeaveTransactionRelationsResponse leaveType(List<LeaveTypeResponse> leaveType) {
  ...
  public LeaveTransactionRelationsResponse addLeaveTypeItem(LeaveTypeResponse leaveTypeItem) {
  ...
  **/
  ...
  public void setLeaveType(List<LeaveTypeResponse> leaveType) {
  ...
  public LeaveTransactionRelationsResponse employee(List<EmployeeResponse> employee) {
  ...
  public LeaveTransactionRelationsResponse addEmployeeItem(EmployeeResponse employeeItem) {
  ...
  **/
   ...
   * @return the LeaveTransactionRelationsResponse instance itself
   */
  public LeaveTransactionRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTransactionRelationsResponse leaveTransactionRelationsResponse = (LeaveTransactionRelationsResponse) o;
    return Objects.equals(this.child, leaveTransactionRelationsResponse.child) &&
        Objects.equals(this.leaveType, leaveTransactionRelationsResponse.leaveType) &&
        Objects.equals(this.employee, leaveTransactionRelationsResponse.employee)&&
        Objects.equals(this.additionalProperties, leaveTransactionRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(child, leaveType, employee, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LeaveTransactionRelationsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTransactionRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTransactionRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTransactionRelationsResponse is not found in the empty JSON string", LeaveTransactionRelationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("leaveType") != null && !jsonObj.get("leaveType").isJsonNull()) {
        JsonArray jsonArrayleaveType = jsonObj.getAsJsonArray("leaveType");
        if (jsonArrayleaveType != null) {
          // ensure the json data is an array
          if (!jsonObj.get("leaveType").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `leaveType` to be an array in the JSON string but got `%s`", jsonObj.get("leaveType").toString()));
          }

          // validate the optional field `leaveType` (array)
          for (int i = 0; i < jsonArrayleaveType.size(); i++) {
            LeaveTypeResponse.validateJsonObject(jsonArrayleaveType.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTransactionRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTransactionRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTransactionRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTransactionRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTransactionRelationsResponse>() {
           @Override
           public void write(JsonWriter out, LeaveTransactionRelationsResponse value) throws IOException {
           ...
           @Override
           public LeaveTransactionRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTransactionRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTransactionRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTransactionRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveTransactionRelationsResponse
  */
  public static LeaveTransactionRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTransactionRelationsResponse.class);
  }

 /**
  * Convert an instance of LeaveTransactionRelationsResponse to an JSON string
  *
  * @return JSON string
  */
