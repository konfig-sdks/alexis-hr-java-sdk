...
public class UpdateEmployeeTeamReferenceRequest {
  public static final String SERIALIZED_NAME_TEAM_ID = "teamId";
  @SerializedName(SERIALIZED_NAME_TEAM_ID)
  private String teamId;

  public UpdateEmployeeTeamReferenceRequest() {
  }

  public UpdateEmployeeTeamReferenceRequest teamId(String teamId) {
  ...
  **/
   ...
   * @return the UpdateEmployeeTeamReferenceRequest instance itself
   */
  public UpdateEmployeeTeamReferenceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEmployeeTeamReferenceRequest updateEmployeeTeamReferenceRequest = (UpdateEmployeeTeamReferenceRequest) o;
    return Objects.equals(this.teamId, updateEmployeeTeamReferenceRequest.teamId)&&
        Objects.equals(this.additionalProperties, updateEmployeeTeamReferenceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(teamId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateEmployeeTeamReferenceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateEmployeeTeamReferenceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateEmployeeTeamReferenceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEmployeeTeamReferenceRequest is not found in the empty JSON string", UpdateEmployeeTeamReferenceRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEmployeeTeamReferenceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEmployeeTeamReferenceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEmployeeTeamReferenceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEmployeeTeamReferenceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEmployeeTeamReferenceRequest>() {
           @Override
           public void write(JsonWriter out, UpdateEmployeeTeamReferenceRequest value) throws IOException {
           ...
           @Override
           public UpdateEmployeeTeamReferenceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateEmployeeTeamReferenceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateEmployeeTeamReferenceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateEmployeeTeamReferenceRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateEmployeeTeamReferenceRequest
  */
  public static UpdateEmployeeTeamReferenceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEmployeeTeamReferenceRequest.class);
  }

 /**
  * Convert an instance of UpdateEmployeeTeamReferenceRequest to an JSON string
  *
  * @return JSON string
  */
