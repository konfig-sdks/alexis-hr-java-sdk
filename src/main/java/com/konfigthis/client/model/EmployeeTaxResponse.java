...
public class EmployeeTaxResponse {
  ...
  public EmployeeTaxResponse table(Double table) {
  ...
  public EmployeeTaxResponse table(Integer table) {
    
    
    
    
    this.table = table.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public EmployeeTaxResponse column(Double column) {
  ...
  public EmployeeTaxResponse column(Integer column) {
    
    
    
    
    this.column = column.doubleValue();
    return this;
  }
  ...
  **/
   ...
   * @return the EmployeeTaxResponse instance itself
   */
  public EmployeeTaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeTaxResponse employeeTaxResponse = (EmployeeTaxResponse) o;
    return Objects.equals(this.table, employeeTaxResponse.table) &&
        Objects.equals(this.column, employeeTaxResponse.column)&&
        Objects.equals(this.additionalProperties, employeeTaxResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(table, column, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeeTaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeTaxResponse is not found in the empty JSON string", EmployeeTaxResponse.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeTaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeTaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeTaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeTaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeTaxResponse>() {
           @Override
           public void write(JsonWriter out, EmployeeTaxResponse value) throws IOException {
           ...
           @Override
           public EmployeeTaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeTaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeTaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeTaxResponse
  * @throws IOException if the JSON string is invalid with respect to EmployeeTaxResponse
  */
  public static EmployeeTaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeTaxResponse.class);
  }

 /**
  * Convert an instance of EmployeeTaxResponse to an JSON string
  *
  * @return JSON string
  */
