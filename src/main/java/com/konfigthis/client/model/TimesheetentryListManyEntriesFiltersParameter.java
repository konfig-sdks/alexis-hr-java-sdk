...
public class TimesheetentryListManyEntriesFiltersParameter {
  ...
  private CompanyListManyCompaniesFiltersParameterId timesheetId;
  ...
  private CompanyListManyCompaniesFiltersParameterId minutes;

  public static final String SERIALIZED_NAME_NOTE = "note";
  @SerializedName(SERIALIZED_NAME_NOTE)
  private CompanyListManyCompaniesFiltersParameterId note;

  public TimesheetentryListManyEntriesFiltersParameter() {
  }

  public TimesheetentryListManyEntriesFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
  ...
  public TimesheetentryListManyEntriesFiltersParameter timesheetId(CompanyListManyCompaniesFiltersParameterId timesheetId) {
  ...
  **/
  ...
  public CompanyListManyCompaniesFiltersParameterId getTimesheetId() {
    return timesheetId;
  }


  public void setTimesheetId(CompanyListManyCompaniesFiltersParameterId timesheetId) {
  ...
  public TimesheetentryListManyEntriesFiltersParameter typeId(CompanyListManyCompaniesFiltersParameterId typeId) {
  ...
  **/
  ...
  public TimesheetentryListManyEntriesFiltersParameter employeeId(CompanyListManyCompaniesFiltersParameterId employeeId) {
  ...
  **/
  ...
  public TimesheetentryListManyEntriesFiltersParameter date(CompanyListManyCompaniesFiltersParameterId date) {
  ...
  **/
  ...
  public TimesheetentryListManyEntriesFiltersParameter updated(CompanyListManyCompaniesFiltersParameterId updated) {
  ...
  **/
  ...
  public TimesheetentryListManyEntriesFiltersParameter status(CompanyListManyCompaniesFiltersParameterId status) {
  ...
  **/
  ...
  public TimesheetentryListManyEntriesFiltersParameter minutes(CompanyListManyCompaniesFiltersParameterId minutes) {
  ...
  **/
  ...
  public CompanyListManyCompaniesFiltersParameterId getMinutes() {
    return minutes;
  }


  public void setMinutes(CompanyListManyCompaniesFiltersParameterId minutes) {
  ...
  public TimesheetentryListManyEntriesFiltersParameter note(CompanyListManyCompaniesFiltersParameterId note) {
  ...
  **/
   ...
   * @return the TimesheetentryListManyEntriesFiltersParameter instance itself
   */
  public TimesheetentryListManyEntriesFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetentryListManyEntriesFiltersParameter timesheetentryListManyEntriesFiltersParameter = (TimesheetentryListManyEntriesFiltersParameter) o;
    return Objects.equals(this.id, timesheetentryListManyEntriesFiltersParameter.id) &&
        Objects.equals(this.timesheetId, timesheetentryListManyEntriesFiltersParameter.timesheetId) &&
        Objects.equals(this.typeId, timesheetentryListManyEntriesFiltersParameter.typeId) &&
        Objects.equals(this.employeeId, timesheetentryListManyEntriesFiltersParameter.employeeId) &&
        Objects.equals(this.date, timesheetentryListManyEntriesFiltersParameter.date) &&
        Objects.equals(this.updated, timesheetentryListManyEntriesFiltersParameter.updated) &&
        Objects.equals(this.status, timesheetentryListManyEntriesFiltersParameter.status) &&
        Objects.equals(this.minutes, timesheetentryListManyEntriesFiltersParameter.minutes) &&
        Objects.equals(this.note, timesheetentryListManyEntriesFiltersParameter.note)&&
        Objects.equals(this.additionalProperties, timesheetentryListManyEntriesFiltersParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetentryListManyEntriesFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetentryListManyEntriesFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetentryListManyEntriesFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetentryListManyEntriesFiltersParameter is not found in the empty JSON string", TimesheetentryListManyEntriesFiltersParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `timesheetId`
      if (jsonObj.get("timesheetId") != null && !jsonObj.get("timesheetId").isJsonNull()) {
        CompanyListManyCompaniesFiltersParameterId.validateJsonObject(jsonObj.getAsJsonObject("timesheetId"));
      }
      ...
      if (jsonObj.get("minutes") != null && !jsonObj.get("minutes").isJsonNull()) {
        CompanyListManyCompaniesFiltersParameterId.validateJsonObject(jsonObj.getAsJsonObject("minutes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetentryListManyEntriesFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetentryListManyEntriesFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetentryListManyEntriesFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetentryListManyEntriesFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetentryListManyEntriesFiltersParameter>() {
           @Override
           public void write(JsonWriter out, TimesheetentryListManyEntriesFiltersParameter value) throws IOException {
           ...
           @Override
           public TimesheetentryListManyEntriesFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetentryListManyEntriesFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetentryListManyEntriesFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetentryListManyEntriesFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to TimesheetentryListManyEntriesFiltersParameter
  */
  public static TimesheetentryListManyEntriesFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetentryListManyEntriesFiltersParameter.class);
  }

 /**
  * Convert an instance of TimesheetentryListManyEntriesFiltersParameter to an JSON string
  *
  * @return JSON string
  */
