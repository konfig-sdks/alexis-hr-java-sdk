...
import com.konfigthis.client.model.TimesheetRelationsResponse;
...
public class TimesheetsGetManyResponseMapped {
  ...
  private List<TimesheetResponse> data = new ArrayList<>();
  ...
  private TimesheetRelationsResponse relations;

  public TimesheetsGetManyResponseMapped() {
  }

  public TimesheetsGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public TimesheetsGetManyResponseMapped data(List<TimesheetResponse> data) {
  ...
  public TimesheetsGetManyResponseMapped addDataItem(TimesheetResponse dataItem) {
  ...
  **/
  ...
  public TimesheetsGetManyResponseMapped total(Double total) {
  ...
  public TimesheetsGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public TimesheetsGetManyResponseMapped count(Double count) {
  ...
  public TimesheetsGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public TimesheetsGetManyResponseMapped offset(Double offset) {
  ...
  public TimesheetsGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public TimesheetsGetManyResponseMapped relations(TimesheetRelationsResponse relations) {
  ...
  **/
  ...
  public TimesheetRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(TimesheetRelationsResponse relations) {
   ...
   * @return the TimesheetsGetManyResponseMapped instance itself
   */
  public TimesheetsGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetsGetManyResponseMapped timesheetsGetManyResponseMapped = (TimesheetsGetManyResponseMapped) o;
    return Objects.equals(this.status, timesheetsGetManyResponseMapped.status) &&
        Objects.equals(this.data, timesheetsGetManyResponseMapped.data) &&
        Objects.equals(this.total, timesheetsGetManyResponseMapped.total) &&
        Objects.equals(this.count, timesheetsGetManyResponseMapped.count) &&
        Objects.equals(this.offset, timesheetsGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, timesheetsGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, timesheetsGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetsGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetsGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetsGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetsGetManyResponseMapped is not found in the empty JSON string", TimesheetsGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetsGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        TimesheetResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        TimesheetRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetsGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetsGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetsGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetsGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetsGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, TimesheetsGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public TimesheetsGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetsGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetsGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetsGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TimesheetsGetManyResponseMapped
  */
  public static TimesheetsGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetsGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of TimesheetsGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
