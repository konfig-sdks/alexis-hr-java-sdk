...
public class OfficeGetOneResponseMapped {
  ...
  public OfficeGetOneResponseMapped() {
  }

  public OfficeGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public OfficeGetOneResponseMapped data(OfficeResponse data) {
  ...
  **/
  ...
  public OfficeResponse getData() {
    return data;
  }


  public void setData(OfficeResponse data) {
  ...
  public OfficeGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the OfficeGetOneResponseMapped instance itself
   */
  public OfficeGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OfficeGetOneResponseMapped officeGetOneResponseMapped = (OfficeGetOneResponseMapped) o;
    return Objects.equals(this.status, officeGetOneResponseMapped.status) &&
        Objects.equals(this.data, officeGetOneResponseMapped.data) &&
        Objects.equals(this.relations, officeGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, officeGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OfficeGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OfficeGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OfficeGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OfficeGetOneResponseMapped is not found in the empty JSON string", OfficeGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OfficeGetOneResponseMapped.openapiRequiredFields) {
      ...
      OfficeResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OfficeGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OfficeGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OfficeGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OfficeGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<OfficeGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, OfficeGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public OfficeGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OfficeGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OfficeGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OfficeGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to OfficeGetOneResponseMapped
  */
  public static OfficeGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OfficeGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of OfficeGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
