...
public class EmploymentTypesGetManyResponseMapped {
  ...
  private List<EmploymentTypeResponse> data = new ArrayList<>();
  ...
  public EmploymentTypesGetManyResponseMapped() {
  }

  public EmploymentTypesGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public EmploymentTypesGetManyResponseMapped data(List<EmploymentTypeResponse> data) {
  ...
  public EmploymentTypesGetManyResponseMapped addDataItem(EmploymentTypeResponse dataItem) {
  ...
  **/
  ...
  public List<EmploymentTypeResponse> getData() {
    return data;
  }


  public void setData(List<EmploymentTypeResponse> data) {
  ...
  public EmploymentTypesGetManyResponseMapped total(Double total) {
  ...
  public EmploymentTypesGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public EmploymentTypesGetManyResponseMapped count(Double count) {
  ...
  public EmploymentTypesGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public EmploymentTypesGetManyResponseMapped offset(Double offset) {
  ...
  public EmploymentTypesGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public EmploymentTypesGetManyResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the EmploymentTypesGetManyResponseMapped instance itself
   */
  public EmploymentTypesGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmploymentTypesGetManyResponseMapped employmentTypesGetManyResponseMapped = (EmploymentTypesGetManyResponseMapped) o;
    return Objects.equals(this.status, employmentTypesGetManyResponseMapped.status) &&
        Objects.equals(this.data, employmentTypesGetManyResponseMapped.data) &&
        Objects.equals(this.total, employmentTypesGetManyResponseMapped.total) &&
        Objects.equals(this.count, employmentTypesGetManyResponseMapped.count) &&
        Objects.equals(this.offset, employmentTypesGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, employmentTypesGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, employmentTypesGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmploymentTypesGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentTypesGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentTypesGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmploymentTypesGetManyResponseMapped is not found in the empty JSON string", EmploymentTypesGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmploymentTypesGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        EmploymentTypeResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmploymentTypesGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmploymentTypesGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmploymentTypesGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmploymentTypesGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmploymentTypesGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmploymentTypesGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public EmploymentTypesGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmploymentTypesGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmploymentTypesGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmploymentTypesGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmploymentTypesGetManyResponseMapped
  */
  public static EmploymentTypesGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmploymentTypesGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of EmploymentTypesGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
