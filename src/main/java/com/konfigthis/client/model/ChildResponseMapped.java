...
public class ChildResponseMapped {
  ...
  public ChildResponseMapped() {
  }

  public ChildResponseMapped status(String status) {
  ...
  **/
  ...
  public ChildResponseMapped data(ChildResponse data) {
  ...
  **/
   ...
   * @return the ChildResponseMapped instance itself
   */
  public ChildResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChildResponseMapped childResponseMapped = (ChildResponseMapped) o;
    return Objects.equals(this.status, childResponseMapped.status) &&
        Objects.equals(this.data, childResponseMapped.data)&&
        Objects.equals(this.additionalProperties, childResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChildResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChildResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChildResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChildResponseMapped is not found in the empty JSON string", ChildResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChildResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChildResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChildResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChildResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChildResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<ChildResponseMapped>() {
           @Override
           public void write(JsonWriter out, ChildResponseMapped value) throws IOException {
           ...
           @Override
           public ChildResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChildResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChildResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChildResponseMapped
  * @throws IOException if the JSON string is invalid with respect to ChildResponseMapped
  */
  public static ChildResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChildResponseMapped.class);
  }

 /**
  * Convert an instance of ChildResponseMapped to an JSON string
  *
  * @return JSON string
  */
