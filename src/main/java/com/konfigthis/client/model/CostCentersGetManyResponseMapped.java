...
public class CostCentersGetManyResponseMapped {
  ...
  private List<CostCenterResponse> data = new ArrayList<>();
  ...
  public CostCentersGetManyResponseMapped() {
  }

  public CostCentersGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public CostCentersGetManyResponseMapped data(List<CostCenterResponse> data) {
  ...
  public CostCentersGetManyResponseMapped addDataItem(CostCenterResponse dataItem) {
  ...
  **/
  ...
  public List<CostCenterResponse> getData() {
    return data;
  }


  public void setData(List<CostCenterResponse> data) {
  ...
  public CostCentersGetManyResponseMapped total(Double total) {
  ...
  public CostCentersGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public CostCentersGetManyResponseMapped count(Double count) {
  ...
  public CostCentersGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public CostCentersGetManyResponseMapped offset(Double offset) {
  ...
  public CostCentersGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public CostCentersGetManyResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the CostCentersGetManyResponseMapped instance itself
   */
  public CostCentersGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CostCentersGetManyResponseMapped costCentersGetManyResponseMapped = (CostCentersGetManyResponseMapped) o;
    return Objects.equals(this.status, costCentersGetManyResponseMapped.status) &&
        Objects.equals(this.data, costCentersGetManyResponseMapped.data) &&
        Objects.equals(this.total, costCentersGetManyResponseMapped.total) &&
        Objects.equals(this.count, costCentersGetManyResponseMapped.count) &&
        Objects.equals(this.offset, costCentersGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, costCentersGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, costCentersGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostCentersGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CostCentersGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CostCentersGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostCentersGetManyResponseMapped is not found in the empty JSON string", CostCentersGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CostCentersGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        CostCenterResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostCentersGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostCentersGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostCentersGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostCentersGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CostCentersGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, CostCentersGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public CostCentersGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CostCentersGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CostCentersGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CostCentersGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CostCentersGetManyResponseMapped
  */
  public static CostCentersGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostCentersGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of CostCentersGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
