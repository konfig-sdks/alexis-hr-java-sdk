...
public class DepartmentRelationsResponse {
  ...
  public DepartmentRelationsResponse() {
  }

  public DepartmentRelationsResponse costCenter(List<CostCenterResponse> costCenter) {
  ...
  public DepartmentRelationsResponse addCostCenterItem(CostCenterResponse costCenterItem) {
  ...
  **/
  ...
  public DepartmentRelationsResponse effectiveCostCenter(List<CostCenterResponse> effectiveCostCenter) {
  ...
  public DepartmentRelationsResponse addEffectiveCostCenterItem(CostCenterResponse effectiveCostCenterItem) {
  ...
  **/
   ...
   * @return the DepartmentRelationsResponse instance itself
   */
  public DepartmentRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DepartmentRelationsResponse departmentRelationsResponse = (DepartmentRelationsResponse) o;
    return Objects.equals(this.costCenter, departmentRelationsResponse.costCenter) &&
        Objects.equals(this.effectiveCostCenter, departmentRelationsResponse.effectiveCostCenter)&&
        Objects.equals(this.additionalProperties, departmentRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(costCenter, effectiveCostCenter, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DepartmentRelationsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DepartmentRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DepartmentRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepartmentRelationsResponse is not found in the empty JSON string", DepartmentRelationsResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepartmentRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepartmentRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepartmentRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepartmentRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DepartmentRelationsResponse>() {
           @Override
           public void write(JsonWriter out, DepartmentRelationsResponse value) throws IOException {
           ...
           @Override
           public DepartmentRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DepartmentRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DepartmentRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DepartmentRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to DepartmentRelationsResponse
  */
  public static DepartmentRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepartmentRelationsResponse.class);
  }

 /**
  * Convert an instance of DepartmentRelationsResponse to an JSON string
  *
  * @return JSON string
  */
