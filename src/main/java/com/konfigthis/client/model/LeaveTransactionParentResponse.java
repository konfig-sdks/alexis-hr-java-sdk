...
public class LeaveTransactionParentResponse {
 ...
 public enum TypeEnum {
  ...
  public LeaveTransactionParentResponse() {
  }

  public LeaveTransactionParentResponse id(String id) {
  ...
  **/
  ...
  public LeaveTransactionParentResponse type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "LEAVE", required = true, value = "")
   ...
   * @return the LeaveTransactionParentResponse instance itself
   */
  public LeaveTransactionParentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTransactionParentResponse leaveTransactionParentResponse = (LeaveTransactionParentResponse) o;
    return Objects.equals(this.id, leaveTransactionParentResponse.id) &&
        Objects.equals(this.type, leaveTransactionParentResponse.type)&&
        Objects.equals(this.additionalProperties, leaveTransactionParentResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveTransactionParentResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTransactionParentResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTransactionParentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTransactionParentResponse is not found in the empty JSON string", LeaveTransactionParentResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveTransactionParentResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTransactionParentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTransactionParentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTransactionParentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTransactionParentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTransactionParentResponse>() {
           @Override
           public void write(JsonWriter out, LeaveTransactionParentResponse value) throws IOException {
           ...
           @Override
           public LeaveTransactionParentResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTransactionParentResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTransactionParentResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTransactionParentResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveTransactionParentResponse
  */
  public static LeaveTransactionParentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTransactionParentResponse.class);
  }

 /**
  * Convert an instance of LeaveTransactionParentResponse to an JSON string
  *
  * @return JSON string
  */
