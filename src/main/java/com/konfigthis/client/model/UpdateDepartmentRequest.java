...
public class UpdateDepartmentRequest {
  ...
  **/
  ...
  public UpdateDepartmentRequest costCenterId(String costCenterId) {
  ...
  **/
  ...
  public UpdateDepartmentRequest parentId(String parentId) {
  ...
  **/
   ...
   * @return the UpdateDepartmentRequest instance itself
   */
  public UpdateDepartmentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, updateDepartmentRequest.description) &&
        Objects.equals(this.name, updateDepartmentRequest.name) &&
        Objects.equals(this.costCenterId, updateDepartmentRequest.costCenterId) &&
        Objects.equals(this.parentId, updateDepartmentRequest.parentId)&&
        Objects.equals(this.additionalProperties, updateDepartmentRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, name, costCenterId, parentId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateDepartmentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateDepartmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDepartmentRequest is not found in the empty JSON string", UpdateDepartmentRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDepartmentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDepartmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDepartmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDepartmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDepartmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDepartmentRequest>() {
           @Override
           public void write(JsonWriter out, UpdateDepartmentRequest value) throws IOException {
           ...
           @Override
           public UpdateDepartmentRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateDepartmentRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateDepartmentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateDepartmentRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateDepartmentRequest
  */
  public static UpdateDepartmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDepartmentRequest.class);
  }

 /**
  * Convert an instance of UpdateDepartmentRequest to an JSON string
  *
  * @return JSON string
  */
