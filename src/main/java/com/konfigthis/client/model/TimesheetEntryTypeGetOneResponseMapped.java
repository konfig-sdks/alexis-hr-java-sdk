...
public class TimesheetEntryTypeGetOneResponseMapped {
  ...
  private TimesheetEntryTypeResponse data;
  ...
  public TimesheetEntryTypeGetOneResponseMapped() {
  }

  public TimesheetEntryTypeGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public TimesheetEntryTypeGetOneResponseMapped data(TimesheetEntryTypeResponse data) {
  ...
  **/
  ...
  public TimesheetEntryTypeResponse getData() {
    return data;
  }


  public void setData(TimesheetEntryTypeResponse data) {
  ...
  public TimesheetEntryTypeGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the TimesheetEntryTypeGetOneResponseMapped instance itself
   */
  public TimesheetEntryTypeGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntryTypeGetOneResponseMapped timesheetEntryTypeGetOneResponseMapped = (TimesheetEntryTypeGetOneResponseMapped) o;
    return Objects.equals(this.status, timesheetEntryTypeGetOneResponseMapped.status) &&
        Objects.equals(this.data, timesheetEntryTypeGetOneResponseMapped.data) &&
        Objects.equals(this.relations, timesheetEntryTypeGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, timesheetEntryTypeGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetEntryTypeGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntryTypeGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntryTypeGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntryTypeGetOneResponseMapped is not found in the empty JSON string", TimesheetEntryTypeGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetEntryTypeGetOneResponseMapped.openapiRequiredFields) {
      ...
      TimesheetEntryTypeResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntryTypeGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntryTypeGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntryTypeGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntryTypeGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntryTypeGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, TimesheetEntryTypeGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public TimesheetEntryTypeGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntryTypeGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntryTypeGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntryTypeGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntryTypeGetOneResponseMapped
  */
  public static TimesheetEntryTypeGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntryTypeGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of TimesheetEntryTypeGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
