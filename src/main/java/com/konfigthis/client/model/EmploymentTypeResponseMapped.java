...
public class EmploymentTypeResponseMapped {
  ...
  public EmploymentTypeResponseMapped() {
  }

  public EmploymentTypeResponseMapped status(String status) {
  ...
  **/
  ...
  public EmploymentTypeResponseMapped data(EmploymentTypeResponse data) {
  ...
  **/
   ...
   * @return the EmploymentTypeResponseMapped instance itself
   */
  public EmploymentTypeResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmploymentTypeResponseMapped employmentTypeResponseMapped = (EmploymentTypeResponseMapped) o;
    return Objects.equals(this.status, employmentTypeResponseMapped.status) &&
        Objects.equals(this.data, employmentTypeResponseMapped.data)&&
        Objects.equals(this.additionalProperties, employmentTypeResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmploymentTypeResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentTypeResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentTypeResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmploymentTypeResponseMapped is not found in the empty JSON string", EmploymentTypeResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmploymentTypeResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmploymentTypeResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmploymentTypeResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmploymentTypeResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmploymentTypeResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmploymentTypeResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmploymentTypeResponseMapped value) throws IOException {
           ...
           @Override
           public EmploymentTypeResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmploymentTypeResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmploymentTypeResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmploymentTypeResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmploymentTypeResponseMapped
  */
  public static EmploymentTypeResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmploymentTypeResponseMapped.class);
  }

 /**
  * Convert an instance of EmploymentTypeResponseMapped to an JSON string
  *
  * @return JSON string
  */
