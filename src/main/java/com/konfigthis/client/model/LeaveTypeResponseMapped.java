...
public class LeaveTypeResponseMapped {
  ...
  public LeaveTypeResponseMapped() {
  }

  public LeaveTypeResponseMapped status(String status) {
  ...
  **/
  ...
  public LeaveTypeResponseMapped data(LeaveTypeResponse data) {
  ...
  **/
   ...
   * @return the LeaveTypeResponseMapped instance itself
   */
  public LeaveTypeResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTypeResponseMapped leaveTypeResponseMapped = (LeaveTypeResponseMapped) o;
    return Objects.equals(this.status, leaveTypeResponseMapped.status) &&
        Objects.equals(this.data, leaveTypeResponseMapped.data)&&
        Objects.equals(this.additionalProperties, leaveTypeResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveTypeResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTypeResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTypeResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTypeResponseMapped is not found in the empty JSON string", LeaveTypeResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveTypeResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTypeResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTypeResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTypeResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTypeResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTypeResponseMapped>() {
           @Override
           public void write(JsonWriter out, LeaveTypeResponseMapped value) throws IOException {
           ...
           @Override
           public LeaveTypeResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTypeResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTypeResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTypeResponseMapped
  * @throws IOException if the JSON string is invalid with respect to LeaveTypeResponseMapped
  */
  public static LeaveTypeResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTypeResponseMapped.class);
  }

 /**
  * Convert an instance of LeaveTypeResponseMapped to an JSON string
  *
  * @return JSON string
  */
