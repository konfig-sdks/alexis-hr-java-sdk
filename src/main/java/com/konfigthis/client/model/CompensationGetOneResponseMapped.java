...
public class CompensationGetOneResponseMapped {
  ...
  private CompensationResponse data;
  ...
  public CompensationGetOneResponseMapped() {
  }

  public CompensationGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public CompensationGetOneResponseMapped data(CompensationResponse data) {
  ...
  **/
  ...
  public CompensationResponse getData() {
    return data;
  }


  public void setData(CompensationResponse data) {
  ...
  public CompensationGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the CompensationGetOneResponseMapped instance itself
   */
  public CompensationGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompensationGetOneResponseMapped compensationGetOneResponseMapped = (CompensationGetOneResponseMapped) o;
    return Objects.equals(this.status, compensationGetOneResponseMapped.status) &&
        Objects.equals(this.data, compensationGetOneResponseMapped.data) &&
        Objects.equals(this.relations, compensationGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, compensationGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompensationGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompensationGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompensationGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompensationGetOneResponseMapped is not found in the empty JSON string", CompensationGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompensationGetOneResponseMapped.openapiRequiredFields) {
      ...
      CompensationResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompensationGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompensationGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompensationGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompensationGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CompensationGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, CompensationGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public CompensationGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompensationGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompensationGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompensationGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CompensationGetOneResponseMapped
  */
  public static CompensationGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompensationGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of CompensationGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
