...
import com.konfigthis.client.model.TimesheetResponse;
...
public class TimesheetEntryRelationsResponse {
  public static final String SERIALIZED_NAME_EMPLOYEE = "employee";
  @SerializedName(SERIALIZED_NAME_EMPLOYEE)
  private List<EmployeeResponse> employee = null;

  public static final String SERIALIZED_NAME_TIMESHEET = "timesheet";
  @SerializedName(SERIALIZED_NAME_TIMESHEET)
  private List<TimesheetResponse> timesheet = null;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private List<TimesheetEntryTypeResponse> type = null;

  public TimesheetEntryRelationsResponse() {
  }

  public TimesheetEntryRelationsResponse employee(List<EmployeeResponse> employee) {
  ...
  public TimesheetEntryRelationsResponse addEmployeeItem(EmployeeResponse employeeItem) {
  ...
  **/
  ...
  public TimesheetEntryRelationsResponse timesheet(List<TimesheetResponse> timesheet) {
  ...
  public TimesheetEntryRelationsResponse addTimesheetItem(TimesheetResponse timesheetItem) {
    if (this.timesheet == null) {
      this.timesheet = new ArrayList<>();
    }
    this.timesheet.add(timesheetItem);
    return this;
  }
  ...
  **/
  ...
  public void setTimesheet(List<TimesheetResponse> timesheet) {
  ...
  public TimesheetEntryRelationsResponse type(List<TimesheetEntryTypeResponse> type) {
  ...
  public TimesheetEntryRelationsResponse addTypeItem(TimesheetEntryTypeResponse typeItem) {
    if (this.type == null) {
  ...
  **/
  ...
  public List<TimesheetEntryTypeResponse> getType() {
    return type;
  }


  public void setType(List<TimesheetEntryTypeResponse> type) {
   ...
   * @return the TimesheetEntryRelationsResponse instance itself
   */
  public TimesheetEntryRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntryRelationsResponse timesheetEntryRelationsResponse = (TimesheetEntryRelationsResponse) o;
    return Objects.equals(this.employee, timesheetEntryRelationsResponse.employee) &&
        Objects.equals(this.timesheet, timesheetEntryRelationsResponse.timesheet) &&
        Objects.equals(this.type, timesheetEntryRelationsResponse.type)&&
        Objects.equals(this.additionalProperties, timesheetEntryRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(employee, timesheet, type, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimesheetEntryRelationsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntryRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntryRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntryRelationsResponse is not found in the empty JSON string", TimesheetEntryRelationsResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("employee") != null && !jsonObj.get("employee").isJsonNull()) {
        ...
        if (jsonArrayemployee != null) {
          ...
          for (int i = 0; i < jsonArrayemployee.size(); i++) {
            EmployeeResponse.validateJsonObject(jsonArrayemployee.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("timesheet") != null && !jsonObj.get("timesheet").isJsonNull()) {
        JsonArray jsonArraytimesheet = jsonObj.getAsJsonArray("timesheet");
        if (jsonArraytimesheet != null) {
          // ensure the json data is an array
          if (!jsonObj.get("timesheet").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `timesheet` to be an array in the JSON string but got `%s`", jsonObj.get("timesheet").toString()));
          }

          // validate the optional field `timesheet` (array)
          for (int i = 0; i < jsonArraytimesheet.size(); i++) {
            TimesheetResponse.validateJsonObject(jsonArraytimesheet.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        ...
        if (jsonArraytype != null) {
          ...
          for (int i = 0; i < jsonArraytype.size(); i++) {
            TimesheetEntryTypeResponse.validateJsonObject(jsonArraytype.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntryRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntryRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntryRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntryRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntryRelationsResponse>() {
           @Override
           public void write(JsonWriter out, TimesheetEntryRelationsResponse value) throws IOException {
           ...
           @Override
           public TimesheetEntryRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntryRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntryRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntryRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntryRelationsResponse
  */
  public static TimesheetEntryRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntryRelationsResponse.class);
  }

 /**
  * Convert an instance of TimesheetEntryRelationsResponse to an JSON string
  *
  * @return JSON string
  */
