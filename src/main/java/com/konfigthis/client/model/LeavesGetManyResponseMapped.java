...
import com.konfigthis.client.model.LeaveRelationsResponse;
import com.konfigthis.client.model.LeaveResponse;
...
public class LeavesGetManyResponseMapped {
  ...
  private List<LeaveResponse> data = new ArrayList<>();
  ...
  private LeaveRelationsResponse relations;

  public LeavesGetManyResponseMapped() {
  }

  public LeavesGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public LeavesGetManyResponseMapped data(List<LeaveResponse> data) {
  ...
  public LeavesGetManyResponseMapped addDataItem(LeaveResponse dataItem) {
  ...
  **/
  ...
  public List<LeaveResponse> getData() {
    return data;
  }


  public void setData(List<LeaveResponse> data) {
  ...
  public LeavesGetManyResponseMapped total(Double total) {
  ...
  public LeavesGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public LeavesGetManyResponseMapped count(Double count) {
  ...
  public LeavesGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public LeavesGetManyResponseMapped offset(Double offset) {
  ...
  public LeavesGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public LeavesGetManyResponseMapped relations(LeaveRelationsResponse relations) {
  ...
  **/
  ...
  public LeaveRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(LeaveRelationsResponse relations) {
   ...
   * @return the LeavesGetManyResponseMapped instance itself
   */
  public LeavesGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeavesGetManyResponseMapped leavesGetManyResponseMapped = (LeavesGetManyResponseMapped) o;
    return Objects.equals(this.status, leavesGetManyResponseMapped.status) &&
        Objects.equals(this.data, leavesGetManyResponseMapped.data) &&
        Objects.equals(this.total, leavesGetManyResponseMapped.total) &&
        Objects.equals(this.count, leavesGetManyResponseMapped.count) &&
        Objects.equals(this.offset, leavesGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, leavesGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, leavesGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeavesGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeavesGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeavesGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeavesGetManyResponseMapped is not found in the empty JSON string", LeavesGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeavesGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        LeaveResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        LeaveRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeavesGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeavesGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeavesGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeavesGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<LeavesGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, LeavesGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public LeavesGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeavesGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeavesGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeavesGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to LeavesGetManyResponseMapped
  */
  public static LeavesGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeavesGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of LeavesGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
