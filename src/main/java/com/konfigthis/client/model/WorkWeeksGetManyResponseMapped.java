...
public class WorkWeeksGetManyResponseMapped {
  ...
  private List<WorkWeekResponse> data = new ArrayList<>();
  ...
  public WorkWeeksGetManyResponseMapped() {
  }

  public WorkWeeksGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public WorkWeeksGetManyResponseMapped data(List<WorkWeekResponse> data) {
  ...
  public WorkWeeksGetManyResponseMapped addDataItem(WorkWeekResponse dataItem) {
  ...
  **/
  ...
  public List<WorkWeekResponse> getData() {
    return data;
  }


  public void setData(List<WorkWeekResponse> data) {
  ...
  public WorkWeeksGetManyResponseMapped total(Double total) {
  ...
  public WorkWeeksGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public WorkWeeksGetManyResponseMapped count(Double count) {
  ...
  public WorkWeeksGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public WorkWeeksGetManyResponseMapped offset(Double offset) {
  ...
  public WorkWeeksGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public WorkWeeksGetManyResponseMapped relations(WorkWeekRelationsResponse relations) {
  ...
  **/
   ...
   * @return the WorkWeeksGetManyResponseMapped instance itself
   */
  public WorkWeeksGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkWeeksGetManyResponseMapped workWeeksGetManyResponseMapped = (WorkWeeksGetManyResponseMapped) o;
    return Objects.equals(this.status, workWeeksGetManyResponseMapped.status) &&
        Objects.equals(this.data, workWeeksGetManyResponseMapped.data) &&
        Objects.equals(this.total, workWeeksGetManyResponseMapped.total) &&
        Objects.equals(this.count, workWeeksGetManyResponseMapped.count) &&
        Objects.equals(this.offset, workWeeksGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, workWeeksGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, workWeeksGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkWeeksGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkWeeksGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkWeeksGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkWeeksGetManyResponseMapped is not found in the empty JSON string", WorkWeeksGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkWeeksGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        WorkWeekResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkWeeksGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkWeeksGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkWeeksGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkWeeksGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkWeeksGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, WorkWeeksGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public WorkWeeksGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkWeeksGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkWeeksGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkWeeksGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to WorkWeeksGetManyResponseMapped
  */
  public static WorkWeeksGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkWeeksGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of WorkWeeksGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
