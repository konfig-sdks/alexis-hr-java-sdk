...
public class TimesheetEntryResponse {
 ...
 public enum StatusEnum {
  ...
  public TimesheetEntryResponse id(String id) {
  ...
  **/
  ...
  public TimesheetEntryResponse timesheetId(String timesheetId) {
  ...
  **/
  ...
  public TimesheetEntryResponse typeId(String typeId) {
  ...
  **/
  ...
  public TimesheetEntryResponse employeeId(String employeeId) {
  ...
  **/
  ...
  public TimesheetEntryResponse date(OffsetDateTime date) {
  ...
  **/
  ...
  public TimesheetEntryResponse updated(OffsetDateTime updated) {
  ...
  **/
  ...
  public TimesheetEntryResponse status(StatusEnum status) {
  ...
  **/
  ...
  public TimesheetEntryResponse minutes(Double minutes) {
  ...
  public TimesheetEntryResponse minutes(Integer minutes) {
  ...
  **/
  ...
  public TimesheetEntryResponse note(String note) {
  ...
  **/
   ...
   * @return the TimesheetEntryResponse instance itself
   */
  public TimesheetEntryResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntryResponse timesheetEntryResponse = (TimesheetEntryResponse) o;
    return Objects.equals(this.id, timesheetEntryResponse.id) &&
        Objects.equals(this.timesheetId, timesheetEntryResponse.timesheetId) &&
        Objects.equals(this.typeId, timesheetEntryResponse.typeId) &&
        Objects.equals(this.employeeId, timesheetEntryResponse.employeeId) &&
        Objects.equals(this.date, timesheetEntryResponse.date) &&
        Objects.equals(this.updated, timesheetEntryResponse.updated) &&
        Objects.equals(this.status, timesheetEntryResponse.status) &&
        Objects.equals(this.minutes, timesheetEntryResponse.minutes) &&
        Objects.equals(this.note, timesheetEntryResponse.note)&&
        Objects.equals(this.additionalProperties, timesheetEntryResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetEntryResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("timesheetId");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntryResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntryResponse is not found in the empty JSON string", TimesheetEntryResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetEntryResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("timesheetId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntryResponse>() {
           @Override
           public void write(JsonWriter out, TimesheetEntryResponse value) throws IOException {
           ...
           @Override
           public TimesheetEntryResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntryResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntryResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntryResponse
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntryResponse
  */
  public static TimesheetEntryResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntryResponse.class);
  }

 /**
  * Convert an instance of TimesheetEntryResponse to an JSON string
  *
  * @return JSON string
  */
