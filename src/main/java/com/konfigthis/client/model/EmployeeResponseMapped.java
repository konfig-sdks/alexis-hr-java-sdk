...
public class EmployeeResponseMapped {
  ...
  public EmployeeResponseMapped() {
  }

  public EmployeeResponseMapped status(String status) {
  ...
  **/
  ...
  public EmployeeResponseMapped data(EmployeeResponse data) {
  ...
  **/
   ...
   * @return the EmployeeResponseMapped instance itself
   */
  public EmployeeResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeResponseMapped employeeResponseMapped = (EmployeeResponseMapped) o;
    return Objects.equals(this.status, employeeResponseMapped.status) &&
        Objects.equals(this.data, employeeResponseMapped.data)&&
        Objects.equals(this.additionalProperties, employeeResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeResponseMapped is not found in the empty JSON string", EmployeeResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmployeeResponseMapped value) throws IOException {
           ...
           @Override
           public EmployeeResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmployeeResponseMapped
  */
  public static EmployeeResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeResponseMapped.class);
  }

 /**
  * Convert an instance of EmployeeResponseMapped to an JSON string
  *
  * @return JSON string
  */
