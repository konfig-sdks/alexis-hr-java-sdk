...
public class TimesheetGetOneResponseMapped {
  ...
  private TimesheetResponse data;
  ...
  public TimesheetGetOneResponseMapped() {
  }

  public TimesheetGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public TimesheetGetOneResponseMapped data(TimesheetResponse data) {
  ...
  **/
  ...
  public void setData(TimesheetResponse data) {
  ...
  public TimesheetGetOneResponseMapped relations(TimesheetRelationsResponse relations) {
  ...
  **/
   ...
   * @return the TimesheetGetOneResponseMapped instance itself
   */
  public TimesheetGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetGetOneResponseMapped timesheetGetOneResponseMapped = (TimesheetGetOneResponseMapped) o;
    return Objects.equals(this.status, timesheetGetOneResponseMapped.status) &&
        Objects.equals(this.data, timesheetGetOneResponseMapped.data) &&
        Objects.equals(this.relations, timesheetGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, timesheetGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetGetOneResponseMapped is not found in the empty JSON string", TimesheetGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetGetOneResponseMapped.openapiRequiredFields) {
      ...
      TimesheetResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, TimesheetGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public TimesheetGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TimesheetGetOneResponseMapped
  */
  public static TimesheetGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of TimesheetGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
