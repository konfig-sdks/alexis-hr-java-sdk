...
public class LeaveRelationsResponse {
  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private List<LeaveTypeResponse> type = null;

  public static final String SERIALIZED_NAME_EMPLOYEE = "employee";
  @SerializedName(SERIALIZED_NAME_EMPLOYEE)
  private List<EmployeeResponse> employee = null;

  public LeaveRelationsResponse() {
  }

  public LeaveRelationsResponse type(List<LeaveTypeResponse> type) {
  ...
  public LeaveRelationsResponse addTypeItem(LeaveTypeResponse typeItem) {
    if (this.type == null) {
  ...
  **/
  ...
  public List<LeaveTypeResponse> getType() {
    return type;
  }


  public void setType(List<LeaveTypeResponse> type) {
  ...
  public LeaveRelationsResponse employee(List<EmployeeResponse> employee) {
  ...
  public LeaveRelationsResponse addEmployeeItem(EmployeeResponse employeeItem) {
  ...
  **/
   ...
   * @return the LeaveRelationsResponse instance itself
   */
  public LeaveRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveRelationsResponse leaveRelationsResponse = (LeaveRelationsResponse) o;
    return Objects.equals(this.type, leaveRelationsResponse.type) &&
        Objects.equals(this.employee, leaveRelationsResponse.employee)&&
        Objects.equals(this.additionalProperties, leaveRelationsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveRelationsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveRelationsResponse is not found in the empty JSON string", LeaveRelationsResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        ...
        if (jsonArraytype != null) {
          ...
          for (int i = 0; i < jsonArraytype.size(); i++) {
            LeaveTypeResponse.validateJsonObject(jsonArraytype.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveRelationsResponse>() {
           @Override
           public void write(JsonWriter out, LeaveRelationsResponse value) throws IOException {
           ...
           @Override
           public LeaveRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveRelationsResponse
  */
  public static LeaveRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveRelationsResponse.class);
  }

 /**
  * Convert an instance of LeaveRelationsResponse to an JSON string
  *
  * @return JSON string
  */
