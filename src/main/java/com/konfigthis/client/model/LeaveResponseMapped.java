...
public class LeaveResponseMapped {
  ...
  public LeaveResponseMapped() {
  }

  public LeaveResponseMapped status(String status) {
  ...
  **/
  ...
  public LeaveResponseMapped data(LeaveResponse data) {
  ...
  **/
   ...
   * @return the LeaveResponseMapped instance itself
   */
  public LeaveResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveResponseMapped leaveResponseMapped = (LeaveResponseMapped) o;
    return Objects.equals(this.status, leaveResponseMapped.status) &&
        Objects.equals(this.data, leaveResponseMapped.data)&&
        Objects.equals(this.additionalProperties, leaveResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveResponseMapped is not found in the empty JSON string", LeaveResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveResponseMapped>() {
           @Override
           public void write(JsonWriter out, LeaveResponseMapped value) throws IOException {
           ...
           @Override
           public LeaveResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveResponseMapped
  * @throws IOException if the JSON string is invalid with respect to LeaveResponseMapped
  */
  public static LeaveResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveResponseMapped.class);
  }

 /**
  * Convert an instance of LeaveResponseMapped to an JSON string
  *
  * @return JSON string
  */
