...
/**
 * EmployeeteamreferenceGetManyFiltersParameter
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EmployeeteamreferenceGetManyFiltersParameter {
  ...
  private CompanyListManyCompaniesFiltersParameterId teamId;
  ...
  public EmployeeteamreferenceGetManyFiltersParameter() {
  }

  public EmployeeteamreferenceGetManyFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
  ...
  public EmployeeteamreferenceGetManyFiltersParameter companyId(CompanyListManyCompaniesFiltersParameterId companyId) {
  ...
  **/
  ...
  public EmployeeteamreferenceGetManyFiltersParameter teamId(CompanyListManyCompaniesFiltersParameterId teamId) {
  ...
  **/
  ...
  public CompanyListManyCompaniesFiltersParameterId getTeamId() {
    return teamId;
  }


  public void setTeamId(CompanyListManyCompaniesFiltersParameterId teamId) {
  ...
  public EmployeeteamreferenceGetManyFiltersParameter userId(CompanyListManyCompaniesFiltersParameterId userId) {
  ...
  **/
  ...
  public EmployeeteamreferenceGetManyFiltersParameter employeeId(CompanyListManyCompaniesFiltersParameterId employeeId) {
  ...
  **/
   ...
   * @return the EmployeeteamreferenceGetManyFiltersParameter instance itself
   */
  public EmployeeteamreferenceGetManyFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeteamreferenceGetManyFiltersParameter employeeteamreferenceGetManyFiltersParameter = (EmployeeteamreferenceGetManyFiltersParameter) o;
    return Objects.equals(this.id, employeeteamreferenceGetManyFiltersParameter.id) &&
        Objects.equals(this.companyId, employeeteamreferenceGetManyFiltersParameter.companyId) &&
        Objects.equals(this.teamId, employeeteamreferenceGetManyFiltersParameter.teamId) &&
        Objects.equals(this.userId, employeeteamreferenceGetManyFiltersParameter.userId) &&
        Objects.equals(this.employeeId, employeeteamreferenceGetManyFiltersParameter.employeeId)&&
        Objects.equals(this.additionalProperties, employeeteamreferenceGetManyFiltersParameter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, teamId, userId, employeeId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeeteamreferenceGetManyFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeteamreferenceGetManyFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeteamreferenceGetManyFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeteamreferenceGetManyFiltersParameter is not found in the empty JSON string", EmployeeteamreferenceGetManyFiltersParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("teamId") != null && !jsonObj.get("teamId").isJsonNull()) {
        CompanyListManyCompaniesFiltersParameterId.validateJsonObject(jsonObj.getAsJsonObject("teamId"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeteamreferenceGetManyFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeteamreferenceGetManyFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeteamreferenceGetManyFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeteamreferenceGetManyFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeteamreferenceGetManyFiltersParameter>() {
           @Override
           public void write(JsonWriter out, EmployeeteamreferenceGetManyFiltersParameter value) throws IOException {
           ...
           @Override
           public EmployeeteamreferenceGetManyFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeteamreferenceGetManyFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeteamreferenceGetManyFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeteamreferenceGetManyFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to EmployeeteamreferenceGetManyFiltersParameter
  */
  public static EmployeeteamreferenceGetManyFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeteamreferenceGetManyFiltersParameter.class);
  }

 /**
  * Convert an instance of EmployeeteamreferenceGetManyFiltersParameter to an JSON string
  *
  * @return JSON string
  */
