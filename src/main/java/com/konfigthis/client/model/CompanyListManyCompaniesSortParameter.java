...
/**
 * CompanyListManyCompaniesSortParameter
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CompanyListManyCompaniesSortParameter {
  /**
   * Gets or Sets id
   */
 ...
 public enum IdEnum {
  ...
  public CompanyListManyCompaniesSortParameter() {
  }

  public CompanyListManyCompaniesSortParameter id(IdEnum id) {
  ...
  **/
   ...
   * @return the CompanyListManyCompaniesSortParameter instance itself
   */
  public CompanyListManyCompaniesSortParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyListManyCompaniesSortParameter companyListManyCompaniesSortParameter = (CompanyListManyCompaniesSortParameter) o;
    return Objects.equals(this.id, companyListManyCompaniesSortParameter.id)&&
        Objects.equals(this.additionalProperties, companyListManyCompaniesSortParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyListManyCompaniesSortParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompanyListManyCompaniesSortParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompanyListManyCompaniesSortParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyListManyCompaniesSortParameter is not found in the empty JSON string", CompanyListManyCompaniesSortParameter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyListManyCompaniesSortParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyListManyCompaniesSortParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyListManyCompaniesSortParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyListManyCompaniesSortParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyListManyCompaniesSortParameter>() {
           @Override
           public void write(JsonWriter out, CompanyListManyCompaniesSortParameter value) throws IOException {
           ...
           @Override
           public CompanyListManyCompaniesSortParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompanyListManyCompaniesSortParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompanyListManyCompaniesSortParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompanyListManyCompaniesSortParameter
  * @throws IOException if the JSON string is invalid with respect to CompanyListManyCompaniesSortParameter
  */
  public static CompanyListManyCompaniesSortParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyListManyCompaniesSortParameter.class);
  }

 /**
  * Convert an instance of CompanyListManyCompaniesSortParameter to an JSON string
  *
  * @return JSON string
  */
