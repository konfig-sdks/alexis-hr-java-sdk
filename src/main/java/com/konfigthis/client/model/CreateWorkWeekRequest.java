...
public class CreateWorkWeekRequest {
  ...
  **/
  ...
  public CreateWorkWeekRequest officeId(String officeId) {
  ...
  **/
  ...
  public CreateWorkWeekRequest effectiveFrom(OffsetDateTime effectiveFrom) {
  ...
  **/
  ...
  public CreateWorkWeekRequest effectiveTo(OffsetDateTime effectiveTo) {
  ...
  **/
  ...
  public CreateWorkWeekRequest timezone(String timezone) {
  ...
  **/
  ...
  public CreateWorkWeekRequest duration(Double duration) {
  ...
  public CreateWorkWeekRequest duration(Integer duration) {
  ...
  **/
  ...
  public CreateWorkWeekRequest monday(WorkWeekDayRequest monday) {
  ...
  **/
  ...
  public WorkWeekDayRequest getMonday() {
    return monday;
  }


  public void setMonday(WorkWeekDayRequest monday) {
  ...
  public CreateWorkWeekRequest tuesday(WorkWeekDayRequest tuesday) {
  ...
  **/
  ...
  public WorkWeekDayRequest getTuesday() {
    return tuesday;
  }


  public void setTuesday(WorkWeekDayRequest tuesday) {
  ...
  public CreateWorkWeekRequest wednesday(WorkWeekDayRequest wednesday) {
  ...
  **/
  ...
  public WorkWeekDayRequest getWednesday() {
    return wednesday;
  }


  public void setWednesday(WorkWeekDayRequest wednesday) {
  ...
  public CreateWorkWeekRequest thursday(WorkWeekDayRequest thursday) {
  ...
  **/
  ...
  public WorkWeekDayRequest getThursday() {
    return thursday;
  }


  public void setThursday(WorkWeekDayRequest thursday) {
  ...
  public CreateWorkWeekRequest friday(WorkWeekDayRequest friday) {
  ...
  **/
  ...
  public WorkWeekDayRequest getFriday() {
    return friday;
  }


  public void setFriday(WorkWeekDayRequest friday) {
  ...
  public CreateWorkWeekRequest saturday(WorkWeekDayRequest saturday) {
  ...
  **/
  ...
  public WorkWeekDayRequest getSaturday() {
    return saturday;
  }


  public void setSaturday(WorkWeekDayRequest saturday) {
  ...
  public CreateWorkWeekRequest sunday(WorkWeekDayRequest sunday) {
  ...
  **/
  ...
  public WorkWeekDayRequest getSunday() {
    return sunday;
  }


  public void setSunday(WorkWeekDayRequest sunday) {
   ...
   * @return the CreateWorkWeekRequest instance itself
   */
  public CreateWorkWeekRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateWorkWeekRequest createWorkWeekRequest = (CreateWorkWeekRequest) o;
    return Objects.equals(this.employeeId, createWorkWeekRequest.employeeId) &&
        Objects.equals(this.officeId, createWorkWeekRequest.officeId) &&
        Objects.equals(this.effectiveFrom, createWorkWeekRequest.effectiveFrom) &&
        Objects.equals(this.effectiveTo, createWorkWeekRequest.effectiveTo) &&
        Objects.equals(this.timezone, createWorkWeekRequest.timezone) &&
        Objects.equals(this.duration, createWorkWeekRequest.duration) &&
        Objects.equals(this.monday, createWorkWeekRequest.monday) &&
        Objects.equals(this.tuesday, createWorkWeekRequest.tuesday) &&
        Objects.equals(this.wednesday, createWorkWeekRequest.wednesday) &&
        Objects.equals(this.thursday, createWorkWeekRequest.thursday) &&
        Objects.equals(this.friday, createWorkWeekRequest.friday) &&
        Objects.equals(this.saturday, createWorkWeekRequest.saturday) &&
        Objects.equals(this.sunday, createWorkWeekRequest.sunday)&&
        Objects.equals(this.additionalProperties, createWorkWeekRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(employeeId, officeId, effectiveFrom, effectiveTo, timezone, duration, monday, tuesday, wednesday, thursday, friday, saturday, sunday, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateWorkWeekRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateWorkWeekRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateWorkWeekRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWorkWeekRequest is not found in the empty JSON string", CreateWorkWeekRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateWorkWeekRequest.openapiRequiredFields) {
      ...
      WorkWeekDayRequest.validateJsonObject(jsonObj.getAsJsonObject("monday"));
      // validate the required field `tuesday`
      WorkWeekDayRequest.validateJsonObject(jsonObj.getAsJsonObject("tuesday"));
      // validate the required field `wednesday`
      WorkWeekDayRequest.validateJsonObject(jsonObj.getAsJsonObject("wednesday"));
      // validate the required field `thursday`
      WorkWeekDayRequest.validateJsonObject(jsonObj.getAsJsonObject("thursday"));
      // validate the required field `friday`
      WorkWeekDayRequest.validateJsonObject(jsonObj.getAsJsonObject("friday"));
      // validate the required field `saturday`
      WorkWeekDayRequest.validateJsonObject(jsonObj.getAsJsonObject("saturday"));
      // validate the required field `sunday`
      WorkWeekDayRequest.validateJsonObject(jsonObj.getAsJsonObject("sunday"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWorkWeekRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWorkWeekRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWorkWeekRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWorkWeekRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWorkWeekRequest>() {
           @Override
           public void write(JsonWriter out, CreateWorkWeekRequest value) throws IOException {
           ...
           @Override
           public CreateWorkWeekRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateWorkWeekRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateWorkWeekRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateWorkWeekRequest
  * @throws IOException if the JSON string is invalid with respect to CreateWorkWeekRequest
  */
  public static CreateWorkWeekRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWorkWeekRequest.class);
  }

 /**
  * Convert an instance of CreateWorkWeekRequest to an JSON string
  *
  * @return JSON string
  */
