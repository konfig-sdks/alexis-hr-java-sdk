...
public class WorkShiftResponse {
  ...
  public WorkShiftResponse startHour(Double startHour) {
  ...
  public WorkShiftResponse startHour(Integer startHour) {
    
    
    
    
    this.startHour = startHour.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public WorkShiftResponse startMinute(Double startMinute) {
  ...
  public WorkShiftResponse startMinute(Integer startMinute) {
    
    
    
    
    this.startMinute = startMinute.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public WorkShiftResponse endHour(Double endHour) {
  ...
  public WorkShiftResponse endHour(Integer endHour) {
    
    
    
    
    this.endHour = endHour.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public WorkShiftResponse endMinute(Double endMinute) {
  ...
  public WorkShiftResponse endMinute(Integer endMinute) {
    
    
    
    
    this.endMinute = endMinute.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public WorkShiftResponse duration(Double duration) {
  ...
  public WorkShiftResponse duration(Integer duration) {
  ...
  **/
   ...
   * @return the WorkShiftResponse instance itself
   */
  public WorkShiftResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkShiftResponse workShiftResponse = (WorkShiftResponse) o;
    return Objects.equals(this.startHour, workShiftResponse.startHour) &&
        Objects.equals(this.startMinute, workShiftResponse.startMinute) &&
        Objects.equals(this.endHour, workShiftResponse.endHour) &&
        Objects.equals(this.endMinute, workShiftResponse.endMinute) &&
        Objects.equals(this.duration, workShiftResponse.duration)&&
        Objects.equals(this.additionalProperties, workShiftResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startHour, startMinute, endHour, endMinute, duration, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WorkShiftResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("startHour");
    openapiRequiredFields.add("startMinute");
    openapiRequiredFields.add("endHour");
    openapiRequiredFields.add("endMinute");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkShiftResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkShiftResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkShiftResponse is not found in the empty JSON string", WorkShiftResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkShiftResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkShiftResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkShiftResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkShiftResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkShiftResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkShiftResponse>() {
           @Override
           public void write(JsonWriter out, WorkShiftResponse value) throws IOException {
           ...
           @Override
           public WorkShiftResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkShiftResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkShiftResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkShiftResponse
  * @throws IOException if the JSON string is invalid with respect to WorkShiftResponse
  */
  public static WorkShiftResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkShiftResponse.class);
  }

 /**
  * Convert an instance of WorkShiftResponse to an JSON string
  *
  * @return JSON string
  */
