...
public class UpdateCostCenterRequest {
  ...
  public UpdateCostCenterRequest() {
  }

  public UpdateCostCenterRequest code(String code) {
  ...
  **/
  ...
  public UpdateCostCenterRequest name(String name) {
  ...
  **/
   ...
   * @return the UpdateCostCenterRequest instance itself
   */
  public UpdateCostCenterRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCostCenterRequest updateCostCenterRequest = (UpdateCostCenterRequest) o;
    return Objects.equals(this.code, updateCostCenterRequest.code) &&
        Objects.equals(this.name, updateCostCenterRequest.name)&&
        Objects.equals(this.additionalProperties, updateCostCenterRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateCostCenterRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateCostCenterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCostCenterRequest is not found in the empty JSON string", UpdateCostCenterRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCostCenterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCostCenterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCostCenterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCostCenterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCostCenterRequest>() {
           @Override
           public void write(JsonWriter out, UpdateCostCenterRequest value) throws IOException {
           ...
           @Override
           public UpdateCostCenterRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateCostCenterRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateCostCenterRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateCostCenterRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateCostCenterRequest
  */
  public static UpdateCostCenterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCostCenterRequest.class);
  }

 /**
  * Convert an instance of UpdateCostCenterRequest to an JSON string
  *
  * @return JSON string
  */
