...
public class LeaveTypeGetOneRelationResponse {
  public static final String SERIALIZED_NAME_LEAVE_TYPE_CODE = "leaveTypeCode";
  @SerializedName(SERIALIZED_NAME_LEAVE_TYPE_CODE)
  private LeaveTypeCodeResponse leaveTypeCode;

  public LeaveTypeGetOneRelationResponse() {
  }

  public LeaveTypeGetOneRelationResponse leaveTypeCode(LeaveTypeCodeResponse leaveTypeCode) {
  ...
  **/
  ...
  public LeaveTypeCodeResponse getLeaveTypeCode() {
    return leaveTypeCode;
  }


  public void setLeaveTypeCode(LeaveTypeCodeResponse leaveTypeCode) {
   ...
   * @return the LeaveTypeGetOneRelationResponse instance itself
   */
  public LeaveTypeGetOneRelationResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTypeGetOneRelationResponse leaveTypeGetOneRelationResponse = (LeaveTypeGetOneRelationResponse) o;
    return Objects.equals(this.leaveTypeCode, leaveTypeGetOneRelationResponse.leaveTypeCode)&&
        Objects.equals(this.additionalProperties, leaveTypeGetOneRelationResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveTypeGetOneRelationResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTypeGetOneRelationResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTypeGetOneRelationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTypeGetOneRelationResponse is not found in the empty JSON string", LeaveTypeGetOneRelationResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `leaveTypeCode`
      if (jsonObj.get("leaveTypeCode") != null && !jsonObj.get("leaveTypeCode").isJsonNull()) {
        LeaveTypeCodeResponse.validateJsonObject(jsonObj.getAsJsonObject("leaveTypeCode"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTypeGetOneRelationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTypeGetOneRelationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTypeGetOneRelationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTypeGetOneRelationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTypeGetOneRelationResponse>() {
           @Override
           public void write(JsonWriter out, LeaveTypeGetOneRelationResponse value) throws IOException {
           ...
           @Override
           public LeaveTypeGetOneRelationResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTypeGetOneRelationResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTypeGetOneRelationResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTypeGetOneRelationResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveTypeGetOneRelationResponse
  */
  public static LeaveTypeGetOneRelationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTypeGetOneRelationResponse.class);
  }

 /**
  * Convert an instance of LeaveTypeGetOneRelationResponse to an JSON string
  *
  * @return JSON string
  */
