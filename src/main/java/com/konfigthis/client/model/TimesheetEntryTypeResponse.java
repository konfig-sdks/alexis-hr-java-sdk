...
public class TimesheetEntryTypeResponse {
 ...
 public enum KindEnum {
  ...
  public TimesheetEntryTypeResponse() {
  }

  public TimesheetEntryTypeResponse id(String id) {
  ...
  **/
  ...
  public TimesheetEntryTypeResponse name(String name) {
  ...
  **/
  ...
  public TimesheetEntryTypeResponse kind(KindEnum kind) {
  ...
  **/
  ...
  @ApiModelProperty(example = "HOURLY_WAGE", value = "")
   ...
   * @return the TimesheetEntryTypeResponse instance itself
   */
  public TimesheetEntryTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntryTypeResponse timesheetEntryTypeResponse = (TimesheetEntryTypeResponse) o;
    return Objects.equals(this.id, timesheetEntryTypeResponse.id) &&
        Objects.equals(this.name, timesheetEntryTypeResponse.name) &&
        Objects.equals(this.kind, timesheetEntryTypeResponse.kind)&&
        Objects.equals(this.additionalProperties, timesheetEntryTypeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetEntryTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntryTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntryTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntryTypeResponse is not found in the empty JSON string", TimesheetEntryTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetEntryTypeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntryTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntryTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntryTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntryTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntryTypeResponse>() {
           @Override
           public void write(JsonWriter out, TimesheetEntryTypeResponse value) throws IOException {
           ...
           @Override
           public TimesheetEntryTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntryTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntryTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntryTypeResponse
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntryTypeResponse
  */
  public static TimesheetEntryTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntryTypeResponse.class);
  }

 /**
  * Convert an instance of TimesheetEntryTypeResponse to an JSON string
  *
  * @return JSON string
  */
