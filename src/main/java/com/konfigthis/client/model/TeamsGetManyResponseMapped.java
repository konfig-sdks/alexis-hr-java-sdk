...
public class TeamsGetManyResponseMapped {
  ...
  private List<TeamResponse> data = new ArrayList<>();
  ...
  public TeamsGetManyResponseMapped() {
  }

  public TeamsGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public TeamsGetManyResponseMapped data(List<TeamResponse> data) {
  ...
  public TeamsGetManyResponseMapped addDataItem(TeamResponse dataItem) {
  ...
  **/
  ...
  public List<TeamResponse> getData() {
    return data;
  }


  public void setData(List<TeamResponse> data) {
  ...
  public TeamsGetManyResponseMapped total(Double total) {
  ...
  public TeamsGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public TeamsGetManyResponseMapped count(Double count) {
  ...
  public TeamsGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public TeamsGetManyResponseMapped offset(Double offset) {
  ...
  public TeamsGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public TeamsGetManyResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the TeamsGetManyResponseMapped instance itself
   */
  public TeamsGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamsGetManyResponseMapped teamsGetManyResponseMapped = (TeamsGetManyResponseMapped) o;
    return Objects.equals(this.status, teamsGetManyResponseMapped.status) &&
        Objects.equals(this.data, teamsGetManyResponseMapped.data) &&
        Objects.equals(this.total, teamsGetManyResponseMapped.total) &&
        Objects.equals(this.count, teamsGetManyResponseMapped.count) &&
        Objects.equals(this.offset, teamsGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, teamsGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, teamsGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamsGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamsGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamsGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamsGetManyResponseMapped is not found in the empty JSON string", TeamsGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamsGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        TeamResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamsGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamsGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamsGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamsGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamsGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, TeamsGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public TeamsGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamsGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamsGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamsGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TeamsGetManyResponseMapped
  */
  public static TeamsGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamsGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of TeamsGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
