...
import com.konfigthis.client.model.TimesheetEntryTypeResponse;
...
public class TimesheetEntryTypesGetManyResponseMapped {
  ...
  private List<TimesheetEntryTypeResponse> data = new ArrayList<>();
  ...
  public TimesheetEntryTypesGetManyResponseMapped() {
  }

  public TimesheetEntryTypesGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public TimesheetEntryTypesGetManyResponseMapped data(List<TimesheetEntryTypeResponse> data) {
  ...
  public TimesheetEntryTypesGetManyResponseMapped addDataItem(TimesheetEntryTypeResponse dataItem) {
  ...
  **/
  ...
  public List<TimesheetEntryTypeResponse> getData() {
    return data;
  }


  public void setData(List<TimesheetEntryTypeResponse> data) {
  ...
  public TimesheetEntryTypesGetManyResponseMapped total(Double total) {
  ...
  public TimesheetEntryTypesGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public TimesheetEntryTypesGetManyResponseMapped count(Double count) {
  ...
  public TimesheetEntryTypesGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public TimesheetEntryTypesGetManyResponseMapped offset(Double offset) {
  ...
  public TimesheetEntryTypesGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public TimesheetEntryTypesGetManyResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the TimesheetEntryTypesGetManyResponseMapped instance itself
   */
  public TimesheetEntryTypesGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntryTypesGetManyResponseMapped timesheetEntryTypesGetManyResponseMapped = (TimesheetEntryTypesGetManyResponseMapped) o;
    return Objects.equals(this.status, timesheetEntryTypesGetManyResponseMapped.status) &&
        Objects.equals(this.data, timesheetEntryTypesGetManyResponseMapped.data) &&
        Objects.equals(this.total, timesheetEntryTypesGetManyResponseMapped.total) &&
        Objects.equals(this.count, timesheetEntryTypesGetManyResponseMapped.count) &&
        Objects.equals(this.offset, timesheetEntryTypesGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, timesheetEntryTypesGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, timesheetEntryTypesGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetEntryTypesGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntryTypesGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntryTypesGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntryTypesGetManyResponseMapped is not found in the empty JSON string", TimesheetEntryTypesGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetEntryTypesGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        TimesheetEntryTypeResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntryTypesGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntryTypesGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntryTypesGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntryTypesGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntryTypesGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, TimesheetEntryTypesGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public TimesheetEntryTypesGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntryTypesGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntryTypesGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntryTypesGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntryTypesGetManyResponseMapped
  */
  public static TimesheetEntryTypesGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntryTypesGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of TimesheetEntryTypesGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
