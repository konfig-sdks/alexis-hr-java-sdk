...
public class DepartmentGetOneResponseMapped {
  ...
  public DepartmentGetOneResponseMapped() {
  }

  public DepartmentGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public DepartmentGetOneResponseMapped data(DepartmentResponse data) {
  ...
  **/
  ...
  public DepartmentResponse getData() {
    return data;
  }


  public void setData(DepartmentResponse data) {
  ...
  public DepartmentGetOneResponseMapped relations(DepartmentRelationsResponse relations) {
  ...
  **/
   ...
   * @return the DepartmentGetOneResponseMapped instance itself
   */
  public DepartmentGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DepartmentGetOneResponseMapped departmentGetOneResponseMapped = (DepartmentGetOneResponseMapped) o;
    return Objects.equals(this.status, departmentGetOneResponseMapped.status) &&
        Objects.equals(this.data, departmentGetOneResponseMapped.data) &&
        Objects.equals(this.relations, departmentGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, departmentGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepartmentGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DepartmentGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DepartmentGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepartmentGetOneResponseMapped is not found in the empty JSON string", DepartmentGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DepartmentGetOneResponseMapped.openapiRequiredFields) {
      ...
      DepartmentResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepartmentGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepartmentGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepartmentGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepartmentGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<DepartmentGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, DepartmentGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public DepartmentGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DepartmentGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DepartmentGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DepartmentGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to DepartmentGetOneResponseMapped
  */
  public static DepartmentGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepartmentGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of DepartmentGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
