...
public class LeaveGetManyLeavesFiltersParameter {
  ...
  private CompanyListManyCompaniesFiltersParameterId duration;
  ...
  public LeaveGetManyLeavesFiltersParameter() {
  }

  public LeaveGetManyLeavesFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
  ...
  public LeaveGetManyLeavesFiltersParameter employeeId(CompanyListManyCompaniesFiltersParameterId employeeId) {
  ...
  **/
  ...
  public LeaveGetManyLeavesFiltersParameter typeId(CompanyListManyCompaniesFiltersParameterId typeId) {
  ...
  **/
  ...
  public LeaveGetManyLeavesFiltersParameter status(CompanyListManyCompaniesFiltersParameterId status) {
  ...
  **/
  ...
  public LeaveGetManyLeavesFiltersParameter duration(CompanyListManyCompaniesFiltersParameterId duration) {
  ...
  **/
  ...
  public CompanyListManyCompaniesFiltersParameterId getDuration() {
    return duration;
  }


  public void setDuration(CompanyListManyCompaniesFiltersParameterId duration) {
  ...
  public LeaveGetManyLeavesFiltersParameter startDate(CompanyListManyCompaniesFiltersParameterId startDate) {
  ...
  **/
  ...
  public LeaveGetManyLeavesFiltersParameter endDate(CompanyListManyCompaniesFiltersParameterId endDate) {
  ...
  **/
   ...
   * @return the LeaveGetManyLeavesFiltersParameter instance itself
   */
  public LeaveGetManyLeavesFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveGetManyLeavesFiltersParameter leaveGetManyLeavesFiltersParameter = (LeaveGetManyLeavesFiltersParameter) o;
    return Objects.equals(this.id, leaveGetManyLeavesFiltersParameter.id) &&
        Objects.equals(this.employeeId, leaveGetManyLeavesFiltersParameter.employeeId) &&
        Objects.equals(this.typeId, leaveGetManyLeavesFiltersParameter.typeId) &&
        Objects.equals(this.status, leaveGetManyLeavesFiltersParameter.status) &&
        Objects.equals(this.duration, leaveGetManyLeavesFiltersParameter.duration) &&
        Objects.equals(this.startDate, leaveGetManyLeavesFiltersParameter.startDate) &&
        Objects.equals(this.endDate, leaveGetManyLeavesFiltersParameter.endDate)&&
        Objects.equals(this.additionalProperties, leaveGetManyLeavesFiltersParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveGetManyLeavesFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveGetManyLeavesFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveGetManyLeavesFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveGetManyLeavesFiltersParameter is not found in the empty JSON string", LeaveGetManyLeavesFiltersParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("duration") != null && !jsonObj.get("duration").isJsonNull()) {
        CompanyListManyCompaniesFiltersParameterId.validateJsonObject(jsonObj.getAsJsonObject("duration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveGetManyLeavesFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveGetManyLeavesFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveGetManyLeavesFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveGetManyLeavesFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveGetManyLeavesFiltersParameter>() {
           @Override
           public void write(JsonWriter out, LeaveGetManyLeavesFiltersParameter value) throws IOException {
           ...
           @Override
           public LeaveGetManyLeavesFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveGetManyLeavesFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveGetManyLeavesFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveGetManyLeavesFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to LeaveGetManyLeavesFiltersParameter
  */
  public static LeaveGetManyLeavesFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveGetManyLeavesFiltersParameter.class);
  }

 /**
  * Convert an instance of LeaveGetManyLeavesFiltersParameter to an JSON string
  *
  * @return JSON string
  */
