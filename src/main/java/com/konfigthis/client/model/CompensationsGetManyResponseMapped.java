...
public class CompensationsGetManyResponseMapped {
  ...
  private List<CompensationResponse> data = new ArrayList<>();
  ...
  public CompensationsGetManyResponseMapped() {
  }

  public CompensationsGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public CompensationsGetManyResponseMapped data(List<CompensationResponse> data) {
  ...
  public CompensationsGetManyResponseMapped addDataItem(CompensationResponse dataItem) {
  ...
  **/
  ...
  public List<CompensationResponse> getData() {
    return data;
  }


  public void setData(List<CompensationResponse> data) {
  ...
  public CompensationsGetManyResponseMapped total(Double total) {
  ...
  public CompensationsGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public CompensationsGetManyResponseMapped count(Double count) {
  ...
  public CompensationsGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public CompensationsGetManyResponseMapped offset(Double offset) {
  ...
  public CompensationsGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public CompensationsGetManyResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the CompensationsGetManyResponseMapped instance itself
   */
  public CompensationsGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompensationsGetManyResponseMapped compensationsGetManyResponseMapped = (CompensationsGetManyResponseMapped) o;
    return Objects.equals(this.status, compensationsGetManyResponseMapped.status) &&
        Objects.equals(this.data, compensationsGetManyResponseMapped.data) &&
        Objects.equals(this.total, compensationsGetManyResponseMapped.total) &&
        Objects.equals(this.count, compensationsGetManyResponseMapped.count) &&
        Objects.equals(this.offset, compensationsGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, compensationsGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, compensationsGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompensationsGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompensationsGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompensationsGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompensationsGetManyResponseMapped is not found in the empty JSON string", CompensationsGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompensationsGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        CompensationResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompensationsGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompensationsGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompensationsGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompensationsGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CompensationsGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, CompensationsGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public CompensationsGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompensationsGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompensationsGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompensationsGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CompensationsGetManyResponseMapped
  */
  public static CompensationsGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompensationsGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of CompensationsGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
