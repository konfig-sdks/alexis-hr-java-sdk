...
public class ChildrenGetManyResponseMapped {
  ...
  private List<ChildResponse> data = new ArrayList<>();
  ...
  public ChildrenGetManyResponseMapped() {
  }

  public ChildrenGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public ChildrenGetManyResponseMapped data(List<ChildResponse> data) {
  ...
  public ChildrenGetManyResponseMapped addDataItem(ChildResponse dataItem) {
  ...
  **/
  ...
  public List<ChildResponse> getData() {
    return data;
  }


  public void setData(List<ChildResponse> data) {
  ...
  public ChildrenGetManyResponseMapped total(Double total) {
  ...
  public ChildrenGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public ChildrenGetManyResponseMapped count(Double count) {
  ...
  public ChildrenGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public ChildrenGetManyResponseMapped offset(Double offset) {
  ...
  public ChildrenGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public ChildrenGetManyResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the ChildrenGetManyResponseMapped instance itself
   */
  public ChildrenGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChildrenGetManyResponseMapped childrenGetManyResponseMapped = (ChildrenGetManyResponseMapped) o;
    return Objects.equals(this.status, childrenGetManyResponseMapped.status) &&
        Objects.equals(this.data, childrenGetManyResponseMapped.data) &&
        Objects.equals(this.total, childrenGetManyResponseMapped.total) &&
        Objects.equals(this.count, childrenGetManyResponseMapped.count) &&
        Objects.equals(this.offset, childrenGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, childrenGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, childrenGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChildrenGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChildrenGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChildrenGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChildrenGetManyResponseMapped is not found in the empty JSON string", ChildrenGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChildrenGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        ChildResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChildrenGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChildrenGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChildrenGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChildrenGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<ChildrenGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, ChildrenGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public ChildrenGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChildrenGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChildrenGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChildrenGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to ChildrenGetManyResponseMapped
  */
  public static ChildrenGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChildrenGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of ChildrenGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
