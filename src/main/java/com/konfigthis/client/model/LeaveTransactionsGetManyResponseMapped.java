...
import com.konfigthis.client.model.LeaveTransactionRelationsResponse;
import com.konfigthis.client.model.LeaveTransactionResponse;
...
public class LeaveTransactionsGetManyResponseMapped {
  ...
  private List<LeaveTransactionResponse> data = new ArrayList<>();
  ...
  private LeaveTransactionRelationsResponse relations;

  public LeaveTransactionsGetManyResponseMapped() {
  }

  public LeaveTransactionsGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public LeaveTransactionsGetManyResponseMapped data(List<LeaveTransactionResponse> data) {
  ...
  public LeaveTransactionsGetManyResponseMapped addDataItem(LeaveTransactionResponse dataItem) {
  ...
  **/
  ...
  public List<LeaveTransactionResponse> getData() {
    return data;
  }


  public void setData(List<LeaveTransactionResponse> data) {
  ...
  public LeaveTransactionsGetManyResponseMapped total(Double total) {
  ...
  public LeaveTransactionsGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public LeaveTransactionsGetManyResponseMapped count(Double count) {
  ...
  public LeaveTransactionsGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public LeaveTransactionsGetManyResponseMapped offset(Double offset) {
  ...
  public LeaveTransactionsGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public LeaveTransactionsGetManyResponseMapped relations(LeaveTransactionRelationsResponse relations) {
  ...
  **/
  ...
  public LeaveTransactionRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(LeaveTransactionRelationsResponse relations) {
   ...
   * @return the LeaveTransactionsGetManyResponseMapped instance itself
   */
  public LeaveTransactionsGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveTransactionsGetManyResponseMapped leaveTransactionsGetManyResponseMapped = (LeaveTransactionsGetManyResponseMapped) o;
    return Objects.equals(this.status, leaveTransactionsGetManyResponseMapped.status) &&
        Objects.equals(this.data, leaveTransactionsGetManyResponseMapped.data) &&
        Objects.equals(this.total, leaveTransactionsGetManyResponseMapped.total) &&
        Objects.equals(this.count, leaveTransactionsGetManyResponseMapped.count) &&
        Objects.equals(this.offset, leaveTransactionsGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, leaveTransactionsGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, leaveTransactionsGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveTransactionsGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveTransactionsGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveTransactionsGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveTransactionsGetManyResponseMapped is not found in the empty JSON string", LeaveTransactionsGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveTransactionsGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        LeaveTransactionResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        LeaveTransactionRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveTransactionsGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveTransactionsGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveTransactionsGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveTransactionsGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveTransactionsGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, LeaveTransactionsGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public LeaveTransactionsGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveTransactionsGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveTransactionsGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveTransactionsGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to LeaveTransactionsGetManyResponseMapped
  */
  public static LeaveTransactionsGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveTransactionsGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of LeaveTransactionsGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
