...
public class TimesheetEntryGetOneResponseMapped {
  ...
  private TimesheetEntryResponse data;
  ...
  public TimesheetEntryGetOneResponseMapped() {
  }

  public TimesheetEntryGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public TimesheetEntryGetOneResponseMapped data(TimesheetEntryResponse data) {
  ...
  **/
  ...
  public TimesheetEntryResponse getData() {
    return data;
  }


  public void setData(TimesheetEntryResponse data) {
  ...
  public TimesheetEntryGetOneResponseMapped relations(TimesheetEntryRelationsResponse relations) {
  ...
  **/
   ...
   * @return the TimesheetEntryGetOneResponseMapped instance itself
   */
  public TimesheetEntryGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntryGetOneResponseMapped timesheetEntryGetOneResponseMapped = (TimesheetEntryGetOneResponseMapped) o;
    return Objects.equals(this.status, timesheetEntryGetOneResponseMapped.status) &&
        Objects.equals(this.data, timesheetEntryGetOneResponseMapped.data) &&
        Objects.equals(this.relations, timesheetEntryGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, timesheetEntryGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetEntryGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntryGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntryGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntryGetOneResponseMapped is not found in the empty JSON string", TimesheetEntryGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetEntryGetOneResponseMapped.openapiRequiredFields) {
      ...
      TimesheetEntryResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntryGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntryGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntryGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntryGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntryGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, TimesheetEntryGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public TimesheetEntryGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntryGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntryGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntryGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntryGetOneResponseMapped
  */
  public static TimesheetEntryGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntryGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of TimesheetEntryGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
