...
public class EmploymentResponseMapped {
  ...
  public EmploymentResponseMapped() {
  }

  public EmploymentResponseMapped status(String status) {
  ...
  **/
  ...
  public EmploymentResponseMapped data(EmploymentResponse data) {
  ...
  **/
   ...
   * @return the EmploymentResponseMapped instance itself
   */
  public EmploymentResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmploymentResponseMapped employmentResponseMapped = (EmploymentResponseMapped) o;
    return Objects.equals(this.status, employmentResponseMapped.status) &&
        Objects.equals(this.data, employmentResponseMapped.data)&&
        Objects.equals(this.additionalProperties, employmentResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmploymentResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmploymentResponseMapped is not found in the empty JSON string", EmploymentResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmploymentResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmploymentResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmploymentResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmploymentResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmploymentResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmploymentResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmploymentResponseMapped value) throws IOException {
           ...
           @Override
           public EmploymentResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmploymentResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmploymentResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmploymentResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmploymentResponseMapped
  */
  public static EmploymentResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmploymentResponseMapped.class);
  }

 /**
  * Convert an instance of EmploymentResponseMapped to an JSON string
  *
  * @return JSON string
  */
