...
public class TimesheetentrytypeListManyTimesheetEntryTypesSortParameter {
  /**
   * Gets or Sets id
   */
 ...
 public enum KindEnum {
  ...
  public TimesheetentrytypeListManyTimesheetEntryTypesSortParameter() {
  }

  public TimesheetentrytypeListManyTimesheetEntryTypesSortParameter id(IdEnum id) {
  ...
  **/
  ...
  public TimesheetentrytypeListManyTimesheetEntryTypesSortParameter name(NameEnum name) {
  ...
  **/
  ...
  public TimesheetentrytypeListManyTimesheetEntryTypesSortParameter kind(KindEnum kind) {
  ...
  **/
   ...
   * @return the TimesheetentrytypeListManyTimesheetEntryTypesSortParameter instance itself
   */
  public TimesheetentrytypeListManyTimesheetEntryTypesSortParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetentrytypeListManyTimesheetEntryTypesSortParameter timesheetentrytypeListManyTimesheetEntryTypesSortParameter = (TimesheetentrytypeListManyTimesheetEntryTypesSortParameter) o;
    return Objects.equals(this.id, timesheetentrytypeListManyTimesheetEntryTypesSortParameter.id) &&
        Objects.equals(this.name, timesheetentrytypeListManyTimesheetEntryTypesSortParameter.name) &&
        Objects.equals(this.kind, timesheetentrytypeListManyTimesheetEntryTypesSortParameter.kind)&&
        Objects.equals(this.additionalProperties, timesheetentrytypeListManyTimesheetEntryTypesSortParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetentrytypeListManyTimesheetEntryTypesSortParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetentrytypeListManyTimesheetEntryTypesSortParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetentrytypeListManyTimesheetEntryTypesSortParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetentrytypeListManyTimesheetEntryTypesSortParameter is not found in the empty JSON string", TimesheetentrytypeListManyTimesheetEntryTypesSortParameter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetentrytypeListManyTimesheetEntryTypesSortParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetentrytypeListManyTimesheetEntryTypesSortParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetentrytypeListManyTimesheetEntryTypesSortParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetentrytypeListManyTimesheetEntryTypesSortParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetentrytypeListManyTimesheetEntryTypesSortParameter>() {
           @Override
           public void write(JsonWriter out, TimesheetentrytypeListManyTimesheetEntryTypesSortParameter value) throws IOException {
           ...
           @Override
           public TimesheetentrytypeListManyTimesheetEntryTypesSortParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetentrytypeListManyTimesheetEntryTypesSortParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetentrytypeListManyTimesheetEntryTypesSortParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetentrytypeListManyTimesheetEntryTypesSortParameter
  * @throws IOException if the JSON string is invalid with respect to TimesheetentrytypeListManyTimesheetEntryTypesSortParameter
  */
  public static TimesheetentrytypeListManyTimesheetEntryTypesSortParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetentrytypeListManyTimesheetEntryTypesSortParameter.class);
  }

 /**
  * Convert an instance of TimesheetentrytypeListManyTimesheetEntryTypesSortParameter to an JSON string
  *
  * @return JSON string
  */
