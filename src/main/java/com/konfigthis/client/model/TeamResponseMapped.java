...
public class TeamResponseMapped {
  ...
  public TeamResponseMapped() {
  }

  public TeamResponseMapped status(String status) {
  ...
  **/
  ...
  public TeamResponseMapped data(TeamResponse data) {
  ...
  **/
   ...
   * @return the TeamResponseMapped instance itself
   */
  public TeamResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamResponseMapped teamResponseMapped = (TeamResponseMapped) o;
    return Objects.equals(this.status, teamResponseMapped.status) &&
        Objects.equals(this.data, teamResponseMapped.data)&&
        Objects.equals(this.additionalProperties, teamResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamResponseMapped is not found in the empty JSON string", TeamResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamResponseMapped>() {
           @Override
           public void write(JsonWriter out, TeamResponseMapped value) throws IOException {
           ...
           @Override
           public TeamResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TeamResponseMapped
  */
  public static TeamResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamResponseMapped.class);
  }

 /**
  * Convert an instance of TeamResponseMapped to an JSON string
  *
  * @return JSON string
  */
