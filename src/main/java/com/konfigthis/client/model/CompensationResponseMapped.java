...
public class CompensationResponseMapped {
  ...
  public CompensationResponseMapped() {
  }

  public CompensationResponseMapped status(String status) {
  ...
  **/
  ...
  public CompensationResponseMapped data(CompensationResponse data) {
  ...
  **/
   ...
   * @return the CompensationResponseMapped instance itself
   */
  public CompensationResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompensationResponseMapped compensationResponseMapped = (CompensationResponseMapped) o;
    return Objects.equals(this.status, compensationResponseMapped.status) &&
        Objects.equals(this.data, compensationResponseMapped.data)&&
        Objects.equals(this.additionalProperties, compensationResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompensationResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompensationResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompensationResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompensationResponseMapped is not found in the empty JSON string", CompensationResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompensationResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompensationResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompensationResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompensationResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompensationResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CompensationResponseMapped>() {
           @Override
           public void write(JsonWriter out, CompensationResponseMapped value) throws IOException {
           ...
           @Override
           public CompensationResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompensationResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompensationResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompensationResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CompensationResponseMapped
  */
  public static CompensationResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompensationResponseMapped.class);
  }

 /**
  * Convert an instance of CompensationResponseMapped to an JSON string
  *
  * @return JSON string
  */
