...
public class EmployeeTeamReferenceGetOneResponseMapped {
  ...
  private EmployeeTeamReferenceResponse data;
  ...
  public EmployeeTeamReferenceGetOneResponseMapped() {
  }

  public EmployeeTeamReferenceGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public EmployeeTeamReferenceGetOneResponseMapped data(EmployeeTeamReferenceResponse data) {
  ...
  **/
  ...
  public EmployeeTeamReferenceResponse getData() {
    return data;
  }


  public void setData(EmployeeTeamReferenceResponse data) {
  ...
  public EmployeeTeamReferenceGetOneResponseMapped relations(EmployeeTeamReferenceRelationsResponse relations) {
  ...
  **/
   ...
   * @return the EmployeeTeamReferenceGetOneResponseMapped instance itself
   */
  public EmployeeTeamReferenceGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeTeamReferenceGetOneResponseMapped employeeTeamReferenceGetOneResponseMapped = (EmployeeTeamReferenceGetOneResponseMapped) o;
    return Objects.equals(this.status, employeeTeamReferenceGetOneResponseMapped.status) &&
        Objects.equals(this.data, employeeTeamReferenceGetOneResponseMapped.data) &&
        Objects.equals(this.relations, employeeTeamReferenceGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, employeeTeamReferenceGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeTeamReferenceGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTeamReferenceGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTeamReferenceGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeTeamReferenceGetOneResponseMapped is not found in the empty JSON string", EmployeeTeamReferenceGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeTeamReferenceGetOneResponseMapped.openapiRequiredFields) {
      ...
      EmployeeTeamReferenceResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeTeamReferenceGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeTeamReferenceGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeTeamReferenceGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeTeamReferenceGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeTeamReferenceGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmployeeTeamReferenceGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public EmployeeTeamReferenceGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeTeamReferenceGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeTeamReferenceGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeTeamReferenceGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmployeeTeamReferenceGetOneResponseMapped
  */
  public static EmployeeTeamReferenceGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeTeamReferenceGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of EmployeeTeamReferenceGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
