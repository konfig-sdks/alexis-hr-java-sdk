...
public class LeaveGetOneResponseMapped {
  ...
  public LeaveGetOneResponseMapped() {
  }

  public LeaveGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public LeaveGetOneResponseMapped data(LeaveResponse data) {
  ...
  **/
  ...
  public LeaveResponse getData() {
    return data;
  }


  public void setData(LeaveResponse data) {
  ...
  public LeaveGetOneResponseMapped relations(LeaveRelationsResponse relations) {
  ...
  **/
   ...
   * @return the LeaveGetOneResponseMapped instance itself
   */
  public LeaveGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveGetOneResponseMapped leaveGetOneResponseMapped = (LeaveGetOneResponseMapped) o;
    return Objects.equals(this.status, leaveGetOneResponseMapped.status) &&
        Objects.equals(this.data, leaveGetOneResponseMapped.data) &&
        Objects.equals(this.relations, leaveGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, leaveGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeaveGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveGetOneResponseMapped is not found in the empty JSON string", LeaveGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveGetOneResponseMapped.openapiRequiredFields) {
      ...
      LeaveResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, LeaveGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public LeaveGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to LeaveGetOneResponseMapped
  */
  public static LeaveGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of LeaveGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
