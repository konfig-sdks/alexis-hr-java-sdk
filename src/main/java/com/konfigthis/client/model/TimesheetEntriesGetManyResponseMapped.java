...
import com.konfigthis.client.model.TimesheetEntryRelationsResponse;
import com.konfigthis.client.model.TimesheetEntryResponse;
...
public class TimesheetEntriesGetManyResponseMapped {
  ...
  private List<TimesheetEntryResponse> data = new ArrayList<>();
  ...
  private TimesheetEntryRelationsResponse relations;

  public TimesheetEntriesGetManyResponseMapped() {
  }

  public TimesheetEntriesGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public TimesheetEntriesGetManyResponseMapped data(List<TimesheetEntryResponse> data) {
  ...
  public TimesheetEntriesGetManyResponseMapped addDataItem(TimesheetEntryResponse dataItem) {
  ...
  **/
  ...
  public List<TimesheetEntryResponse> getData() {
    return data;
  }


  public void setData(List<TimesheetEntryResponse> data) {
  ...
  public TimesheetEntriesGetManyResponseMapped total(Double total) {
  ...
  public TimesheetEntriesGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public TimesheetEntriesGetManyResponseMapped count(Double count) {
  ...
  public TimesheetEntriesGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public TimesheetEntriesGetManyResponseMapped offset(Double offset) {
  ...
  public TimesheetEntriesGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public TimesheetEntriesGetManyResponseMapped relations(TimesheetEntryRelationsResponse relations) {
  ...
  **/
  ...
  public TimesheetEntryRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(TimesheetEntryRelationsResponse relations) {
   ...
   * @return the TimesheetEntriesGetManyResponseMapped instance itself
   */
  public TimesheetEntriesGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntriesGetManyResponseMapped timesheetEntriesGetManyResponseMapped = (TimesheetEntriesGetManyResponseMapped) o;
    return Objects.equals(this.status, timesheetEntriesGetManyResponseMapped.status) &&
        Objects.equals(this.data, timesheetEntriesGetManyResponseMapped.data) &&
        Objects.equals(this.total, timesheetEntriesGetManyResponseMapped.total) &&
        Objects.equals(this.count, timesheetEntriesGetManyResponseMapped.count) &&
        Objects.equals(this.offset, timesheetEntriesGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, timesheetEntriesGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, timesheetEntriesGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetEntriesGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntriesGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntriesGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntriesGetManyResponseMapped is not found in the empty JSON string", TimesheetEntriesGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetEntriesGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        TimesheetEntryResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        TimesheetEntryRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntriesGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntriesGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntriesGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntriesGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntriesGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, TimesheetEntriesGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public TimesheetEntriesGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntriesGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntriesGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntriesGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntriesGetManyResponseMapped
  */
  public static TimesheetEntriesGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntriesGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of TimesheetEntriesGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
