...
public class CostCenterResponseMapped {
  ...
  public CostCenterResponseMapped() {
  }

  public CostCenterResponseMapped status(String status) {
  ...
  **/
  ...
  public CostCenterResponseMapped data(CostCenterResponse data) {
  ...
  **/
   ...
   * @return the CostCenterResponseMapped instance itself
   */
  public CostCenterResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CostCenterResponseMapped costCenterResponseMapped = (CostCenterResponseMapped) o;
    return Objects.equals(this.status, costCenterResponseMapped.status) &&
        Objects.equals(this.data, costCenterResponseMapped.data)&&
        Objects.equals(this.additionalProperties, costCenterResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CostCenterResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CostCenterResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CostCenterResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CostCenterResponseMapped is not found in the empty JSON string", CostCenterResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CostCenterResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CostCenterResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CostCenterResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CostCenterResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CostCenterResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CostCenterResponseMapped>() {
           @Override
           public void write(JsonWriter out, CostCenterResponseMapped value) throws IOException {
           ...
           @Override
           public CostCenterResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CostCenterResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CostCenterResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CostCenterResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CostCenterResponseMapped
  */
  public static CostCenterResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CostCenterResponseMapped.class);
  }

 /**
  * Convert an instance of CostCenterResponseMapped to an JSON string
  *
  * @return JSON string
  */
