...
public class DepartmentListManyDepartmentsFiltersParameter {
  ...
  private CompanyListManyCompaniesFiltersParameterId effectiveCostCenterId;

  public static final String SERIALIZED_NAME_PARENT_ID = "parentId";
  @SerializedName(SERIALIZED_NAME_PARENT_ID)
  private CompanyListManyCompaniesFiltersParameterId parentId;

  public DepartmentListManyDepartmentsFiltersParameter() {
  }

  public DepartmentListManyDepartmentsFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsFiltersParameter companyId(CompanyListManyCompaniesFiltersParameterId companyId) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsFiltersParameter name(CompanyListManyCompaniesFiltersParameterId name) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsFiltersParameter costCenterId(CompanyListManyCompaniesFiltersParameterId costCenterId) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsFiltersParameter effectiveCostCenterId(CompanyListManyCompaniesFiltersParameterId effectiveCostCenterId) {
  ...
  **/
  ...
  public CompanyListManyCompaniesFiltersParameterId getEffectiveCostCenterId() {
    return effectiveCostCenterId;
  }


  public void setEffectiveCostCenterId(CompanyListManyCompaniesFiltersParameterId effectiveCostCenterId) {
  ...
  public DepartmentListManyDepartmentsFiltersParameter parentId(CompanyListManyCompaniesFiltersParameterId parentId) {
  ...
  **/
  ...
  public CompanyListManyCompaniesFiltersParameterId getParentId() {
    return parentId;
  }


  public void setParentId(CompanyListManyCompaniesFiltersParameterId parentId) {
   ...
   * @return the DepartmentListManyDepartmentsFiltersParameter instance itself
   */
  public DepartmentListManyDepartmentsFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DepartmentListManyDepartmentsFiltersParameter departmentListManyDepartmentsFiltersParameter = (DepartmentListManyDepartmentsFiltersParameter) o;
    return Objects.equals(this.id, departmentListManyDepartmentsFiltersParameter.id) &&
        Objects.equals(this.companyId, departmentListManyDepartmentsFiltersParameter.companyId) &&
        Objects.equals(this.name, departmentListManyDepartmentsFiltersParameter.name) &&
        Objects.equals(this.costCenterId, departmentListManyDepartmentsFiltersParameter.costCenterId) &&
        Objects.equals(this.effectiveCostCenterId, departmentListManyDepartmentsFiltersParameter.effectiveCostCenterId) &&
        Objects.equals(this.parentId, departmentListManyDepartmentsFiltersParameter.parentId)&&
        Objects.equals(this.additionalProperties, departmentListManyDepartmentsFiltersParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepartmentListManyDepartmentsFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DepartmentListManyDepartmentsFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DepartmentListManyDepartmentsFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepartmentListManyDepartmentsFiltersParameter is not found in the empty JSON string", DepartmentListManyDepartmentsFiltersParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `effectiveCostCenterId`
      if (jsonObj.get("effectiveCostCenterId") != null && !jsonObj.get("effectiveCostCenterId").isJsonNull()) {
        CompanyListManyCompaniesFiltersParameterId.validateJsonObject(jsonObj.getAsJsonObject("effectiveCostCenterId"));
      }
      // validate the optional field `parentId`
      if (jsonObj.get("parentId") != null && !jsonObj.get("parentId").isJsonNull()) {
        CompanyListManyCompaniesFiltersParameterId.validateJsonObject(jsonObj.getAsJsonObject("parentId"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepartmentListManyDepartmentsFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepartmentListManyDepartmentsFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepartmentListManyDepartmentsFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepartmentListManyDepartmentsFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<DepartmentListManyDepartmentsFiltersParameter>() {
           @Override
           public void write(JsonWriter out, DepartmentListManyDepartmentsFiltersParameter value) throws IOException {
           ...
           @Override
           public DepartmentListManyDepartmentsFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DepartmentListManyDepartmentsFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DepartmentListManyDepartmentsFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DepartmentListManyDepartmentsFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to DepartmentListManyDepartmentsFiltersParameter
  */
  public static DepartmentListManyDepartmentsFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepartmentListManyDepartmentsFiltersParameter.class);
  }

 /**
  * Convert an instance of DepartmentListManyDepartmentsFiltersParameter to an JSON string
  *
  * @return JSON string
  */
