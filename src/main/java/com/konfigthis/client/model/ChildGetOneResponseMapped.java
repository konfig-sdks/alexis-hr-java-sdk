...
public class ChildGetOneResponseMapped {
  ...
  public ChildGetOneResponseMapped() {
  }

  public ChildGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public ChildGetOneResponseMapped data(ChildResponse data) {
  ...
  **/
  ...
  public ChildResponse getData() {
    return data;
  }


  public void setData(ChildResponse data) {
  ...
  public ChildGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the ChildGetOneResponseMapped instance itself
   */
  public ChildGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChildGetOneResponseMapped childGetOneResponseMapped = (ChildGetOneResponseMapped) o;
    return Objects.equals(this.status, childGetOneResponseMapped.status) &&
        Objects.equals(this.data, childGetOneResponseMapped.data) &&
        Objects.equals(this.relations, childGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, childGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChildGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChildGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChildGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChildGetOneResponseMapped is not found in the empty JSON string", ChildGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChildGetOneResponseMapped.openapiRequiredFields) {
      ...
      ChildResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChildGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChildGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChildGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChildGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<ChildGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, ChildGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public ChildGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChildGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChildGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChildGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to ChildGetOneResponseMapped
  */
  public static ChildGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChildGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of ChildGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
