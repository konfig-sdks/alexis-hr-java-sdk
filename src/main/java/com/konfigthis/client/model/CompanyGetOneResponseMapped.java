...
public class CompanyGetOneResponseMapped {
  ...
  public CompanyGetOneResponseMapped() {
  }

  public CompanyGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public CompanyGetOneResponseMapped data(CompanyResponse data) {
  ...
  **/
  ...
  public CompanyResponse getData() {
    return data;
  }


  public void setData(CompanyResponse data) {
  ...
  public CompanyGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the CompanyGetOneResponseMapped instance itself
   */
  public CompanyGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyGetOneResponseMapped companyGetOneResponseMapped = (CompanyGetOneResponseMapped) o;
    return Objects.equals(this.status, companyGetOneResponseMapped.status) &&
        Objects.equals(this.data, companyGetOneResponseMapped.data) &&
        Objects.equals(this.relations, companyGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, companyGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompanyGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompanyGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyGetOneResponseMapped is not found in the empty JSON string", CompanyGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompanyGetOneResponseMapped.openapiRequiredFields) {
      ...
      CompanyResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, CompanyGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public CompanyGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompanyGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompanyGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompanyGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to CompanyGetOneResponseMapped
  */
  public static CompanyGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of CompanyGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
