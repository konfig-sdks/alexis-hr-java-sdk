...
public class OfficeListManyOfficesSortParameter {
  /**
   * Gets or Sets id
   */
 ...
 public enum TimezoneEnum {
   ...
   * Gets or Sets CFAR
   */
  @JsonAdapter(CFAREnum.Adapter.class)
 public enum CFAREnum {
    ASC("asc"),
    ...
    public static CFAREnum fromValue(String value) {
      for (CFAREnum b : CFAREnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<CFAREnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final CFAREnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public CFAREnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return CFAREnum.fromValue(value);
      }
    }
  }
  ...
  private CFAREnum CFAR;

  /**
   * Gets or Sets SCB
   */
  @JsonAdapter(SCBEnum.Adapter.class)
 public enum SCBEnum {
    ASC("asc"),
    ...
    public static SCBEnum fromValue(String value) {
      for (SCBEnum b : SCBEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<SCBEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SCBEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SCBEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SCBEnum.fromValue(value);
      }
    }
  }
   ...
   * Gets or Sets SNI
   */
  @JsonAdapter(SNIEnum.Adapter.class)
 public enum SNIEnum {
    ASC("asc"),
    ...
    public static SNIEnum fromValue(String value) {
      for (SNIEnum b : SNIEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<SNIEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SNIEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SNIEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SNIEnum.fromValue(value);
      }
    }
  }
  ...
  public OfficeListManyOfficesSortParameter() {
  }

  public OfficeListManyOfficesSortParameter id(IdEnum id) {
  ...
  **/
  ...
  public OfficeListManyOfficesSortParameter companyId(CompanyIdEnum companyId) {
  ...
  **/
  ...
  public OfficeListManyOfficesSortParameter name(NameEnum name) {
  ...
  **/
  ...
  public OfficeListManyOfficesSortParameter phone(PhoneEnum phone) {
  ...
  **/
  ...
  public OfficeListManyOfficesSortParameter email(EmailEnum email) {
  ...
  **/
  ...
  public OfficeListManyOfficesSortParameter timezone(TimezoneEnum timezone) {
  ...
  **/
  ...
  public OfficeListManyOfficesSortParameter CFAR(CFAREnum CFAR) {
  ...
  **/
  ...
  public CFAREnum getCFAR() {
    return CFAR;
  }


  public void setCFAR(CFAREnum CFAR) {
  ...
  public OfficeListManyOfficesSortParameter SCB(SCBEnum SCB) {
  ...
  **/
  ...
  public SCBEnum getSCB() {
    return SCB;
  }


  public void setSCB(SCBEnum SCB) {
  ...
  public OfficeListManyOfficesSortParameter SNI(SNIEnum SNI) {
  ...
  **/
  ...
  public SNIEnum getSNI() {
    return SNI;
  }


  public void setSNI(SNIEnum SNI) {
   ...
   * @return the OfficeListManyOfficesSortParameter instance itself
   */
  public OfficeListManyOfficesSortParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OfficeListManyOfficesSortParameter officeListManyOfficesSortParameter = (OfficeListManyOfficesSortParameter) o;
    return Objects.equals(this.id, officeListManyOfficesSortParameter.id) &&
        Objects.equals(this.companyId, officeListManyOfficesSortParameter.companyId) &&
        Objects.equals(this.name, officeListManyOfficesSortParameter.name) &&
        Objects.equals(this.phone, officeListManyOfficesSortParameter.phone) &&
        Objects.equals(this.email, officeListManyOfficesSortParameter.email) &&
        Objects.equals(this.timezone, officeListManyOfficesSortParameter.timezone) &&
        Objects.equals(this.CFAR, officeListManyOfficesSortParameter.CFAR) &&
        Objects.equals(this.SCB, officeListManyOfficesSortParameter.SCB) &&
        Objects.equals(this.SNI, officeListManyOfficesSortParameter.SNI)&&
        Objects.equals(this.additionalProperties, officeListManyOfficesSortParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OfficeListManyOfficesSortParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OfficeListManyOfficesSortParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OfficeListManyOfficesSortParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OfficeListManyOfficesSortParameter is not found in the empty JSON string", OfficeListManyOfficesSortParameter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OfficeListManyOfficesSortParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OfficeListManyOfficesSortParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OfficeListManyOfficesSortParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OfficeListManyOfficesSortParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<OfficeListManyOfficesSortParameter>() {
           @Override
           public void write(JsonWriter out, OfficeListManyOfficesSortParameter value) throws IOException {
           ...
           @Override
           public OfficeListManyOfficesSortParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OfficeListManyOfficesSortParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OfficeListManyOfficesSortParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OfficeListManyOfficesSortParameter
  * @throws IOException if the JSON string is invalid with respect to OfficeListManyOfficesSortParameter
  */
  public static OfficeListManyOfficesSortParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OfficeListManyOfficesSortParameter.class);
  }

 /**
  * Convert an instance of OfficeListManyOfficesSortParameter to an JSON string
  *
  * @return JSON string
  */
