...
public class DepartmentListManyDepartmentsSortParameter {
  /**
   * Gets or Sets id
   */
 ...
 public enum CostCenterIdEnum {
  ...
  /**
   * Gets or Sets effectiveCostCenterId
   */
  @JsonAdapter(EffectiveCostCenterIdEnum.Adapter.class)
 public enum EffectiveCostCenterIdEnum {
    ASC("asc"),
    ...
    EffectiveCostCenterIdEnum(String value) {
      this.value = value;
    }
    ...
    public static EffectiveCostCenterIdEnum fromValue(String value) {
      for (EffectiveCostCenterIdEnum b : EffectiveCostCenterIdEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<EffectiveCostCenterIdEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final EffectiveCostCenterIdEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public EffectiveCostCenterIdEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return EffectiveCostCenterIdEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_EFFECTIVE_COST_CENTER_ID = "effectiveCostCenterId";
  @SerializedName(SERIALIZED_NAME_EFFECTIVE_COST_CENTER_ID)
  private EffectiveCostCenterIdEnum effectiveCostCenterId;

  /**
   * Gets or Sets parentId
   */
  @JsonAdapter(ParentIdEnum.Adapter.class)
 public enum ParentIdEnum {
    ...
    public static ParentIdEnum fromValue(String value) {
      for (ParentIdEnum b : ParentIdEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ParentIdEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ParentIdEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ParentIdEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ParentIdEnum.fromValue(value);
      }
    }
  }
  ...
  public DepartmentListManyDepartmentsSortParameter() {
  }

  public DepartmentListManyDepartmentsSortParameter id(IdEnum id) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsSortParameter companyId(CompanyIdEnum companyId) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsSortParameter name(NameEnum name) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsSortParameter costCenterId(CostCenterIdEnum costCenterId) {
  ...
  **/
  ...
  public DepartmentListManyDepartmentsSortParameter effectiveCostCenterId(EffectiveCostCenterIdEnum effectiveCostCenterId) {
    
    
    
    
    this.effectiveCostCenterId = effectiveCostCenterId;
    return this;
  }

   /**
   * Get effectiveCostCenterId
   * @return effectiveCostCenterId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public EffectiveCostCenterIdEnum getEffectiveCostCenterId() {
    return effectiveCostCenterId;
  }


  public void setEffectiveCostCenterId(EffectiveCostCenterIdEnum effectiveCostCenterId) {
  ...
  public DepartmentListManyDepartmentsSortParameter parentId(ParentIdEnum parentId) {
  ...
  **/
   ...
   * @return the DepartmentListManyDepartmentsSortParameter instance itself
   */
  public DepartmentListManyDepartmentsSortParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DepartmentListManyDepartmentsSortParameter departmentListManyDepartmentsSortParameter = (DepartmentListManyDepartmentsSortParameter) o;
    return Objects.equals(this.id, departmentListManyDepartmentsSortParameter.id) &&
        Objects.equals(this.companyId, departmentListManyDepartmentsSortParameter.companyId) &&
        Objects.equals(this.name, departmentListManyDepartmentsSortParameter.name) &&
        Objects.equals(this.costCenterId, departmentListManyDepartmentsSortParameter.costCenterId) &&
        Objects.equals(this.effectiveCostCenterId, departmentListManyDepartmentsSortParameter.effectiveCostCenterId) &&
        Objects.equals(this.parentId, departmentListManyDepartmentsSortParameter.parentId)&&
        Objects.equals(this.additionalProperties, departmentListManyDepartmentsSortParameter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, name, costCenterId, effectiveCostCenterId, parentId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DepartmentListManyDepartmentsSortParameter {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    companyId: ").append(toIndentedString(companyId)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    costCenterId: ").append(toIndentedString(costCenterId)).append("\n");
    sb.append("    effectiveCostCenterId: ").append(toIndentedString(effectiveCostCenterId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("effectiveCostCenterId");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DepartmentListManyDepartmentsSortParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DepartmentListManyDepartmentsSortParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepartmentListManyDepartmentsSortParameter is not found in the empty JSON string", DepartmentListManyDepartmentsSortParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("effectiveCostCenterId") != null && !jsonObj.get("effectiveCostCenterId").isJsonNull()) && !jsonObj.get("effectiveCostCenterId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `effectiveCostCenterId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("effectiveCostCenterId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepartmentListManyDepartmentsSortParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepartmentListManyDepartmentsSortParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepartmentListManyDepartmentsSortParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepartmentListManyDepartmentsSortParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<DepartmentListManyDepartmentsSortParameter>() {
           @Override
           public void write(JsonWriter out, DepartmentListManyDepartmentsSortParameter value) throws IOException {
           ...
           @Override
           public DepartmentListManyDepartmentsSortParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DepartmentListManyDepartmentsSortParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DepartmentListManyDepartmentsSortParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DepartmentListManyDepartmentsSortParameter
  * @throws IOException if the JSON string is invalid with respect to DepartmentListManyDepartmentsSortParameter
  */
  public static DepartmentListManyDepartmentsSortParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepartmentListManyDepartmentsSortParameter.class);
  }

 /**
  * Convert an instance of DepartmentListManyDepartmentsSortParameter to an JSON string
  *
  * @return JSON string
  */
