...
import com.konfigthis.client.model.EmployeeGetOneRelationsResponse;
...
public class EmployeeGetOneResponseMapped {
  ...
  private EmployeeGetOneRelationsResponse relations;

  public EmployeeGetOneResponseMapped() {
  }

  public EmployeeGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public EmployeeGetOneResponseMapped data(EmployeeResponse data) {
  ...
  **/
  ...
  public EmployeeGetOneResponseMapped relations(EmployeeGetOneRelationsResponse relations) {
  ...
  **/
  ...
  public EmployeeGetOneRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(EmployeeGetOneRelationsResponse relations) {
   ...
   * @return the EmployeeGetOneResponseMapped instance itself
   */
  public EmployeeGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeGetOneResponseMapped employeeGetOneResponseMapped = (EmployeeGetOneResponseMapped) o;
    return Objects.equals(this.status, employeeGetOneResponseMapped.status) &&
        Objects.equals(this.data, employeeGetOneResponseMapped.data) &&
        Objects.equals(this.relations, employeeGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, employeeGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeGetOneResponseMapped is not found in the empty JSON string", EmployeeGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeGetOneResponseMapped.openapiRequiredFields) {
      ...
      EmployeeResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        EmployeeGetOneRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmployeeGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public EmployeeGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmployeeGetOneResponseMapped
  */
  public static EmployeeGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of EmployeeGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
