...
import com.konfigthis.client.model.DepartmentRelationsResponse;
...
public class DepartmentsGetManyResponseMapped {
  ...
  private List<DepartmentResponse> data = new ArrayList<>();
  ...
  private DepartmentRelationsResponse relations;

  public DepartmentsGetManyResponseMapped() {
  }

  public DepartmentsGetManyResponseMapped status(String status) {
  ...
  **/
  ...
  public DepartmentsGetManyResponseMapped data(List<DepartmentResponse> data) {
  ...
  public DepartmentsGetManyResponseMapped addDataItem(DepartmentResponse dataItem) {
  ...
  **/
  ...
  public List<DepartmentResponse> getData() {
    return data;
  }


  public void setData(List<DepartmentResponse> data) {
  ...
  public DepartmentsGetManyResponseMapped total(Double total) {
  ...
  public DepartmentsGetManyResponseMapped total(Integer total) {
  ...
  **/
  ...
  public DepartmentsGetManyResponseMapped count(Double count) {
  ...
  public DepartmentsGetManyResponseMapped count(Integer count) {
  ...
  **/
  ...
  public DepartmentsGetManyResponseMapped offset(Double offset) {
  ...
  public DepartmentsGetManyResponseMapped offset(Integer offset) {
  ...
  **/
  ...
  public DepartmentsGetManyResponseMapped relations(DepartmentRelationsResponse relations) {
  ...
  **/
  ...
  public DepartmentRelationsResponse getRelations() {
    return relations;
  }


  public void setRelations(DepartmentRelationsResponse relations) {
   ...
   * @return the DepartmentsGetManyResponseMapped instance itself
   */
  public DepartmentsGetManyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DepartmentsGetManyResponseMapped departmentsGetManyResponseMapped = (DepartmentsGetManyResponseMapped) o;
    return Objects.equals(this.status, departmentsGetManyResponseMapped.status) &&
        Objects.equals(this.data, departmentsGetManyResponseMapped.data) &&
        Objects.equals(this.total, departmentsGetManyResponseMapped.total) &&
        Objects.equals(this.count, departmentsGetManyResponseMapped.count) &&
        Objects.equals(this.offset, departmentsGetManyResponseMapped.offset) &&
        Objects.equals(this.relations, departmentsGetManyResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, departmentsGetManyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepartmentsGetManyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DepartmentsGetManyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DepartmentsGetManyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepartmentsGetManyResponseMapped is not found in the empty JSON string", DepartmentsGetManyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DepartmentsGetManyResponseMapped.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        DepartmentResponse.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the optional field `relations`
      if (jsonObj.get("relations") != null && !jsonObj.get("relations").isJsonNull()) {
        DepartmentRelationsResponse.validateJsonObject(jsonObj.getAsJsonObject("relations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepartmentsGetManyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepartmentsGetManyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepartmentsGetManyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepartmentsGetManyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<DepartmentsGetManyResponseMapped>() {
           @Override
           public void write(JsonWriter out, DepartmentsGetManyResponseMapped value) throws IOException {
           ...
           @Override
           public DepartmentsGetManyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DepartmentsGetManyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DepartmentsGetManyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DepartmentsGetManyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to DepartmentsGetManyResponseMapped
  */
  public static DepartmentsGetManyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepartmentsGetManyResponseMapped.class);
  }

 /**
  * Convert an instance of DepartmentsGetManyResponseMapped to an JSON string
  *
  * @return JSON string
  */
