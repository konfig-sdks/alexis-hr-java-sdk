...
public class CreateCostCenterRequest {
  ...
  public CreateCostCenterRequest code(String code) {
  ...
  **/
  ...
  public CreateCostCenterRequest name(String name) {
  ...
  **/
   ...
   * @return the CreateCostCenterRequest instance itself
   */
  public CreateCostCenterRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCostCenterRequest createCostCenterRequest = (CreateCostCenterRequest) o;
    return Objects.equals(this.code, createCostCenterRequest.code) &&
        Objects.equals(this.name, createCostCenterRequest.name)&&
        Objects.equals(this.additionalProperties, createCostCenterRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCostCenterRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateCostCenterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCostCenterRequest is not found in the empty JSON string", CreateCostCenterRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCostCenterRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCostCenterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCostCenterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCostCenterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCostCenterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCostCenterRequest>() {
           @Override
           public void write(JsonWriter out, CreateCostCenterRequest value) throws IOException {
           ...
           @Override
           public CreateCostCenterRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateCostCenterRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateCostCenterRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCostCenterRequest
  * @throws IOException if the JSON string is invalid with respect to CreateCostCenterRequest
  */
  public static CreateCostCenterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCostCenterRequest.class);
  }

 /**
  * Convert an instance of CreateCostCenterRequest to an JSON string
  *
  * @return JSON string
  */
