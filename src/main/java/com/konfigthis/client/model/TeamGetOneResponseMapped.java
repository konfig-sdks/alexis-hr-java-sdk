...
public class TeamGetOneResponseMapped {
  ...
  public TeamGetOneResponseMapped() {
  }

  public TeamGetOneResponseMapped status(String status) {
  ...
  **/
  ...
  public TeamGetOneResponseMapped data(TeamResponse data) {
  ...
  **/
  ...
  public TeamGetOneResponseMapped relations(Object relations) {
  ...
  **/
   ...
   * @return the TeamGetOneResponseMapped instance itself
   */
  public TeamGetOneResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamGetOneResponseMapped teamGetOneResponseMapped = (TeamGetOneResponseMapped) o;
    return Objects.equals(this.status, teamGetOneResponseMapped.status) &&
        Objects.equals(this.data, teamGetOneResponseMapped.data) &&
        Objects.equals(this.relations, teamGetOneResponseMapped.relations)&&
        Objects.equals(this.additionalProperties, teamGetOneResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamGetOneResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamGetOneResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamGetOneResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamGetOneResponseMapped is not found in the empty JSON string", TeamGetOneResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamGetOneResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamGetOneResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamGetOneResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamGetOneResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamGetOneResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamGetOneResponseMapped>() {
           @Override
           public void write(JsonWriter out, TeamGetOneResponseMapped value) throws IOException {
           ...
           @Override
           public TeamGetOneResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamGetOneResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamGetOneResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamGetOneResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TeamGetOneResponseMapped
  */
  public static TeamGetOneResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamGetOneResponseMapped.class);
  }

 /**
  * Convert an instance of TeamGetOneResponseMapped to an JSON string
  *
  * @return JSON string
  */
