...
public class EmptyResponseMapped {
  ...
  public EmptyResponseMapped() {
  }

  public EmptyResponseMapped status(String status) {
  ...
  **/
  ...
  public EmptyResponseMapped data(Object data) {
  ...
  **/
   ...
   * @return the EmptyResponseMapped instance itself
   */
  public EmptyResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmptyResponseMapped emptyResponseMapped = (EmptyResponseMapped) o;
    return Objects.equals(this.status, emptyResponseMapped.status) &&
        Objects.equals(this.data, emptyResponseMapped.data)&&
        Objects.equals(this.additionalProperties, emptyResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmptyResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmptyResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmptyResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmptyResponseMapped is not found in the empty JSON string", EmptyResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmptyResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmptyResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmptyResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmptyResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmptyResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<EmptyResponseMapped>() {
           @Override
           public void write(JsonWriter out, EmptyResponseMapped value) throws IOException {
           ...
           @Override
           public EmptyResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmptyResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmptyResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmptyResponseMapped
  * @throws IOException if the JSON string is invalid with respect to EmptyResponseMapped
  */
  public static EmptyResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmptyResponseMapped.class);
  }

 /**
  * Convert an instance of EmptyResponseMapped to an JSON string
  *
  * @return JSON string
  */
