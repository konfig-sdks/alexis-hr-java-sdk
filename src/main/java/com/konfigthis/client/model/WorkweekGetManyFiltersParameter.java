...
public class WorkweekGetManyFiltersParameter {
  ...
  private CompanyListManyCompaniesFiltersParameterId effectiveFrom;
  ...
  public WorkweekGetManyFiltersParameter() {
  }

  public WorkweekGetManyFiltersParameter id(CompanyListManyCompaniesFiltersParameterId id) {
  ...
  **/
  ...
  public WorkweekGetManyFiltersParameter companyId(CompanyListManyCompaniesFiltersParameterId companyId) {
  ...
  **/
  ...
  public WorkweekGetManyFiltersParameter officeId(CompanyListManyCompaniesFiltersParameterId officeId) {
  ...
  **/
  ...
  public WorkweekGetManyFiltersParameter employeeId(CompanyListManyCompaniesFiltersParameterId employeeId) {
  ...
  **/
  ...
  public WorkweekGetManyFiltersParameter effectiveFrom(CompanyListManyCompaniesFiltersParameterId effectiveFrom) {
  ...
  **/
  ...
  public CompanyListManyCompaniesFiltersParameterId getEffectiveFrom() {
    return effectiveFrom;
  }


  public void setEffectiveFrom(CompanyListManyCompaniesFiltersParameterId effectiveFrom) {
  ...
  public WorkweekGetManyFiltersParameter timezone(CompanyListManyCompaniesFiltersParameterId timezone) {
  ...
  **/
  ...
  public WorkweekGetManyFiltersParameter duration(CompanyListManyCompaniesFiltersParameterId duration) {
  ...
  **/
   ...
   * @return the WorkweekGetManyFiltersParameter instance itself
   */
  public WorkweekGetManyFiltersParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WorkweekGetManyFiltersParameter workweekGetManyFiltersParameter = (WorkweekGetManyFiltersParameter) o;
    return Objects.equals(this.id, workweekGetManyFiltersParameter.id) &&
        Objects.equals(this.companyId, workweekGetManyFiltersParameter.companyId) &&
        Objects.equals(this.officeId, workweekGetManyFiltersParameter.officeId) &&
        Objects.equals(this.employeeId, workweekGetManyFiltersParameter.employeeId) &&
        Objects.equals(this.effectiveFrom, workweekGetManyFiltersParameter.effectiveFrom) &&
        Objects.equals(this.timezone, workweekGetManyFiltersParameter.timezone) &&
        Objects.equals(this.duration, workweekGetManyFiltersParameter.duration)&&
        Objects.equals(this.additionalProperties, workweekGetManyFiltersParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkweekGetManyFiltersParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkweekGetManyFiltersParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkweekGetManyFiltersParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkweekGetManyFiltersParameter is not found in the empty JSON string", WorkweekGetManyFiltersParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `effectiveFrom`
      if (jsonObj.get("effectiveFrom") != null && !jsonObj.get("effectiveFrom").isJsonNull()) {
        CompanyListManyCompaniesFiltersParameterId.validateJsonObject(jsonObj.getAsJsonObject("effectiveFrom"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkweekGetManyFiltersParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkweekGetManyFiltersParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkweekGetManyFiltersParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkweekGetManyFiltersParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkweekGetManyFiltersParameter>() {
           @Override
           public void write(JsonWriter out, WorkweekGetManyFiltersParameter value) throws IOException {
           ...
           @Override
           public WorkweekGetManyFiltersParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WorkweekGetManyFiltersParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WorkweekGetManyFiltersParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkweekGetManyFiltersParameter
  * @throws IOException if the JSON string is invalid with respect to WorkweekGetManyFiltersParameter
  */
  public static WorkweekGetManyFiltersParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkweekGetManyFiltersParameter.class);
  }

 /**
  * Convert an instance of WorkweekGetManyFiltersParameter to an JSON string
  *
  * @return JSON string
  */
