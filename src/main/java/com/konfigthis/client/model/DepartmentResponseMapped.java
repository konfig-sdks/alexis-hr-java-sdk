...
public class DepartmentResponseMapped {
  ...
  public DepartmentResponseMapped() {
  }

  public DepartmentResponseMapped status(String status) {
  ...
  **/
  ...
  public DepartmentResponseMapped data(DepartmentResponse data) {
  ...
  **/
   ...
   * @return the DepartmentResponseMapped instance itself
   */
  public DepartmentResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DepartmentResponseMapped departmentResponseMapped = (DepartmentResponseMapped) o;
    return Objects.equals(this.status, departmentResponseMapped.status) &&
        Objects.equals(this.data, departmentResponseMapped.data)&&
        Objects.equals(this.additionalProperties, departmentResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepartmentResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DepartmentResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DepartmentResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepartmentResponseMapped is not found in the empty JSON string", DepartmentResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DepartmentResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepartmentResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepartmentResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepartmentResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepartmentResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<DepartmentResponseMapped>() {
           @Override
           public void write(JsonWriter out, DepartmentResponseMapped value) throws IOException {
           ...
           @Override
           public DepartmentResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DepartmentResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DepartmentResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DepartmentResponseMapped
  * @throws IOException if the JSON string is invalid with respect to DepartmentResponseMapped
  */
  public static DepartmentResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepartmentResponseMapped.class);
  }

 /**
  * Convert an instance of DepartmentResponseMapped to an JSON string
  *
  * @return JSON string
  */
