...
public class EmployeeTaxRequest {
  ...
  public EmployeeTaxRequest() {
  }

  public EmployeeTaxRequest table(Double table) {
  ...
  public EmployeeTaxRequest table(Integer table) {
  ...
  **/
  ...
  public EmployeeTaxRequest column(Double column) {
  ...
  public EmployeeTaxRequest column(Integer column) {
  ...
  **/
   ...
   * @return the EmployeeTaxRequest instance itself
   */
  public EmployeeTaxRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeTaxRequest employeeTaxRequest = (EmployeeTaxRequest) o;
    return Objects.equals(this.table, employeeTaxRequest.table) &&
        Objects.equals(this.column, employeeTaxRequest.column)&&
        Objects.equals(this.additionalProperties, employeeTaxRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeTaxRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTaxRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTaxRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeTaxRequest is not found in the empty JSON string", EmployeeTaxRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeTaxRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeTaxRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeTaxRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeTaxRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeTaxRequest>() {
           @Override
           public void write(JsonWriter out, EmployeeTaxRequest value) throws IOException {
           ...
           @Override
           public EmployeeTaxRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeTaxRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeTaxRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeTaxRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeeTaxRequest
  */
  public static EmployeeTaxRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeTaxRequest.class);
  }

 /**
  * Convert an instance of EmployeeTaxRequest to an JSON string
  *
  * @return JSON string
  */
