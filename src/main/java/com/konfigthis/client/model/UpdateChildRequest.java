...
public class UpdateChildRequest {
  ...
  public UpdateChildRequest name(String name) {
  ...
  **/
  ...
  public UpdateChildRequest birthdate(OffsetDateTime birthdate) {
  ...
  **/
   ...
   * @return the UpdateChildRequest instance itself
   */
  public UpdateChildRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateChildRequest updateChildRequest = (UpdateChildRequest) o;
    return Objects.equals(this.name, updateChildRequest.name) &&
        Objects.equals(this.birthdate, updateChildRequest.birthdate)&&
        Objects.equals(this.additionalProperties, updateChildRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, birthdate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateChildRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateChildRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateChildRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateChildRequest is not found in the empty JSON string", UpdateChildRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateChildRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateChildRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateChildRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateChildRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateChildRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateChildRequest>() {
           @Override
           public void write(JsonWriter out, UpdateChildRequest value) throws IOException {
           ...
           @Override
           public UpdateChildRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateChildRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateChildRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateChildRequest
  * @throws IOException if the JSON string is invalid with respect to UpdateChildRequest
  */
  public static UpdateChildRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateChildRequest.class);
  }

 /**
  * Convert an instance of UpdateChildRequest to an JSON string
  *
  * @return JSON string
  */
