...
public class EmploymentRelationsResponse {
  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private List<EmploymentTypeResponse> type = null;

  public static final String SERIALIZED_NAME_EMPLOYEE = "employee";
  @SerializedName(SERIALIZED_NAME_EMPLOYEE)
  private List<EmployeeResponse> employee = null;

  public EmploymentRelationsResponse() {
  }

  public EmploymentRelationsResponse type(List<EmploymentTypeResponse> type) {
  ...
  public EmploymentRelationsResponse addTypeItem(EmploymentTypeResponse typeItem) {
    if (this.type == null) {
  ...
  **/
  ...
  public List<EmploymentTypeResponse> getType() {
    return type;
  }


  public void setType(List<EmploymentTypeResponse> type) {
  ...
  public EmploymentRelationsResponse employee(List<EmployeeResponse> employee) {
  ...
  public EmploymentRelationsResponse addEmployeeItem(EmployeeResponse employeeItem) {
  ...
  **/
   ...
   * @return the EmploymentRelationsResponse instance itself
   */
  public EmploymentRelationsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmploymentRelationsResponse employmentRelationsResponse = (EmploymentRelationsResponse) o;
    return Objects.equals(this.type, employmentRelationsResponse.type) &&
        Objects.equals(this.employee, employmentRelationsResponse.employee)&&
        Objects.equals(this.additionalProperties, employmentRelationsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, employee, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmploymentRelationsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentRelationsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentRelationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmploymentRelationsResponse is not found in the empty JSON string", EmploymentRelationsResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        ...
        if (jsonArraytype != null) {
          ...
          for (int i = 0; i < jsonArraytype.size(); i++) {
            EmploymentTypeResponse.validateJsonObject(jsonArraytype.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmploymentRelationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmploymentRelationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmploymentRelationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmploymentRelationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmploymentRelationsResponse>() {
           @Override
           public void write(JsonWriter out, EmploymentRelationsResponse value) throws IOException {
           ...
           @Override
           public EmploymentRelationsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmploymentRelationsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmploymentRelationsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmploymentRelationsResponse
  * @throws IOException if the JSON string is invalid with respect to EmploymentRelationsResponse
  */
  public static EmploymentRelationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmploymentRelationsResponse.class);
  }

 /**
  * Convert an instance of EmploymentRelationsResponse to an JSON string
  *
  * @return JSON string
  */
