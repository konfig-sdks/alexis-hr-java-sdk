...
public class TimesheetEntryResponseMapped {
  ...
  public TimesheetEntryResponseMapped() {
  }

  public TimesheetEntryResponseMapped status(String status) {
  ...
  **/
  ...
  public TimesheetEntryResponseMapped data(TimesheetEntryResponse data) {
  ...
  **/
   ...
   * @return the TimesheetEntryResponseMapped instance itself
   */
  public TimesheetEntryResponseMapped putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimesheetEntryResponseMapped timesheetEntryResponseMapped = (TimesheetEntryResponseMapped) o;
    return Objects.equals(this.status, timesheetEntryResponseMapped.status) &&
        Objects.equals(this.data, timesheetEntryResponseMapped.data)&&
        Objects.equals(this.additionalProperties, timesheetEntryResponseMapped.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimesheetEntryResponseMapped {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetEntryResponseMapped
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetEntryResponseMapped.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimesheetEntryResponseMapped is not found in the empty JSON string", TimesheetEntryResponseMapped.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimesheetEntryResponseMapped.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimesheetEntryResponseMapped.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimesheetEntryResponseMapped' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimesheetEntryResponseMapped> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimesheetEntryResponseMapped.class));

       return (TypeAdapter<T>) new TypeAdapter<TimesheetEntryResponseMapped>() {
           @Override
           public void write(JsonWriter out, TimesheetEntryResponseMapped value) throws IOException {
           ...
           @Override
           public TimesheetEntryResponseMapped read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimesheetEntryResponseMapped instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimesheetEntryResponseMapped given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimesheetEntryResponseMapped
  * @throws IOException if the JSON string is invalid with respect to TimesheetEntryResponseMapped
  */
  public static TimesheetEntryResponseMapped fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimesheetEntryResponseMapped.class);
  }

 /**
  * Convert an instance of TimesheetEntryResponseMapped to an JSON string
  *
  * @return JSON string
  */
